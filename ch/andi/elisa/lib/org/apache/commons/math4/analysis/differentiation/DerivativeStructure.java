 ...
 * derivation order despite not requiring users to compute the derivatives by
...
public class DerivativeStructure implements RealFieldElement<DerivativeStructure>, Serializable {
	 ...
	 */
	public DerivativeStructure(final double a1, final DerivativeStructure ds1, final double a2, final DerivativeStructure ds2,
			final double a3, final DerivativeStructure ds3) throws DimensionMismatchException {
		this(ds1.compiler);
		compiler.checkCompatibility(ds2.compiler);
	 ...
	 */
	public DerivativeStructure(final double a1, final DerivativeStructure ds1, final double a2, final DerivativeStructure ds2,
			final double a3, final DerivativeStructure ds3, final double a4, final DerivativeStructure ds4)
			throws DimensionMismatchException {
		this(ds1.compiler);
		compiler.checkCompatibility(ds2.compiler);
		compiler.checkCompatibility(ds3.compiler);
	...
	public DerivativeStructure linearCombination(final DerivativeStructure a1, final DerivativeStructure b1,
		...
		// compute an accurate value, taking care of cancellations
		final double accurateValue = LinearCombination.value(a1.getValue(), b1.getValue(), a2.getValue(), b2.getValue());
	...
	public DerivativeStructure linearCombination(final double a1, final DerivativeStructure b1, final double a2,
		...
		// compute an accurate value, taking care of cancellations
		final double accurateValue = LinearCombination.value(a1, b1.getValue(), a2, b2.getValue());
	...
	public DerivativeStructure linearCombination(final double a1, final DerivativeStructure b1, final double a2,
		...
		// compute an accurate value, taking care of cancellations
		final double accurateValue = LinearCombination.value(a1, b1.getValue(), a2, b2.getValue(), a3, b3.getValue());
	...
	public DerivativeStructure linearCombination(final DerivativeStructure a1, final DerivativeStructure b1,
		...
		// compute an accurate value, taking care of cancellations
		final double accurateValue = LinearCombination.value(a1.getValue(), b1.getValue(), a2.getValue(), b2.getValue(),
				a3.getValue(), b3.getValue(), a4.getValue(), b4.getValue());
	...
	public DerivativeStructure linearCombination(final double a1, final DerivativeStructure b1, final double a2,
		...
		// compute an accurate value, taking care of cancellations
		final double accurateValue = LinearCombination.value(a1, b1.getValue(), a2, b2.getValue(), a3, b3.getValue(), a4,
				b4.getValue());
