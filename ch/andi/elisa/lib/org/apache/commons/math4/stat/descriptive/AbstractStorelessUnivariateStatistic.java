 ...
 * <p>
 * Provides default {@code evaluate(double[],...)} and
 * {@code incrementAll(double[])} implementations.
 * <p>
...
public abstract class AbstractStorelessUnivariateStatistic implements StorelessUnivariateStatistic {
	 ...
	 * {@link StorelessUnivariateStatistic} instance, calls {@link #clear} on
	 * it, then calls {@link #incrementAll} with the specified portion of the
	 * input array, and then uses {@link #getResult} to compute the return
	 * value.
	 * <p>
	 * Note that this implementation does not change the internal state of the
	 * statistic.
	 * <p>
