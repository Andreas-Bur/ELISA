...
public class QRDecomposition {
	 ...
	 *            The matrix to decompose.
	 * @param threshold
	 *            Singularity threshold. The matrix will be considered singular
	 *            if the absolute value of any of the diagonal elements of the
	 *            "R" matrix is smaller than the threshold.
	 */
	...
	private static class Solver implements DecompositionSolver {
		 ...
		 *            Singularity threshold.
		 * @param raise
		 *            Whether to raise a {@link SingularMatrixException} if any
		 *            element of the diagonal fails the check.
		 * @return {@code true} if any element of the diagonal is smaller or
		 *         equal to {@code min}.
		 * @throws SingularMatrixException
		 *             if the matrix is singular and {@code raise} is
		 *             {@code true}.
		 */
