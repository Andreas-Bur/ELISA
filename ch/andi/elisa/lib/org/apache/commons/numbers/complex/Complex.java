 ...
 * IEEE-754 while this class conforms with the standard behavior for Java object
 * types.
 * </p>
 *
 */
public final class Complex implements Serializable {
	 ...
	 * {@code c = cos(x) + i sin (x)}
	 *
	 * @param x
	 *            {@code double} to build the cis number
	 * @return {@code Complex}
	 */
	...
	/**
	 * Parses a string that would be produced by {@link #toString()} and
	...
	/**
	 * Returns true if either real or imaginary component of the Complex is
	 * Infinite
	 *
	 * @return {@code boolean}
	 */
	 ...
	 * all infinities (including those with an NaN component) project onto real
	 * infinity, as described in the <a href=
	...
	/**
	 * Return the absolute value of this complex number. This code follows the
	 ...
	 *
	 *
	 * Recalculates to recover infinities as specified in C.99 standard G.5.1.
	 * Method is fully in accordance with C++11 standards for complex numbers.
	 *
	 * @param divisor
	...
	/**
	 * Get a hash code for the complex number. Any {@code Double.NaN} value in
	...
	/**
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/InverseHyperbolicSine.html" TARGET=
	 * "_top"> inverse hyperbolic sine</a> of this complex number. Implements
	 * the formula:
	 * <p>
	 ...
	 * TARGET="_top"> inverse hyperbolic tangent</a> of this complex number.
	 ...
	 * TARGET="_top"> inverse hyperbolic cosine</a> of this complex number.
	 * Implements the formula:
	 * <p>
	 ...
	 * {@link Math#cos}, {@link Math#cosh} and {@link Math#sinh}.
	 * </p>
	 * <p>
	 *
	 ...
	 * </pre>
	 * 
	 * where the (real) functions on the right-hand side are {@link Math#exp},
	 * {@link Math#cos}, and {@link Math#sin}.
	 *
	 ...
	 * </pre>
	 * 
	 * where ln on the right hand side is {@link Math#log}, {@code |a + bi|} is
	 * the modulus, {@link Complex#abs}, and
	 ...
	 * <a href="http://mathworld.wolfram.com/CommonLogarithm.html" TARGET=
	 * "_top"> common logarithm</a> of this complex number.
	 *
	 * @return the base 10 logarithm of <code>this</code>.
	 */
	public Complex log10() {
		return new Complex(Math.log(abs()) / Math.log(10), Math.atan2(imaginary, real));
	}
	...
	public Complex sqrt() {
		...
		if (real >= 0) {
			...
			return new Complex(Math.abs(imaginary) / (2 * t), Math.copySign(1d, imaginary) * t);
		}
	}
	 ...
	 * element, {@code NaN + NaN i} is returned. if neither part is NaN, but at
	 * least one part is infinite, the result is a one-element list containing
	 * {@link #INF}.
	 *
	 * @param n
	 *            Degree of root.
	...
	/**
	 * Check that the argument is positive and throw a RuntimeException if it is
	 * not.
	 * 
	 * @param arg
	 *            {@code double} to check
	 */
