...
public class Combinations implements Iterable<int[]> {
	...
	private static class LexicographicIterator implements Iterator<int[]> {
		...
		/**
		 * Construct a CombinationIterator to enumerate {@code k}-sets from a
		 * set of size {@code n}.
		 * <p>
	...
	private static class SingletonIterator implements Iterator<int[]> {
		...
		/**
		 * @return {@code true} until next is called the first time, then
		 *         {@code false}.
		 **/
		@Override
		public boolean hasNext() {
	 ...
	 *
	 * The comparison is based on the value (in base 10) represented by the
	 * digit (interpreted in base {@code n}) in the input array, in reverse
	 * order. For example if {@code c} is {@code {3, 2, 1}}, and {@code n} is 3,
	 * the method will return 18.
	 */
	public static class LexicographicComparator implements Comparator<int[]>, Serializable {
		 ...
		 * in base {@code n}) in the input array in reverse order.
		 *
		 * @param c
		 *            Input array.
