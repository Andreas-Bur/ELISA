...
public class Precision {
	...
	/**
	 * Safe minimum, such that {@code 1 / SAFE_MIN} does not overflow. In IEEE
	 * 754 arithmetic, this is also the smallest normalized number
	 * 2<sup>-1022</sup>.
	 */
	...
	/**
	 * Compares two numbers given some amount of allowed error. The returned
	 * value is
	 * <ul>
	 * <li>0 if {@link #equals(double,double,double) equals(x, y, eps)},</li>
	 * <li>negative if !{@link #equals(double,double,double) equals(x, y, eps)}
	 * and {@code x < y},</li>
	 * <li>positive if !{@link #equals(double,double,double) equals(x, y, eps)}
	 * and {@code x > y} or either argument is {@code NaN}.</li>
	 * </ul>
	 *
	 * @param x
	 *            First value.
	 ...
	 *            Second value.
	 * @param eps
	 *            Allowed error when checking for equality.
	 * @return 0 if the value are considered equal, -1 if the first is smaller
	 *         than the second, 1 is the first is larger than the second.
	 */
	 ...
	 * NaN. The returned value is
	 * <ul>
	 * <li>zero if {@link #equals(double,double,int) equals(x, y, maxUlps)},
	 * </li>
	 * <li>negative if !{@link #equals(double,double,int) equals(x, y, maxUlps)}
	 * and {@code x < y},</li>
	 * <li>positive if !{@link #equals(double,double,int) equals(x, y, maxUlps)}
	 * and {@code x > y} or either argument is {@code NaN}.</li>
	 * </ul>
	 *
	 * @param x
