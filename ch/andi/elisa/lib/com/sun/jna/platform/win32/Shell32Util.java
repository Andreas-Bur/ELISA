...
public abstract class Shell32Util {
	 ...
	 * KNOWNFOLDERID. This function replaces {@link #getFolderPath}. That older
	 * function is now simply a wrapper for getKnownFolderPath
	 * 
	 * @param guid
	 *            the KNOWNFOLDERS GUID as defined in {@link KnownFolders}
	 * @return the path of the known folder. The returned path does not include
	 *         a trailing backslash. For example, "C:\Users" is returned rather
	 *         than "C:\Users\".
	 * @throws Win32Exception
	 *             if the guid references a KNOWNFOLDERID which does not have a
	 *             path (such as a folder marked as KF_CATEGORY_VIRTUAL) or that
	 *             the KNOWNFOLDERID is not present on the system. Not all
	 *             KNOWNFOLDERID values are present on all systems.
	 */
