...
public interface LowLevelMonitorConfigurationAPI {
	...
	class MC_TIMING_REPORT extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dwHorizontalFrequencyInHZ", "dwVerticalFrequencyInHZ",
				"bTimingStatusByte");
		/**
		...
		/**
		 * Timing status byte. For more information about this value, see the
	...
	enum MC_VCP_CODE_TYPE {
		/**
		 * Momentary VCP code. Sending a command of this type causes the monitor
		 * to initiate a self-timed operation and then revert to its original
		 * state. Examples include display tests and degaussing.
		 */
		MC_MOMENTARY,

		/**
		 * Set Parameter VCP code. Sending a command of this type changes some
		 * aspect of the monitor's operation.
		 */
		MC_SET_PARAMETER;
