...
public interface IConnectionPoint extends IUnknown {
	...
	/**
	 * 
	 * When Advise is called, the called COM object will callback
	 * 'QueryInterface' asking for a number of different interfaces, for
	 * example: - {00000003-0000-0000-C000-000000000046} - IMarshal -
