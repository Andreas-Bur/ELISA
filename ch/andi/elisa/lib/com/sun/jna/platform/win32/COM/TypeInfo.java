...
public class TypeInfo extends Unknown implements ITypeInfo {
	...
	public/* [local] */HRESULT GetNames(/* [in] */MEMBERID memid,
		...
		return (HRESULT) this._invokeNativeObject(7, new Object[] { this.getPointer(), memid, rgBstrNames, cMaxNames, pcNames },
				HRESULT.class);
	}
	...
	public/* [local] */HRESULT Invoke(/* [in] */PVOID pvInstance, /* [in] */MEMBERID memid,
		...
		return (HRESULT) this._invokeNativeObject(11,
				new Object[] { this.getPointer(), pvInstance, memid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr },
				HRESULT.class);
	}
