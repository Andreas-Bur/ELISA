...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
	...
	int TOKEN_ALL_ACCESS_P = STANDARD_RIGHTS_REQUIRED | TOKEN_ASSIGN_PRIMARY | TOKEN_DUPLICATE | TOKEN_IMPERSONATE | TOKEN_QUERY
	 ...
	 * It is also used to indicate which, if any, privileges are held by a user
	 * or group requesting access to an object.
	 */
	...
	int FILE_GENERIC_WRITE = STANDARD_RIGHTS_WRITE | SYNCHRONIZE | FILE_WRITE_DATA | FILE_WRITE_ATTRIBUTES | FILE_WRITE_EA
			| FILE_APPEND_DATA;
	 ...
	 *
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa366786(v=vs.85).aspx">MSDN</a>
	 */
	...
	// NOTE: These values are not supported until Windows Server 2008 R2 and
	// Windows 7
	...
	// see
	// https://msdn.microsoft.com/en-us/library/windows/desktop/aa363904(v=vs.85).aspx
	...
	public static class LARGE_INTEGER extends Structure implements Comparable<LARGE_INTEGER> {
		...
		/**
		 * Compares 2 LARGE_INTEGER values - - <B>Note:</B> a {@code null} value
		 * is considered <U>greater</U> than any non-{@code null} one (i.e.,
		 * {@code null} values are &quot;pushed&quot; to the end of a sorted
		 ...
		 * @param v2
		 *            The 2nd value
		 * @return 0 if values are equal (including if <U>both</U> are
		 *         {@code null}, negative if 1st value less than 2nd one,
		...
		/**
		 * Compares a LARGE_INTEGER value with a {@code long} one. <B>Note:</B>
		 * if the LARGE_INTEGER value is {@code null} then it is consider
		 * <U>greater</U> than any {@code long} value.
		 *
		 * @param v1
		 *            The {@link LARGE_INTEGER} value
		 * @param v2
		 *            The {@code long} value
		 * @return 0 if values are equal, negative if 1st value less than 2nd
		 *         one, positive otherwise. <B>Note:</B> the comparison uses the
		 *         {@link #getValue()}.
		 * @see IntegerType#compare(long, long)
		 */
	...
	public static class OSVERSIONINFO extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dwOSVersionInfoSize", "dwMajorVersion", "dwMinorVersion",
	...
	public static class OSVERSIONINFOEX extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dwOSVersionInfoSize", "dwMajorVersion", "dwMinorVersion",
				"dwBuildNumber", "dwPlatformId", "szCSDVersion", "wServicePackMajor", "wServicePackMinor", "wSuiteMask",
				"wProductType", "wReserved");
		...
		/**
		 * @return The operating system platform. This member can be
		 *         VER_PLATFORM_WIN32_NT.
		 */
		...
		/**
		 * @return A bit mask that identifies the product suites available on
		 *         the system.
		 */
	...
	public static class EVENTLOGRECORD extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("Length", "Reserved", "RecordNumber", "TimeGenerated",
				"TimeWritten", "EventID", "EventType", "NumStrings", "EventCategory", "ReservedFlags", "ClosingRecordNumber",
	...
	/**
	 * Required to duplicate a handle using {@link Kernel32#DuplicateHandle} .
	 */
	 ...
	 *
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/ms684880(v=VS.85).aspx">MSDN</a>
	 */
	int PROCESS_ALL_ACCESS = WinNT.PROCESS_CREATE_PROCESS | WinNT.PROCESS_CREATE_THREAD | WinNT.PROCESS_DUP_HANDLE
			...
			| WinNT.PROCESS_VM_OPERATION | WinNT.PROCESS_VM_READ | WinNT.PROCESS_VM_WRITE | WinNT.DELETE | WinNT.READ_CONTROL
	 ...
	 * {@link Kernel32#GetExitCodeProcess} , {@code Kernel32#GetPriorityClass},
	 * {@code Kernel32#IsProcessInJob},
	...
	/**
	 * Required to terminate a process using {@link Kernel32#TerminateProcess}.
	 */
	...
	public static class SECURITY_DESCRIPTOR_RELATIVE extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("Revision", "Sbz1", "Control", "Owner", "Group", "Sacl",
				"Dacl");
	...
	public static abstract class ACCESS_ACEStructure extends ACEStructure {
		...
		public int Mask;
		/**
		 * First 4 bytes of the SID Only used to have a valid field defined -
		 * use sid!
		 */
	...
	/**
	 * Defines the mapping of generic access rights to specific and standard
	...
	public static class GENERIC_MAPPING extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("genericRead", "genericWrite", "genericExecute",
				"genericAll");
	...
	public static class SYSTEM_LOGICAL_PROCESSOR_INFORMATION extends Structure {
		...
		/**
		 * The processor mask identifying the processors described by this
		 * structure. A processor mask is a bit vector in which each set bit
		 * represents an active processor in the relationship.
		 */
		public ULONG_PTR processorMask;

		/**
		 * The relationship between the processors identified by the value of
		 * the {@link #processorMask} member. This member can be one of
		...
		public static class AnonymousUnionPayload extends Union {
			...
			/**
			 * <p>
			 * Identifies the characteristics of a particular cache. There is
			 * one record returned for each cache reported. Some or all caches
			 * may not be reported, depending on how caches are identified.
			 ...
			 *
			 * <p>
			 * This member was not supported until Windows Server 2003 SP1 /
		...
		public static class AnonymousStructProcessorCore extends Structure {
			...
			/**
			 * <p>
			 * If the value of this mmeber is {@code 1}, the logical processors
			 * identified by the value of the {@link #processorMask} member
			 * share functional units, as in Hyperthreading or SMT. Otherwise,
			 * the identified logical processors do not share functional units.
			 * </p>
			 *
			 * <p>
			 * Note: Prior to Windows Vista, this member is also {@code 1} for
			 * cores that share a physical package.
			 * </p>
			 */
			public BYTE flags;
	 ...
	 * corresponding {@link SYSTEM_LOGICAL_PROCESSOR_INFORMATION} or
	...
	public interface LOGICAL_PROCESSOR_RELATIONSHIP {
		 ...
		 *
		 * <p>
		 * Not supported until Windows Server 2003 SP1 / Windows XP Professional
		 * x64.
		 * </p>
		 */
		int RelationCache = 2;
		 ...
		 * This value is not used on output.
		 * </p>
		 *
		 * <p>
		 * Not supported until Windows Server 2008 R2.
	...
	public static class CACHE_DESCRIPTOR extends Structure {
		...
		/**
		 * The cache level. This member can be 1, 2 or 3, corresponding to L1,
		 * L2 or L3 cache, respectively (other values may be supported in the
		 * future.)
		 */
		public BYTE level;
	...
	public static class MEMORY_BASIC_INFORMATION extends Structure {
		 ...
		 * VirtualAlloc function. The page pointed to by the BaseAddress member
		 ...
		 * This member can be one of the memory protection constants or 0 if the
		 * caller does not have access.
		 */
		public DWORD allocationProtect;

		/**
		 * The size of the region beginning at the base address in which all
		 * pages have identical attributes, in bytes.
		 */
		public SIZE_T regionSize;

		/**
		 * The state of the pages in the region. This member can be one of the
		 * following values:
		 *
		...
		/**
		 * The access protection of the pages in the region. This member is one
		 * of the values listed for the AllocationProtect member.
		 */
	...
	public class SECURITY_QUALITY_OF_SERVICE extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("Length", "ImpersonationLevel", "ContextTrackingMode",
				"EffectiveOnly");
	...
	public static final int LANG_MACEDONIAN = 0x2f; // the Former Yugoslav
	 ...
	 * Sublanguage IDs.
	 *
	 * The name immediately following SUBLANG_ dictates which primary language
	 * ID that sublanguage ID can be combined with to form a valid language ID.
	 */
	...
	public static final int SUBLANG_ARABIC_SAUDI_ARABIA = 0x01; // Arabic (Saudi
																// Arabia)
	...
	public static final int SUBLANG_CHINESE_TRADITIONAL = 0x01; // Chinese
																// (Taiwan)
	public static final int SUBLANG_CHINESE_SIMPLIFIED = 0x02; // Chinese (PR
																// China)
	public static final int SUBLANG_CHINESE_HONGKONG = 0x03; // Chinese (Hong
																// Kong S.A.R.,
																// P.R.C.)
	public static final int SUBLANG_CHINESE_SINGAPORE = 0x04; // Chinese
																// (Singapore)
	public static final int SUBLANG_CHINESE_MACAU = 0x05; // Chinese (Macau
															// S.A.R.)
	...
	public static final int SUBLANG_ENGLISH_SOUTH_AFRICA = 0x07; // English
																	// (South
																	// Africa)
	public static final int SUBLANG_ENGLISH_JAMAICA = 0x08; // English (Jamaica)
	public static final int SUBLANG_ENGLISH_CARIBBEAN = 0x09; // English
																// (Caribbean)
	public static final int SUBLANG_ENGLISH_BELIZE = 0x0a; // English (Belize)
	public static final int SUBLANG_ENGLISH_TRINIDAD = 0x0b; // English
																// (Trinidad)
	public static final int SUBLANG_ENGLISH_ZIMBABWE = 0x0c; // English
																// (Zimbabwe)
	public static final int SUBLANG_ENGLISH_PHILIPPINES = 0x0d; // English
																// (Philippines)
	...
	public static final int SUBLANG_FRENCH_LUXEMBOURG = 0x05; // French
																// (Luxembourg)
	...
	public static final int SUBLANG_GERMAN_LUXEMBOURG = 0x04; // German
																// (Luxembourg)
	public static final int SUBLANG_GERMAN_LIECHTENSTEIN = 0x05; // German
																	// (Liechtenstein)
	public static final int SUBLANG_ITALIAN = 0x01; // Italian
	public static final int SUBLANG_ITALIAN_SWISS = 0x02; // Italian (Swiss)
	public static final int SUBLANG_KASHMIRI_SASIA = 0x02; // Kashmiri (South
															// Asia)
	public static final int SUBLANG_KASHMIRI_INDIA = 0x02; // For app
															// compatibility
															// only
	...
	public static final int SUBLANG_MALAY_BRUNEI_DARUSSALAM = 0x02; // Malay
																	// (Brunei
																	// Darussalam)
	public static final int SUBLANG_NEPALI_INDIA = 0x02; // Nepali (India)
	public static final int SUBLANG_NORWEGIAN_BOKMAL = 0x01; // Norwegian
																// (Bokmal)
	public static final int SUBLANG_NORWEGIAN_NYNORSK = 0x02; // Norwegian
																// (Nynorsk)
	public static final int SUBLANG_PORTUGUESE = 0x02; // Portuguese
	public static final int SUBLANG_PORTUGUESE_BRAZILIAN = 0x01; // Portuguese
																	// (Brazilian)
	public static final int SUBLANG_SERBIAN_LATIN = 0x02; // Serbian (Latin)
	public static final int SUBLANG_SERBIAN_CYRILLIC = 0x03; // Serbian
																// (Cyrillic)
	...
	public static final int SUBLANG_SPANISH_GUATEMALA = 0x04; // Spanish
																// (Guatemala)
	public static final int SUBLANG_SPANISH_COSTA_RICA = 0x05; // Spanish (Costa
																// Rica)
	public static final int SUBLANG_SPANISH_PANAMA = 0x06; // Spanish (Panama)
	public static final int SUBLANG_SPANISH_DOMINICAN_REPUBLIC = 0x07; // Spanish
																		// (Dominican
																		// Republic)
	public static final int SUBLANG_SPANISH_VENEZUELA = 0x08; // Spanish
																// (Venezuela)
	public static final int SUBLANG_SPANISH_COLOMBIA = 0x09; // Spanish
																// (Colombia)
	public static final int SUBLANG_SPANISH_PERU = 0x0a; // Spanish (Peru)
	public static final int SUBLANG_SPANISH_ARGENTINA = 0x0b; // Spanish
																// (Argentina)
	...
	public static final int SUBLANG_SPANISH_PARAGUAY = 0x0f; // Spanish
																// (Paraguay)
	public static final int SUBLANG_SPANISH_BOLIVIA = 0x10; // Spanish (Bolivia)
	public static final int SUBLANG_SPANISH_EL_SALVADOR = 0x11; // Spanish (El
																// Salvador)
	public static final int SUBLANG_SPANISH_HONDURAS = 0x12; // Spanish
																// (Honduras)
	public static final int SUBLANG_SPANISH_NICARAGUA = 0x13; // Spanish
																// (Nicaragua)
	public static final int SUBLANG_SPANISH_PUERTO_RICO = 0x14; // Spanish
																// (Puerto Rico)
	...
	public static final int SORT_JAPANESE_UNICODE = 0x1; // Japanese Unicode
															// order

	public static final int SORT_CHINESE_BIG5 = 0x0; // Chinese BIG5 order
	public static final int SORT_CHINESE_PRCP = 0x0; // PRC Chinese Phonetic
														// order
	public static final int SORT_CHINESE_UNICODE = 0x1; // Chinese Unicode order
	public static final int SORT_CHINESE_PRC = 0x2; // PRC Chinese Stroke Count
													// order
	public static final int SORT_CHINESE_BOPOMOFO = 0x3; // Traditional Chinese
															// Bopomofo order
	...
	public static final int SORT_GERMAN_PHONE_BOOK = 0x1; // German Phone Book
															// order

	public static final int SORT_HUNGARIAN_DEFAULT = 0x0; // Hungarian Default
															// order
	public static final int SORT_HUNGARIAN_TECHNICAL = 0x1; // Hungarian
															// Technical order

	public static final int SORT_GEORGIAN_TRADITIONAL = 0x0; // Georgian
																// Traditional
																// order
	...
	/**
	 * <p>
	 * A language ID is a 16 bit value which is the combination of a primary
	 * language ID and a secondary language ID. The bits are allocated as
	 * follows:
	 * </p>
	 *
	 * <pre>
	 ...
	 * 
	 * <p>
	 * WARNING: This pattern isn't always follows, Serbina, Bosnian &amp;
	 * Croation for example.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Note that the LANG, SUBLANG construction is not always consistent. The
	 * named locale APIs (eg GetLocaleInfoEx) are recommended.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * A locale ID is a 32 bit value which is the combination of a language ID,
	 * a sort ID, and a reserved area. The bits are allocated as follows:
	 * </p>
	 *
	 * <pre>
	 *   +-------------+---------+-------------------------+
	...
	public static final class LocaleMacros {
		...
		/**
		 * construct the locale id from a language id, sort id, and sort
		 * version.
		 * 
		 * @param lgid
		 *            locale id
		 ...
		 * @param ver
		 *            sort version
		 * @return locale id derviced from a language id, sort id, and sort
		 *         version.
		 */
		...
		/**
		 * Construct language id from a primary language id and a sublanguage
		 * id.
		 * 
		 * @param p
		 *            primary language ID
	...
	public static final LCID LOCALE_INVARIANT = LocaleMacros.MAKELCID(LocaleMacros.MAKELANGID(LANG_INVARIANT, SUBLANG_NEUTRAL),
			SORT_DEFAULT);
}
