...
public interface OpenGL32 extends StdCallLibrary {
	...
	/**
	 * The glGetString function returns a string describing the current OpenGL
	 * connection.
	 *
	 * @param name
	 *            One of the following symbolic constants.
	 * @return The glGetString function returns a pointer to a static string
	 *         describing some aspect of the current OpenGL connection.
	 */
	...
	/**
	 * The wglGetCurrentContext function obtains a handle to the current OpenGL
	 * rendering context of the calling thread.
	 *
	 * @return If the calling thread has a current OpenGL rendering context,
	 ...
	 * the calling thread's current rendering context. All subsequent OpenGL
	 * calls made by the thread are drawn on the device identified by hdc.
	 *
	 * @param windowDC
	 *            Handle to a device context. Subsequent OpenGL calls made by
	 *            the calling thread are drawn on the device identified by hdc.
	 * @param hglrc
	 *            Handle to an OpenGL rendering context that the function sets
	 *            as the calling thread's rendering context.
	 ...
	 *
	 * @param hglrc
	 *            Handle to an OpenGL rendering context that the function will
	 *            delete.
	 * @return true if successful
	 */
	 ...
	 * @return When the function succeeds, the return value is the address of
