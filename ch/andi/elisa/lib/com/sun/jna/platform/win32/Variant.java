...
public interface Variant {
	...
	public static class VARIANT extends Union {
		 ...
		 * 
		 * <p>
		 * <i>Implementation note:</i> the string is wrapped as a BSTR value,
		 * that is allocated using
		 * {@link com.sun.jna.platform.win32.OleAuto#SysAllocString} and needs
		 * to be freed using
		 * {@link com.sun.jna.platform.win32.OleAuto#SysFreeString} by the user
		 * </p>
		 * 
		 * @param value
		 *            to be wrapped
		...
		public static class _VARIANT extends Structure {
			public static final List<String> FIELDS = createFieldsOrder("vt", "wReserved1", "wReserved2", "wReserved3",
					"__variant");
