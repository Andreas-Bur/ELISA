...
public interface NTSecApi {
	...
	/**
	 * The LSA_UNICODE_STRING structure is used by various Local Security
	...
	public static class LSA_UNICODE_STRING extends Structure {
		...
		public short Length;
		/**
		 * Specifies the total size, in bytes, of the memory allocated for
		 * Buffer. Up to MaximumLength bytes can be written into the buffer
	...
	public static class LSA_FOREST_TRUST_RECORD extends Structure {
		...
		/**
		 * LSA_FOREST_TRUST_RECORD_TYPE enumeration that indicates the type of
		 * the record. The following table shows the possible values.
		 ...
		 * ForestTrustDomainInfo Record contains an LSA_FOREST_TRUST_DOMAIN_INFO
	...
	public static class LSA_FOREST_TRUST_INFORMATION extends Structure {
		...
		/**
		 * Number of LSA_FOREST_TRUST_RECORD structures in the array pointed to
		 * by the Entries member.
		 */
		public int RecordCount;
		/**
		 * Pointer to a pointer to an array of LSA_FOREST_TRUST_RECORD
		 * structures, each of which contains one piece of forest trust
		 * information.
		 */
		 ...
		 * 
		 * @return An array of forest trust records.
		 */
	...
	/**
	 * The LSA_FOREST_TRUST_INFORMATION structure contains Local Security
	 * Authority forest trust information.
	 */
