...
public interface Winsock2 extends Library {
	 ...
	 * name parameter is dependent on the namespace provider.
	 * </p>
	 *
	 * <p>
	 ...
	 * buffer size will always be adequate.
	 * </p>
	 *
	 * @param name
	 *            A bytearray that receives the local host name.
	 * @param namelen
	 *            The length, in bytes, of the buffer pointed to by the name
	 *            parameter.
