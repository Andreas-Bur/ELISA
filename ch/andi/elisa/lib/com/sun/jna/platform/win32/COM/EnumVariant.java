...
public class EnumVariant extends Unknown implements IEnumVariant {
	...
	public void Skip(int count) {
		WinNT.HRESULT hresult = (WinNT.HRESULT) this._invokeNativeObject(4, new Object[] { getPointer(), count },
				WinNT.HRESULT.class);
		COMUtils.checkRC(hresult);
	}
	...
	public EnumVariant Clone() {
		...
		WinNT.HRESULT hresult = (WinNT.HRESULT) this._invokeNativeObject(6, new Object[] { getPointer(), pbr },
				WinNT.HRESULT.class);
		COMUtils.checkRC(hresult);
