...
public abstract class WinspoolUtil {
	...
	public static PRINTER_INFO_1[] getPrinterInfo1() {
		...
		if (!Winspool.INSTANCE.EnumPrinters(Winspool.PRINTER_ENUM_LOCAL, null, 1, pPrinterEnum.getPointer(), pcbNeeded.getValue(),
	...
	public static PRINTER_INFO_2[] getAllPrinterInfo2() {
		...
		// These printers include those that are physically attached to the
		// local machine
	...
	public static PRINTER_INFO_4[] getPrinterInfo4() {
		...
		if (!Winspool.INSTANCE.EnumPrinters(Winspool.PRINTER_ENUM_LOCAL, null, 4, pPrinterEnum.getPointer(), pcbNeeded.getValue(),
				pcbNeeded, pcReturned)) {
			throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
		}
	...
	public static JOB_INFO_1[] getJobInfo1(HANDLEByReference phPrinter) {
		...
		if (!Winspool.INSTANCE.EnumJobs(phPrinter.getValue(), 0, 255, 1, pJobEnum.getPointer(), pcbNeeded.getValue(), pcbNeeded,
				pcReturned)) {
			throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
		}
