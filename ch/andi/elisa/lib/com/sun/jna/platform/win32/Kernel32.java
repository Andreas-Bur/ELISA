...
public interface Kernel32 extends StdCallLibrary, WinNT, Wincon {
	 ...
	 *
	 * @param hMem
	 *            A handle to the local memory object. If the <tt>hMem</tt>
	 *            parameter is NULL, {@code LocalFree} ignores the parameter and
	 *            returns NULL.
	 ...
	 *         {@code GetLastError}.
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa366730(v=vs.85).aspx">LocalFree</A>
	 */
	 ...
	 *         {@code GetLastError}.
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa366579(v=vs.85).aspx">GlobalFree</A>
	 */
	 ...
	 *
	 * @param lpSystemTime
	 *            Pointer to a {@link WinBase.SYSTEMTIME} structure to receive
	...
	/**
	 * The SetSystemTime function modifies the current system date and time. The
	 * system time is expressed in Coordinated Universal Time (UTC).
	 *
	 * @param lpSystemTime
	 *            Pointer to a {@link WinBase.SYSTEMTIME} structure holding the
	 *            new system date and time. <B>Note:</B> The {@code wDayOfWeek}
	 *            member of the SYSTEMTIME structure is ignored.
	 * @return {@code true} if the function succeeds, {@code false} otherwise.
	 *         If the function fails, call {@link #GetLastError()} to get
	 *         extended error information.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms724942(v=vs.85).aspx">SetSystemTime
	 *      documentation</a>
	 */
	 ...
	 *
	 * @param lpSystemTime
	 *            A pointer to a {@link WinBase.SYSTEMTIME} structure to receive
	 *            the current local date and time.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms724338(v=vs.85).aspx">GetLocalTime
	 *      documentation</a>
	 */
	 ...
	 *         extended error information.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms724936(v=vs.85).aspx">SetLocalTime
	 *      documentation</a>
	 */
	 ...
	 *         extended error information.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms724400(v=vs.85).aspx">GetSystemTimes
	 *      documentation</a>
	 */
	 ...
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364939(v=vs.85).aspx">GetDriveType</a>
	 */
	 ...
	 */
	int FormatMessage(int dwFlags, Pointer lpSource, int dwMessageId, int dwLanguageId, PointerByReference lpBuffer, int nSize,
			Pointer va_list);
	 ...
	 *         call GetLastError.
	 */
	HANDLE CreateFile(String lpFileName, int dwDesiredAccess, int dwShareMode, WinBase.SECURITY_ATTRIBUTES lpSecurityAttributes,
	 ...
	 */
	boolean GetQueuedCompletionStatus(HANDLE CompletionPort, IntByReference lpNumberOfBytes, ULONG_PTRByReference lpCompletionKey,
	 ...
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms724211(v=vs.85).aspx">CloseHandle</A>
	 */
	 ...
	 */
	public boolean ReadDirectoryChangesW(HANDLE directory, WinNT.FILE_NOTIFY_INFORMATION info, int length, boolean watchSubtree,
	 ...
	 *            device, the function only flushes the transmit buffer. If a
	 *            handle to the server end of a named pipe, the function does
	 *            not return until the client has read all buffered data from
	 *            the pipe.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364439(v=vs.85).aspx">FlushFileBuffers
	 *      documentation</a>
	 */
	 ...
	 *         GetLastError.
	 */
	HANDLE CreateFileMapping(HANDLE hFile, WinBase.SECURITY_ATTRIBUTES lpAttributes, int flProtect, int dwMaximumSizeHigh,
	 ...
	 *            enough, set this parameter to NULL and use the required buffer
	...
	boolean CreateProcess(String lpApplicationName, String lpCommandLine, WinBase.SECURITY_ATTRIBUTES lpProcessAttributes,
			WinBase.SECURITY_ATTRIBUTES lpThreadAttributes, boolean bInheritHandles, DWORD dwCreationFlags, Pointer lpEnvironment,
			String lpCurrentDirectory, WinBase.STARTUPINFO lpStartupInfo, WinBase.PROCESS_INFORMATION lpProcessInformation);
	 ...
	 * @return If the function succeeds, the return value is nonzero.
	 */
	boolean CreateProcessW(String lpApplicationName, char[] lpCommandLine, WinBase.SECURITY_ATTRIBUTES lpProcessAttributes,
			WinBase.SECURITY_ATTRIBUTES lpThreadAttributes, boolean bInheritHandles, DWORD dwCreationFlags, Pointer lpEnvironment,
			String lpCurrentDirectory, WinBase.STARTUPINFO lpStartupInfo, WinBase.PROCESS_INFORMATION lpProcessInformation);
	...
	/**
	 * This function retrieves the full path of the executable file of a given
	 * process.
	 *
	 * @param hProcess
	 ...
	 *            1(WinNT.PROCESS_NAME_NATIVE) - The name should use the native
	 *            system path format.
	 * @param lpExeName
	 *            pre-allocated character buffer for the returned path
	 * @param lpdwSize
	 *            input: the size of the allocated buffer output: the length of
	 *            the returned path in characters
	 *
	 * @return true if successful false if not. To get extended error
	 *         information, call GetLastError.
	 */
	...
	/**
	 * Retrieves file information for the specified file. To set file
	 * information using a file handle, see SetFileInformationByHandle.
	 * 
	 * @param hFile
	 *            A handle to the file that contains the information to be
	 *            retrieved.
	 * @param FileInformationClass
	 *            A FILE_INFO_BY_HANDLE_CLASS enumeration value that specifies
	 *            the type of information to be retrieved.
	 * @param lpFileInformation
	 *            A pointer to the buffer that receives the requested file
	 *            information. The structure that is returned corresponds to the
	 *            class that is specified by FileInformationClass.
	 * @param dwBufferSize
	 *            The size of the lpFileInformation buffer, in bytes.
	 * @return If the function succeeds, the return value is nonzero and file
	 *         information data is contained in the buffer pointed to by the
	 *         lpFileInformation parameter. If the function fails, the return
	...
	/**
	 * Sets the file information for the specified file. To retrieve file
	 * information using a file handle, see GetFileInformationByHandleEx.
	 * 
	 * @param hFile
	 *            A handle to the file for which to change information. This
	 ...
	 *            FILE_BASIC_INFO, FILE_RENAME_INFO, FILE_DISPOSITION_INFO,
	 *            FILE_ALLOCATION_INFO, FILE_END_OF_FILE_INFO, and
	 *            FILE_IO_PRIORITY_HINT_INFO
	 * @param lpFileInformation
	 *            A pointer to the buffer that contains the information to
	 *            change for the specified file information class. The structure
	 *            that this parameter points to corresponds to the class that is
	 *            specified by FileInformationClass.
	 * @param dwBufferSize
	 *            The size of the lpFileInformation buffer, in bytes.
	 ...
	 *         information, call GetLastError.
	 */
	boolean GetFileTime(HANDLE hFile, WinBase.FILETIME lpCreationTime, WinBase.FILETIME lpLastAccessTime,
	 ...
	 *            &quot;\\MyServer\MyShare\&quot;). Furthermore, a drive
	 *            specification must have a trailing backslash (for example,
	 *            &quot;C:\&quot;). The calling application must have
	 ...
	 *            A variable that receives the total number of free clusters on
	 *            the disk that are available to the user who is associated with
	 *            the calling thread. If per-user disk quotas are in use, this
	 *            value may be less than the total number of free clusters on
	 *            the disk.
	 ...
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364935(v=vs.85).aspx">GetDiskFreeSpace</a>
	 */
	boolean GetDiskFreeSpace(String lpRootPathName, DWORDByReference lpSectorsPerCluster, DWORDByReference lpBytesPerSector,
			DWORDByReference lpNumberOfFreeClusters, DWORDByReference lpTotalNumberOfClusters);
	 ...
	 *            A string that specifies a directory on a disk. If this
	 *            parameter is NULL, the function uses the root of the current
	 *            disk. If this parameter is a UNC name, it must include a
	 *            trailing backslash, for example, {@code \\MyServer\MyShare\}.
	 *            This parameter does not have to specify the root directory on
	 *            a disk. The function accepts any directory on a disk.
	 ...
	 *         information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364937(v=vs.85).aspx">GetDiskFreeSpaceEx</a>
	 */
	boolean GetDiskFreeSpaceEx(String lpDirectoryName, LARGE_INTEGER lpFreeBytesAvailable, LARGE_INTEGER lpTotalNumberOfBytes,
	 ...
	 * @param lpBytesRead
	 *            A variable that receives the number of bytes read from the
	 *            pipe.
	 * @param nTimeOut
	 *            The number of milliseconds to wait for the named pipe to be
	 *            available.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365144(v=vs.85).aspx">CallNamedPipe
	 *      documentation</a>
	 */
	 ...
	 * @param lpOverlapped
	 *            A pointer to an {@link WinBase.OVERLAPPED} structure.
	 * @return
	 *         <P>
	 * 		If the operation is synchronous, does not return until the
	 *         operation has completed. If the function succeeds, the return
	 *         value is {@code true}. If the function fails, the return value is
	 *         {@code false}. To get extended error information, call
	 *         {@link #GetLastError()}.
	 *         </P>
	 *         <P>
	 * 		If the operation is asynchronous, returns immediately. If the
	 *         operation is still pending, the return value is {@code false} and
	 *         {@link #GetLastError()} returns {@link #ERROR_IO_PENDING}.
	 *         </P>
	 *         <P>
	 * 		If a client connects before the function is called, the function
	 *         returns {@code false} and {@link #GetLastError()} returns
	 *         {@link #ERROR_PIPE_CONNECTED}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365146(v=vs.85).aspx">ConnectNamedPipe
	 *      documentation</a>
	 */
	...
	/**
	 * @param lpName
	 *            The unique pipe name. This string must have the following
	 *            form:
	 *            <P>
	 *            <code>
	 *        \\.\pipe\pipename
	 ...
	 *            </P>
	 *            <P>
	 * 			The <I>pipename</I> part of the name can include any character
	 *            other than a backslash, including numbers and special
	 *            characters. The entire pipe name string can be up to
	 *            {@link #MAX_PIPE_NAME_LENGTH} characters long. Pipe names are
	 *            not case sensitive.
	 *            </P>
	 * @param dwOpenMode
	 *            The open mode. The function fails if specifies anything other
	 *            than 0 or the allowed flags
	 * @param dwPipeMode
	 *            The pipe mode. The function fails if specifies anything other
	 *            than 0 or the allowed flags
	 * @param nMaxInstances
	 *            The maximum number of instances that can be created for this
	 *            pipe. Acceptable values are in the range 1 through
	 ...
	 *            The default time-out value, in milliseconds. A value of zero
	 *            will result in a default time-out of 50 milliseconds
	 * @param lpSecurityAttributes
	 *            A pointer to a {@link WinBase.SECURITY_ATTRIBUTES} structure
	 *            that specifies a security descriptor for the new named pipe.
	 *            If {@code null} the named pipe gets a default security
	 *            descriptor and the handle cannot be inherited.
	 * @return If the function succeeds, the return value is a handle to the
	 *         server end of a named pipe instance. If the function fails, the
	 *         return value is {@link #INVALID_HANDLE_VALUE}. To get extended
	 *         error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365150(v=vs.85).aspx">CreateNamedPipe
	 *      documentation</a>
	 */
	 ...
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365166(v=vs.85).aspx">DisconnectNamedPipe
	 *      documentation</a>
	 */
	 ...
	 *            The buffer to receive the computer name. <B>Note:</B> use
	 *            {@link Native#toString(char[])} to convert it to a
	 *            {@link String}
	 * @param ClientComputerNameLength
	 *            The size of the <tt>ClientComputerName</tt> buffer, in bytes.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365437(v=vs.85).aspx">GetNamedPipeClientComputerName
	 *      documentation</a>
	 */
	 ...
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365440(v=vs.85).aspx">GetNamedPipeClientProcessId
	 *      documentation</a>
	 */
	 ...
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365442(v=vs.85).aspx">GetNamedPipeClientProcessId
	 *      documentation</a>
	 */
	 ...
	 * @param lpState
	 *            A pointer to a variable that indicates the current state of
	 *            the handle. This parameter can be {@code null} if this
	 *            information is not needed.
	 * @param lpCurInstances
	 *            A pointer to a variable that receives the number of current
	 *            pipe instances. This parameter can be {@code null} if this
	 *            information is not needed.
	 * @param lpMaxCollectionCount
	 *            A pointer to a variable that receives the maximum number of
	 *            bytes to be collected on the client's computer before
	 *            transmission to the server. This parameter can be {@code null}
	 *            if this information is not needed.
	 * @param lpCollectDataTimeout
	 *            A pointer to a variable that receives the maximum time, in
	 *            milliseconds, that can pass before a remote named pipe
	 *            transfers information over the network. This parameter can be
	 *            {@code null} if this information is not needed.
	 * @param lpUserName
	 *            A buffer that receives the user name string associated with
	 *            the client application. This parameter can be {@code null} if
	 *            this information is not needed.
	 * @param nMaxUserNameSize
	 *            The size of the buffer specified by the <tt>lpUserName</tt>
	 *            parameter. This parameter is ignored if <tt>lpUserName</tt> is
	 *            {@code null}.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365443(v=vs.85).aspx">GetNamedPipeHandleState
	 *      documentation</a>
	 */
	public boolean GetNamedPipeHandleState(HANDLE hNamedPipe, IntByReference lpState, IntByReference lpCurInstances,
			IntByReference lpMaxCollectionCount, IntByReference lpCollectDataTimeout, char[] lpUserName, int nMaxUserNameSize);
	 ...
	 * @param lpFlags
	 *            A pointer to a variable that receives the type of the named
	 *            pipe. This parameter can be {@code null} if this information
	 *            is not needed.
	 * @param lpOutBufferSize
	 *            A pointer to a variable that receives the size of the buffer
	 *            for outgoing data, in bytes. This parameter can be
	 *            {@code null} if this information is not needed.
	 * @param lpInBufferSize
	 *            A pointer to a variable that receives the size of the buffer
	 *            for incoming data, in bytes. This parameter can be
	 *            {@code null} if this information is not needed.
	 * @param lpMaxInstances
	 *            A pointer to a variable that receives the maximum number of
	 *            pipe instances that can be created. This parameter can be
	 *            {@code null} if this information is not needed.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365445(v=vs.85).aspx">GetNamedPipeInfo
	 *      documentation</a>
	 */
	 ...
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365446(v=vs.85).aspx">GetNamedPipeServerProcessId
	 *      documentation</a>
	 */
	 ...
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365569(v=vs.85).aspx">GetNamedPipeServerSessionId
	 *      documentation</a>
	 */
	public boolean GetNamedPipeServerSessionId(HANDLE Pipe, ULONGByReference ServerSessionId);

	/**
	 * Copies data from a named or anonymous pipe into a buffer without removing
	 * it from the pipe.
	 * 
	 * @param hNamedPipe
	 *            A handle to the pipe.
	 * @param lpBuffer
	 *            A buffer that receives data read from the pipe. This parameter
	 *            can be {@code null} if no data is to be read.
	 * @param nBufferSize
	 *            The size of the buffer specified by the
	 *            <tt>lpBuffer parameter</tt>, in bytes. This parameter is
	 *            ignored if <tt>lpBuffer</tt> is {@code null}.
	 * @param lpBytesRead
	 *            A variable that receives the number of bytes read from the
	 *            pipe. This parameter can be {@code null} if no data is to be
	 *            read.
	 * @param lpTotalBytesAvail
	 *            A variable that receives the total number of bytes available
	 *            to be read from the pipe. This parameter can be {@code null}
	 *            if no data is to be read.
	 * @param lpBytesLeftThisMessage
	 *            A variable that receives the number of bytes remaining in this
	 *            message. This parameter can be {@code null} if no data is to
	 *            be read.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365779(v=vs.85).aspx">PeekNamedPipe
	 *      documentation</a>
	 */
	 ...
	 *            flag and a wait-mode flag. This parameter can be {@code null}
	 *            if the mode is not being set.
	 * @param lpMaxCollectionCount
	 *            The maximum number of bytes collected on the client computer
	 *            before transmission to the server. This parameter can be
	 *            {@code null} if the count is not being set.
	 * @param lpCollectDataTimeout
	 *            The maximum time, in milliseconds, that can pass before a
	 *            remote named pipe transfers information over the network. This
	 *            parameter can be {@code null} if the timeout is not being set.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365787(v=vs.85).aspx">SetNamedPipeHandleState
	 *      documentation</a>
	 */
	public boolean SetNamedPipeHandleState(HANDLE hNamedPipe, IntByReference lpMode, IntByReference lpMaxCollectionCount,
	 ...
	 * @param lpOverlapped
	 *            A pointer to an {@link WinBase.OVERLAPPED} structure. Can be
	 *            {@code null} if pipe not opened with
	 *            {@link #FILE_FLAG_OVERLAPPED}.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365790(v=vs.85).aspx">TransactNamedPipe
	 *      documentation</a>
	 */
	 ...
	 * server process has a pending {@link #ConnectNamedPipe} operation on the
	 * pipe.
	 * 
	 * @param lpNamedPipeName
	 *            The name of the named pipe. The string must include the name
	 *            of the computer on which the server process is executing. The
	 ...
	 *            </P>
	 *            <P>
	 * 			A period may be used for the <I>servername</I> if the pipe is
	 *            local.
	 *            </P>
	 * @param nTimeOut
	 ...
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365800(v=vs.85).aspx">WaitNamedPipe
	 *      documentation</a>
	 */
	 ...
	 *         error information, call GetLastError.
	 */
	boolean DeviceIoControl(HANDLE hDevice, int dwIoControlCode, Pointer lpInBuffer, int nInBufferSize, Pointer lpOutBuffer,
			int nOutBufferSize, IntByReference lpBytesReturned, Pointer lpOverlapped);
	...
	/**
	 * <P>
	 * Retrieves the environment variables for the current process. The block of
	 * variables format is as follows:
	 * </P>
	 * <p>
	 * <code>
	 *      Var1=Value1\0
	 ...
	 *         {@code null} is returned. When the data is no longer needed the
	 *         memory block must be released using
	 *         {@link #FreeEnvironmentStrings(Pointer)}
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms683187(v=vs.85).aspx">GetEnvironmentStrings
	 *      documentation</a>
	 */
	 ...
	 *            A pointer to a block of environment strings obtained by
	 *            calling the {@link #GetEnvironmentStrings()} function
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms683151(v=vs.85).aspx">FreeEnvironmentStrings
	 *      documentation</a>
	 */
	 ...
	 *         </p>
	 */
	DWORD GetPrivateProfileString(String lpAppName, String lpKeyName, String lpDefault, char[] lpReturnedString, DWORD nSize,
			String lpFileName);
	 ...
	 * @param lpLocalTime
	 *            [out] A pointer to a SYSTEMTIME structure that receives the
	 *            local time.
	 * @return status
	 */
	boolean SystemTimeToTzSpecificLocalTime(TIME_ZONE_INFORMATION lpTimeZone, SYSTEMTIME lpUniversalTime, SYSTEMTIME lpLocalTime);
	 ...
	 * 
	 * @param lpFileTime
	 *            [in] A pointer to a FILETIME structure containing the file
	 *            time to be converted to system (UTC) date and time format.
	 *            This value must be less than 0x8000000000000000. Otherwise,
	 *            the function fails.
	 * @param lpSystemTime
	 ...
	 * @param lpThreadAttributes
	 *            The {@link WinBase.SECURITY_ATTRIBUTES} structure that
	 *            specifies a security descriptor for the new thread. If
	 *            {@code null}, the thread gets a default security descriptor
	 *            and the handle cannot be inherited.
	 * @param dwStackSize
	 *            The initial size of the stack, in bytes. The system rounds
	 *            this value to the nearest page. If this parameter is 0 (zero),
	 *            the new thread uses the default size for the executable.
	 * @param lpStartAddress
	 *            The application-defined
	 *            {@link WinBase.FOREIGN_THREAD_START_ROUTINE} to be executed by
	 *            the thread and represents the starting address of the thread
	 *            in the remote process. The function must exist in the remote
	 *            process.
	 * @param lpParameter
	 ...
	 *            parameter is {@code null}, the thread identifier is not
	 *            returned.
	 * @return If the function succeeds, the return value is a handle to the new
	 *         thread. If the function fails, the return value is {@code null}.
	 *         To get extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms682437(v=vs.85).aspx">CreateRemoteThread
	 *      documentation</a>
	 */
	HANDLE CreateRemoteThread(HANDLE hProcess, WinBase.SECURITY_ATTRIBUTES lpThreadAttributes, int dwStackSize,
	 ...
	 *            written.
	 * @param lpBuffer
	 *            The buffer that contains data to be written in the address
	 *            space of the specified process.
	 * @param nSize
	 *            The number of bytes to be written to the specified process.
	 * @param lpNumberOfBytesWritten
	 *            A variable that receives the number of bytes transferred into
	 *            the specified process. If {@code null} the parameter is
	 *            ignored.
	 * @return {@code true} if successful, {@code false} otherwise. To get
	 *         extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms681674(v=vs.85).aspx">WriteProcessMemory
	 *      documentation</a>
	 */
	 ...
	 *
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms680553(v=vs.85).aspx">MSDN</a>
	 * @param hProcess
	 ...
	 * @param lpBuffer
	 *            A {@link WinNT.MEMORY_BASIC_INFORMATION} structure in which
	 ...
	 *         {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa366907(v=vs.85).aspx">VirtualQueryEx
	 *      documentation</a>
	 */
	 ...
	 * 
	 * @param dwFlags
	 *            The controllable aspects of the function - see the various
	 *            {@code DDD_XXX} constants
	 * @param lpDeviceName
	 *            The MS-DOS device name string specifying the device the
	 *            function is defining, redefining, or deleting. The device name
	 *            string must not have a colon as the last character, unless a
	 *            drive letter is being defined, redefined, or deleted. For
	 *            example, drive {@code C} would be the string &quot;C:&quot;.
	 *            In no case is a trailing backslash (&quot;\&quot;) allowed.
	 * @param lpTargetPath
	 *            The path string that will implement this device. The string is
	 *            an MS-DOS path string unless the {@code DDD_RAW_TARGET_PATH}
	 *            flag is specified, in which case this string is a path string.
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa363904(v=vs.85).aspx">DefineDosDevice</a>
	 */
	 ...
	 * 
	 * @param lpDeviceName
	 *            An MS-DOS device name string specifying the target of the
	 *            query. The device name cannot have a trailing backslash; for
	 *            example, use &quot;C:&quot;, not &quot;C:\&quot;. This
	 *            parameter can be NULL. In that case, the function will store a
	 *            list of all existing MS-DOS device names into the buffer.
	 * @param lpTargetPath
	 *            A buffer that will receive the result of the query. The
	 *            function fills this buffer with one or more null-terminated
	 *            strings. The final null-terminated string is followed by an
	 *            additional NULL. If device name is non-NULL, the function
	 *            retrieves information about the particular MS-DOS device. The
	 *            first null-terminated string stored into the buffer is the
	 *            current mapping for the device. The other null-terminated
	 *            strings represent undeleted prior mappings for the device.
	 *            Each null-terminated string stored into the buffer is the name
	 *            of an existing MS-DOS device, for example,
	 *            {@code \Device\HarddiskVolume1} or {@code \Device\Floppy0}.
	 * @param ucchMax
	 *            The maximum number of characters that can be stored into the
	 *            buffer
	 * @return If the function succeeds, the return value is the number of
	 *         characters stored into the buffer, otherwise zero. Use
	 *         {@link #GetLastError()} to get extended error information. If the
	 *         buffer is too small, the function fails and the last error code
	 *         is {@code ERROR_INSUFFICIENT_BUFFER}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365461(v=vs.85).aspx">QueryDosDevice</a>
	 */
	 ...
	 * a specific name (or partial name if wildcards are used). To specify
	 * additional attributes to use in a search, use the FindFirstFileEx
	 * function.
	 * 
	 * @param lpFileName
	 *            The directory or path, and the file name. The file name can
	 *            include wildcard characters, for example, an asterisk (*) or a
	 *            question mark (?). This parameter should not be NULL, an
	 *            invalid string (for example, an empty string or a string that
	 *            is missing the terminating null character), or end in a
	 *            trailing backslash (\). If the string ends with a wildcard,
	 *            period, or directory name, the user must have access to the
	 *            root and all subdirectories on the path. In the ANSI version
	 *            of this function, the name is limited to MAX_PATH characters.
	 ...
	 *            Naming a File. <b>Tip</b> Starting in Windows 10, version
	 *            1607, for the unicode version of this function
	 *            (FindFirstFileExW), you can opt-in to remove the MAX_PATH
	 *            character limitation without prepending "\\?\". See the
	 *            "Maximum Path Limitation" section of Naming Files, Paths, and
	 *            Namespaces for details.
	 * @param lpFindFileData
	 *            A pointer to the buffer that receives the file data. The
	 *            pointer type is determined by the level of information that is
	 ...
	 *         file or directory found. If the function fails or fails to locate
	 *         files from the search string in the lpFileName parameter, the
	 *         return value is INVALID_HANDLE_VALUE and the contents of
	 *         lpFindFileData are indeterminate. To get extended error
	 *         information, call the GetLastError function. If the function
	 *         fails because no matching files can be found, the GetLastError
	 ...
	 * attributes that match those specified. For the most basic version of this
	 * function, see FindFirstFile.
	 * 
	 * @param lpFileName
	 *            The directory or path, and the file name. The file name can
	 *            include wildcard characters, for example, an asterisk (*) or a
	 ...
	 *            Namespaces for details.
	 * @param fInfoLevelId
	 *            The information level of the returned data. This parameter is
	 *            one of the FINDEX_INFO_LEVELS enumeration values.
	 * @param lpFindFileData
	 *            A pointer to the buffer that receives the file data. The
	 *            pointer type is determined by the level of information that is
	 *            specified in the fInfoLevelId parameter.
	 * @param fSearchOp
	 *            The type of filtering to perform that is different from
	 *            wildcard matching. This parameter is one of the
	 *            FINDEX_SEARCH_OPS enumeration values.
	 * @param lpSearchFilter
	 *            A pointer to the search criteria if the specified fSearchOp
	 *            needs structured search information. At this time, none of the
	 *            supported fSearchOp values require extended search
	 *            information. Therefore, this pointer must be NULL.
	 * @param dwAdditionalFlags
	 *            Specifies additional flags that control the search.
	 *            FIND_FIRST_EX_CASE_SENSITIVE (0x01) - Searches are
	 *            case-sensitive. FIND_FIRST_EX_LARGE_FETCH (0x02) - Uses a
	 *            larger buffer for directory queries, which can increase
	 *            performance of the find operation. <b>Windows Server 2008,
	 *            Windows Vista, Windows Server 2003 and Windows XP: This value
	 *            is not supported until Windows Server 2008 R2 and Windows
	 *            7.</b>
	 * @return If the function succeeds, the return value is a search handle
	 *         used in a subsequent call to FindNextFile or FindClose, and the
	 *         lpFindFileData parameter contains information about the first
	 ...
	 *         function returns ERROR_FILE_NOT_FOUND.
	 */
	HANDLE FindFirstFileEx(String lpFileName, int fInfoLevelId, Pointer lpFindFileData, int fSearchOp, Pointer lpSearchFilter,
	 ...
	 *         or directory found. If the function fails, the return value is
	 *         zero and the contents of lpFindFileData are indeterminate. To get
	 *         extended error information, call the GetLastError function. If
	 *         the function fails because no more matching files can be found,
	...
	/**
	 * Retrieves the name of a mounted folder on the specified volume - used to
	 * begin scanning the mounted folders on a volume
	 * 
	 * @param lpszRootPathName
	 *            A volume GUID path for the volume to scan for mounted folders.
	 *            A trailing backslash is required.
	 * @param lpszVolumeMountPoint
	 *            A buffer that receives the name of the first mounted folder
	 *            that is found.
	 * @param cchBufferLength
	 *            The length of the buffer that receives the path to the mounted
	 *            folder
	 ...
	 *         Otherwise, the return value is the {@link #INVALID_HANDLE_VALUE}.
	 *         To get extended error information, call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364426(v=vs.85).aspx">FindFirstVolumeMountPoint</a>
	 */
	 ...
	 * {@link #FindFirstVolumeMountPoint(String, char[], int)} function - finds
	 * one (next) mounted folder per call.
	 * 
	 * @param hFindVolumeMountPoint
	 *            A mounted folder search handle returned by a previous call to
	 *            the {@link #FindFirstVolumeMountPoint(String, char[], int)}
	 *            function.
	 * @param lpszVolumeMountPoint
	 *            A buffer that receives the name of the (next) mounted folder
	 *            that is found.
	 * @param cchBufferLength
	 *            The length of the buffer that receives the path to the mounted
	 *            folder
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information. If no
	 *         more mount points found then the reported error is
	 *         {@code ERROR_NO_MORE_FILES}. In this case, simply call
	 *         {@link #FindVolumeMountPointClose(com.sun.jna.platform.win32.WinNT.HANDLE)}
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364432(v=vs.85).aspx">FindNextVolumeMountPoint</a>
	 */
	 ...
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364435(v=vs.85).aspx">FindVolumeMountPointClose</a>
	 */
	 ...
	 * 
	 * @param lpszVolumeMountPoint
	 *            A string that contains the path of a mounted folder (e.g.,
	 *            &quot;Y:\MountX\&quot;) or a drive letter (for example,
	 *            &quot;X:\&quot;). The string must end with a trailing
	 *            backslash.
	 * @param lpszVolumeName
	 *            A buffer that receives the volume GUID path - if there is more
	 *            than one volume GUID path for the volume, only the first one
	 *            in the mount manager's cache is returned.
	 * @param cchBufferLength
	 *            The length of the output buffer - a reasonable size for the
	 *            buffer to accommodate the largest possible volume GUID path is
	 *            at 50 characters
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364994(v=vs.85).aspx">GetVolumeNameForVolumeMountPoint</a>
	 */
	 ...
	 * 
	 * @param lpRootPathName
	 *            The volume's drive letter (for example, {@code X:\}) or the
	 *            path of a mounted folder that is associated with the volume
	 *            (for example, {@code Y:\MountX\}). The string must end with a
	 *            trailing backslash. If this parameter is NULL, the root of the
	 *            current directory is used.
	 * @param lpVolumeName
	 *            The new label for the volume. If this parameter is NULL, the
	 *            function deletes any existing label from the specified volume
	 *            and does not assign a new label.
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365560(v=vs.85).aspx">SetVolumeLabel</a>
	 */
	 ...
	 * 
	 * @param lpszVolumeMountPoint
	 *            The user-mode path to be associated with the volume. This may
	 *            be a drive letter (for example, &quot;X:\&quot;) or a
	 *            directory on another volume (for example,
	 *            &quot;Y:\MountX\&quot;). The string must end with a trailing
	 *            backslash.
	 * @param lpszVolumeName
	 ...
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa365561(v=vs.85).aspx">SetVolumeMountPoint</a>
	 */
	 ...
	 *            backslash is required, for example, &quot;X:\&quot; or
	 *            &quot;Y:\MountX\&quot;.
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa363927(v=vs.85).aspx">DeleteVolumeMountPoint</a>
	 */
	 ...
	 *            described. If this parameter is {@code null}, the root of the
	 *            current directory is used. A trailing backslash is required.
	 *            For example, you specify &quot;\\MyServer\MyShare\&quot;, or
	 *            &quot;C:\&quot;.
	 * @param lpVolumeNameBuffer
	 *            If not {@code null} then receives the name of the specified
	 *            volume. The buffer size is specified by the
	 *            <tt>nVolumeNameSize</tt> parameter.
	 * @param nVolumeNameSize
	 *            The length of the volume name buffer - max. size is
	 *            {@link WinDef#MAX_PATH} + 1 - ignored if no volume name buffer
	 *            provided
	 * @param lpVolumeSerialNumber
	 *            Receives the volume serial number - can be {@code null} if the
	 *            serial number is not required
	 * @param lpMaximumComponentLength
	 *            Receives the maximum length of a file name component that the
	 *            underlying file system supports - can be {@code null} if this
	 *            data is not required
	 * @param lpFileSystemFlags
	 *            Receives flags associated with the file system - can be
	 *            {@code null} if this data is not required
	 * @param lpFileSystemNameBuffer
	 *            If not {@code null} then receives the name of the file system.
	 *            The buffer size is specified by the
	 *            <tt>nFileSystemNameSize</tt> parameter.
	 * @param nFileSystemNameSize
	 *            The length of the file system name buffer - max. size is
	 *            {@link WinDef#MAX_PATH} + 1 - ignored if no file system name
	 *            buffer provided
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364993(v=vs.85).aspx">GetVolumeInformation</a>
	 */
	 ...
	 * 
	 * @param lpszFileName
	 *            The input path string. Both absolute and relative file and
	 *            directory names, for example &quot;..&quot;, are acceptable in
	 *            this path. If you specify a relative directory or file name
	 *            without a volume qualifier, returns the drive letter of the
	 *            boot volume. If this parameter is an empty string, the
	 *            function fails but the last error is set to
	 *            {@code ERROR_SUCCESS}.
	 * @param lpszVolumePathName
	 ...
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364996(v=vs.85).aspx">GetVolumePathName</a>
	 */
	 ...
	 * @param lpszVolumeName
	 *            A volume GUID path for the volume
	 * @param lpszVolumePathNames
	 *            A buffer that receives the list of drive letters and mounted
	 *            folder paths. The list is an array of null-terminated strings
	 *            terminated by an additional NULL character. If the buffer is
	 *            not large enough to hold the complete list, the buffer holds
	 *            as much of the list as possible.
	 * @param cchBufferLength
	 *            The available length of the buffer - including all NULL
	 *            characters.
	 * @param lpcchReturnLength
	 *            If the call is successful, this parameter is the number of
	 *            character copied to the buffer. Otherwise, this parameter is
	 *            the size of the buffer required to hold the complete list
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information. If the
	 *         buffer is not large enough to hold the complete list, the error
	 *         code is {@code ERROR_MORE_DATA} and the
	 *         <tt>lpcchReturnLength</tt> parameter receives the required buffer
	 *         size.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364998(v=vs.85).aspx">GetVolumePathNamesForVolumeName</a>
	 */
	 ...
	 * 
	 * @param lpszVolumeName
	 *            A buffer that receives a null-terminated string that specifies
	 *            a volume GUID path for the first volume that is found
	 * @param cchBufferLength
	 ...
	 *         functions. Otherwise, the return value is the
	 *         {@link #INVALID_HANDLE_VALUE}. To get extended error information,
	 *         call {@link #GetLastError()}.
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364425(v=vs.85).aspx">FindFirstVolume</a>
	 ...
	 * {@link #FindFirstVolume(char[], int)} function - finds one volume per
	 * call.
	 * 
	 * @param hFindVolume
	 ...
	 * @param lpszVolumeName
	 *            A buffer that receives a null-terminated string that specifies
	 *            a volume GUID path for the (next) path that is found
	 * @param cchBufferLength
	 *            The length of the buffer to receive the volume GUID path
	 * @return {@code true} if succeeds. If fails then call
	 *         {@link #GetLastError()} to get extended error information. If no
	 *         more volumes found then the reported error is
	 *         {@code ERROR_NO_MORE_FILES}. In this case, simply call
	 *         {@link #FindVolumeClose(com.sun.jna.platform.win32.WinNT.HANDLE)}
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364431(v=vs.85).aspx">FindNextVolume</a>
	 * @see Kernel32Util#extractVolumeGUID(String)
	 */
	 ...
	 *         {@link #GetLastError()} to get extended error information
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa364433(v=vs.85).aspx">FindVolumeClose</a>
	 */
	 ...
	 *            For more information about paths, see "Naming Files, Paths,
	 *            and Namespaces" on MSDN. <br>
	 ...
	 *
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms684218(v=vs.85).aspx">MSDN</a>
	 * @param hSnapshot
	 *            A handle to the snapshot returned from a previous call to the
	 *            CreateToolhelp32Snapshot function.
	 * @param lpme
	 ...
	 *
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms684221(v=vs.85).aspx">MSDN</a>
	 * @param hSnapshot
	 *            A handle to the snapshot returned from a previous call to the
	 *            CreateToolhelp32Snapshot function.
	 * @param lpme
	 ...
	 * 
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms680621(v=vs.85).aspx">MSDN</a>
	 * 
	 * @param umode
	 ...
	 * only accessible by their ordinal value.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * @param esFlags
	 *            The thread's execution requirements. This parameter can be one
