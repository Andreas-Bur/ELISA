 ...
 * @see <A HREF=
 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa373083(v=vs.85).aspx">Performance
 *      Counters</A>
 */
public interface Pdh extends StdCallLibrary {
	...
	/*
	 * TODO LPVOID CALLBACK AllocateMemory(_In_ SIZE_T AllocSize,_In_ LPVOID
	 * pContext) void CALLBACK FreeMemory(LPVOID pBuffer,LPVOID pContext)
	 */
	 ...
	 * 
	 * @param szMachineName
	 *            The name of the computer to connect to. If {@code null}, PDH
	 *            connects to the local computer.
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372578(v=vs.85).aspx">PdhConnectMachine</A>
	 */
	 ...
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372630(v=vs.85).aspx">PdhGetDllVersion</A>
	 */
	 ...
	 * 
	 * @param szDataSource
	 *            The name of the log file from which to retrieve performance
	 *            data. If {@code null}, performance data is collected from a
	 *            real-time data source.
	 * @param dwUserData
	 *            User-defined value to associate with this query.
	 * @param phQuery
	 *            (Out) Handle to the query. You use this handle in subsequent
	 *            calls.
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372652(v=vs.85).aspx">PdhOpenQuery</A>
	 */
	 ...
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372558(v=vs.85).aspx">PdhCloseQuery</A>
	 */
	 ...
	 * 
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa373041(v=vs.85).aspx">PDH_COUNTER_PATH_ELEMENTS</A>
	 * @see <A HREF=
	 *      "https://technet.microsoft.com/en-us/library/cc776490(v=ws.10).aspx">Windows
	 *      Server 2003 Performance Counters Reference</A>
	 */
	public class PDH_COUNTER_PATH_ELEMENTS extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("szMachineName", "szObjectName", "szInstanceName",
	 ...
	 *            Caller-allocated buffer that receives a null-terminated
	 *            counter path. The maximum length of a counter path is
	 *            PDH_MAX_COUNTER_PATH. Set to {@code null} if
	 *            <tt>pcchBufferSize</tt> is zero.
	 * @param pcchBufferSize
	 *            Size of the <tt>szFullPathBuffer</tt> buffer. If zero on
	 *            input, the function returns PDH_MORE_DATA and sets this
	 *            parameter to the required buffer size. If the buffer is larger
	 *            than the required size, the function sets this parameter to
	 *            the actual size of the buffer that was used.
	 * @param dwFlags
	 *            Format of the input and output counter values.
	 * @return ERROR_SUCCESS (or PDH_MORE_DATA)
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372649(v=vs.85).aspx">PdhMakeCounterPath</A>
	 */
	 ...
	 *            String that contains the counter path. The maximum length of a
	 *            counter path is {@link #PDH_MAX_COUNTER_PATH}.
	 * @param dwUserData
	 *            User-defined value.
	 * @param phCounter
	 ...
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372204(v=vs.85).aspx">PdhAddCounter</A>
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa373193(v=vs.85).aspx">Specifying
	 *      a Counter Path</A>
	 */
	 ...
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372665(v=vs.85).aspx">PdhRemoveCounter</A>
	 */
	 ...
	 * 
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa373060(v=vs.85).aspx">PDH_RAW_COUNTER</A>
	 */
	public class PDH_RAW_COUNTER extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("CStatus", "TimeStamp", "FirstValue", "SecondValue",
				"MultiCount");
		...
		/**
		 * If the counter type contains the PERF_MULTI_COUNTER flag, this member
		 * contains the additional counter data used in the calculation
		 */
	...
	/**
	 * @param hCounter
	 *            Handle of the counter from which to retrieve the current raw
	 *            value.
	 * @param lpdwType
	 *            Receives the counter type - this parameter is optional
	 * @param pValue
	 *            The {@link PDH_RAW_COUNTER} structure to receive the data
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372644(v=vs.85).aspx">PdhGetRawCounterValue</A>
	 */
	...
	/**
	 * Validates that the counter is present on the computer specified in the
	 * counter path.
	 * 
	 * @param szFullCounterPath
	 ...
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372986(v=vs.85).aspx">PdhValidatePath</A>
	 */
	 ...
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372563(v=vs.85).aspx">PdhCollectQueryData</A>
	 */
	int PdhCollectQueryData(HANDLE hQuery);

	/**
	 * Uses a separate thread to collect the current raw data value for all
	 * counters in the specified query. The function then signals the
	 * application-defined event and waits the specified time interval before
	 * returning.
	 * 
	 * @param hQuery
	 *            Handle to the query
	 ...
	 * @param hNewDataEvent
	 *            Handle to the event that you want PDH to signal after the time
	 *            interval expires. To create an event object, call the
	 *            {@link Kernel32#CreateEvent(com.sun.jna.platform.win32.WinBase.SECURITY_ATTRIBUTES, boolean, boolean, String)}
	 *            function
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372566(v=vs.85).aspx">PdhCollectQueryDataEx</A>
	 */
	 ...
	 *            Handle to the query
	 * @param pllTimeStamp
	 *            Time stamp when the first counter value in the query was
	 *            retrieved. The time is specified as {@link WinBase.FILETIME}.
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372569(v=vs.85).aspx">PdhCollectQueryDataWithTime</A>
	 */
	int PdhCollectQueryDataWithTime(HANDLE hQuery, LONGLONGByReference pllTimeStamp);

	/**
	 * Information on time intervals as applied to the sampling of performance
	 * data.
	 * 
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa373071(v=vs.85).aspx">PDH_TIME_INFO</A>
	 */
	 ...
	 *            Handle to the query.
	 * @param pInfo
	 *            A {@link PDH_TIME_INFO} structure that specifies the time
	 *            range.
	 * @return ERROR_SUCCESS if successful
	 * @see <A HREF=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa372677(v=vs.85).aspx">PdhSetQueryTimeRange</A>
	 */
