...
public class Context {
	 ...
	 *
	 * @param path
	 *            path to XML-resource with configuration
	 * @param config
	 *            configuration
	 * @throws MalformedURLException
	 *             if failed to load configuration file
	 ...
	 *
	 * It also reads feat.params which should be located at the root of acoustic
	 * model and sets corresponding parameters of
	 * {@link MelFrequencyFilterBank2} instance.
	 *
	 * @param path
	 *            path to directory with acoustic model files
	 *
	 * @throws IOException
	 *             if failed to read feat.params
	 */
	 ...
	 *
	 * @param path
	 *            path to directory with dictionary files
	 */
	 ...
	 *
	 * Enables static grammar and disables probabilistic language model. JSGF
	 * and GrXML formats are supported.
	 *
	 * @param path
	 *            path to the grammar files
	 * @param name
	 *            name of the main grammar to use
	 ...
	 *             if path ends with unsupported extension
	 */
