...
/**
 * Shows the configuration currently in use. This monitor is typically added as
 * a recognition monitor such that the configuration is shown immediately after
 * the recognizer is allocated.
 */
public class ConfigMonitor implements Configurable, Runnable, Monitor {

	/**
	 * The property that is used to indicate whether or not this monitor should
	...
	/**
	 * The property that is used to indicate whether or not this monitor should
	 * dump the configuration in an HTML document
	 */
	@S4Boolean(defaultValue = false)
	...
	/**
	 * The property that is used to indicate whether or not this monitor should
	 * dump the configuration in an GDL document
	 */
	@S4Boolean(defaultValue = false)
	...
	/**
	 * The property that is used to indicate whether or not this monitor should
	 * save the configuration in an XML document
	 */
	@S4Boolean(defaultValue = false)
