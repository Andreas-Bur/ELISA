...
/**
 * Tracks and reports recognition accuracy based upon the highest scoring path
 * in a Result.
 */
public class BestPathAccuracyTracker extends AccuracyTracker {
	...
	public BestPathAccuracyTracker(Recognizer recognizer, boolean showSummary, boolean showDetails, boolean showResults,
			boolean showAlignedResults, boolean showRawResults, boolean showFullPath) {
