...
/**
 * Defines the Bark frequency warping function. This class provides methods to
 * convert frequencies from a linear scale to the bark scale. The bark scale is
 * originated from measurements of the critical bandwidth. Please find more
 * details in books about psychoacoustics or speech analysis/recognition.
 *
...
public class FrequencyWarper {
	 ...
	 * <p>
	 * Compute Bark frequency from linear frequency in Hertz. The function is:
	...
	/**
	 * Compute linear frequency in Hertz from Bark frequency. The function is:
