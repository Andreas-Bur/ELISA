...
public class Microphone extends BaseDataProcessor {
	...
	public Microphone(int sampleRate, int bitsPerSample, int channels, boolean bigEndian, boolean signed,
			boolean closeBetweenUtterances, int msecPerRead, boolean keepLastAudio, String stereoToMono, int selectedChannel,
			String selectedMixerIndex, int audioBufferSize) {
		initLogger();
	...
	public void initialize() {
		...
		if (!AudioSystem.isLineSupported(info)) {
			...
			if (nativeFormat == null) {
				...
				if (doConversion) {
					logger.info(
							"Converting from " + finalFormat.getSampleRate() + "Hz to " + desiredFormat.getSampleRate() + "Hz");
				} else {
