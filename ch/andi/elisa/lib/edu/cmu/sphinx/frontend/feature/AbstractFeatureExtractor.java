 ...
 * main purpose of this it to collect window size cepstra frames in a buffer and
 * let the extractor compute the feature frame with them.
 */
public abstract class AbstractFeatureExtractor extends BaseDataProcessor {
	...
	/**
	 * Resets the DeltasFeatureExtractor to be ready to read the next segment of
	 * data.
	 */
	private void reset() {
		bufferPosition = 0;
