...
public class Utterance {
	 ...
	 *
	 * @param name
	 *            the name of this Utterance, e.g., it can be the name of the
	 *            audio file where the audio came from
	 * @param format
	 *            the audio format of this Utterance
	 */
	...
	public float getAudioTime() {
		return audioBuffer.size() / (audioFormat.getSampleRate() * audioFormat.getSampleSizeInBits() / 8);
	}
