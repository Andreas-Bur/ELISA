 ...
 * data as input, and outputs the same {@link Data}object, but with preemphasis
 * applied. For each value X[i] in the input Data object X, the following
 ...
 * {@link #PROP_PREEMPHASIS_FACTOR} of 0.97. A common value for this factor is
 ...
 * usually contain much less energy than lower frequency components, even though
 * they are still important for speech recognition. It is a high-pass filter
 * because it allows the high frequency components to "pass through", while
 * weakening or filtering out the low frequency components.
 */
public class Preemphasizer extends BaseDataProcessor {
	...
	/**
	 * Returns the next Data object being processed by this Preemphasizer, or if
	 * it is a Signal, it is returned without modification.
	 *
