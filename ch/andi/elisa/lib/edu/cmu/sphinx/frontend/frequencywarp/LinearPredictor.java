...
public class LinearPredictor {
	 ...
	 *
	 * @param RC
	 *            double array of reflection coefficients. The RC array must
	 ...
	 *
	 * @param ceporder
	 *            is the order of the LPC cepstral vector to be computed.
	 * @return LPC cepstra
	 */
	 ...
	 *
	 * @param warp
	 *            is the warping coefficient. For 16KHz speech 0.6 is good
	 *            valued.
	 * @param nbilincepstra
	 *            is the number of bilinear cepstral values to be computed from
	 *            the linear frequency cepstrum.
