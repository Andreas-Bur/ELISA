...
public class DoubleData extends OVector implements Data {
	...
	/**
	 * Constructs a new <code>Data</code> object with values only. All other
	 * internal fields like sampling rate etc. are initialized to -1.
	 * 
	 * @param values
	 *            source values
	 */
	...
	/**
	 * Constructs a Data object with the given values, collect time, and first
	 * sample number.
	 *
	 * @param values
	 *            the data values
	 ...
	 * @param firstSampleNumber
	 *            the position of the first sample in the original data
	 */
	public DoubleData(double[] values, int sampleRate, long firstSampleNumber) {
		super(values);
	...
	public String toString() {
		return ("DoubleData: " + sampleRate + "Hz, first sample #: " + firstSampleNumber + ", collect time: " + collectTime);
	}
	...
	/**
	 * @return the position of the first sample in the original data. The very
	 *         first sample number is zero.
	 */
	 ...
	 *
	 * @return the difference, in milliseconds, between the time the audio data
	 *         is collected and midnight, January 1, 1970
	 */
