...
/**
 * Creates push-branches out of a Frontend. This might be used for for
 * push-decoding or to create new pull-streams
 *
...
public class FrontEndSplitter extends BaseDataProcessor implements DataProducer {
	...
	/**
	 * Reads and returns the next Data frame or return <code>null</code> if no
	 * data is available.
	 *
