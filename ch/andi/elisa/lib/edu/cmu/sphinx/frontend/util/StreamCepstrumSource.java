...
/**
 * Produces Mel-cepstrum data from an InputStream. To set the inputstream with
 * cepstral data, use the {@link #setInputStream(InputStream,boolean)
...
public class StreamCepstrumSource extends BaseDataProcessor {
	 ...
	 */
	public void setInputStream(InputStream is, boolean bigEndian) throws IOException {
