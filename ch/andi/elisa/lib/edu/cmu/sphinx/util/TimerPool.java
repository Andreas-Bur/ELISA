...
/**
 * Keeps references to a list of timers which can be referenced by a key-pair
 * consisting of an owner and a timer name.
 *
...
public class TimerPool {
	 ...
	 *            owner of the timer
	 * @param timerName
	 *            the name of the particular timer to retrieve. If the timer
	...
	private static void showTimesShortTitle(Logger logger) {
		...
		logger.info(Utilities.pad("# Name", 20) + ' ' + Utilities.pad("Count", 8) + Utilities.pad("CurTime", 10)
				+ Utilities.pad("MinTime", 10) + Utilities.pad("MaxTime", 10) + Utilities.pad("AvgTime", 10)
