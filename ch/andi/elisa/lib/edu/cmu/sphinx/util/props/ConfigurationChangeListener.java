...
public interface ConfigurationChangeListener {
	 ...
	 * <code>configurableName</code> was changed.
	 *
	 ...
	 * @param cm
	 *            The <code>ConfigurationManager</code>-instance this component
	 *            is registered to
	 */
	public void configurationChanged(String configurableName, String propertyName, ConfigurationManager cm);

	/**
	 * Called if a new compoenent defined by <code>ps</code> was registered to
	 * the ConfigurationManager <code>cm</code>.
	 * 
	 * @param cm
	...
	/**
	 * Called if a compoenent defined by <code>ps</code> was unregistered
	 * (removed) from the ConfigurationManager <code>cm</code>.
	 * 
	 * @param cm
	 *            Configuration manager
	 * @param ps
