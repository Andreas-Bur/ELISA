...
public class Import {
	 ...
	 * basename.output.syms - basename.fst.txt First argument is the java binary
	 * model filename, second argument openfst's files basename
	 *
	 * @param args
	 *            arguments
	 * @throws IOException
