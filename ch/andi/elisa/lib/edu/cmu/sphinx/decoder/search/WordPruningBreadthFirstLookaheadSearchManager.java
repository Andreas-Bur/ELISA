...
public class WordPruningBreadthFirstLookaheadSearchManager extends WordPruningBreadthFirstSearchManager {
	 ...
	 * @param fastmatchLinguist
	 *            a linguist for fast search space
	 * @param pruner
	 ...
	 * @param fastmatchActiveListFactory
	 *            fast match active list factor to store phoneloop tokens
