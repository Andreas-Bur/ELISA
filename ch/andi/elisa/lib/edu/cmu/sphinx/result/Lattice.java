...
public class Lattice {
	...
	/**
	 * Get the initialNode for this Lattice. This corresponds usually to the
	 * &lt;s&gt; symbol
	 * 
	...
	/**
	 * Set the initialNode for this Lattice. This corresponds usually to the
	 * &lt;s&gt; symbol
	 * 
	 * @param initialNode
	 *            node to set as initial
	 */
	...
	public void computeNodePosteriors(float languageModelWeightAdjustment, boolean useAcousticScoresOnly) {
		...
		for (Node currentNode : sortedNodes) {
			for (Edge edge : currentNode.getLeavingEdges()) {
				...
				edge.getToNode()
						.setForwardScore(logMath.addAsLinear((float) forwardProb, (float) edge.getToNode().getForwardScore()));
