...
public class SimpleTranscript implements Transcript {
	...
	private StringTokenizer words; // string tokenizer for current
									// transcription.
	 ...
	 *
	 * @param dictionary
	 *            this transcript's dictionary
	 * @param isExact
	 *            whether the transcription is exact
	 */
	 ...
	 *            whether the transcription is exact
	 * @param wordSeparator
	 *            string containing the word separator characters.
	 */
