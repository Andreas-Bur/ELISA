...
/**
 * Indicates stages during training. The numbers prepended to the names indicate
 * the order in which they are performed. Consecutive numbers were avoided to
 * allow for future expansion of alternative stages. The value of the numbers
 * has no bearing on the importance or duration of each stage, it is just an
 * ordering method.
 */
public class Stage {
