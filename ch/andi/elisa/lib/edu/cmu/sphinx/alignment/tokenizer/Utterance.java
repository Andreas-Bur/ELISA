 ...
 * modified by various UtteranceProcessor implementations. An utterance contains
 * a set of Features (essential a set of properties) and a set of Relations. A
 * Relation is an ordered set of Item graphs. The utterance contains a set of
 * features and implements FeatureSet so that applications can set/get features
 * directly from the utterance. If a feature query is not found in the utterance
 * feature set, the query is forwarded to the FeatureSet of the voice associated
 * with the utterance.
 */
public class Utterance {
	 ...
	 *
	 * @param tokenizer
	 *            tokenizer to use for utterance.
	 */
	...
	/**
	 * Sets the token list for this utterance. Note that this could be optimized
	 * by turning the token list directly into the token relation.
	 *
	 * @param tokenList
	 *            the tokenList
	 *
