...
public class ItemContents {
	...
	/**
	 * Adds the given item to the set of relations. Whenever an item is added to
	 * a relation, it should add the name and the Item reference to this set of
	 * name/item mappings. This allows an item to find out the set of all
	 ...
	 *
	 * @return the item associated with this ItemContents in the named relation,
