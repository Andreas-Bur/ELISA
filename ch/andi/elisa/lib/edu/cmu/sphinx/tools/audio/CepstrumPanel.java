...
public class CepstrumPanel extends JPanel {
	...
	/**
	 * Offset factor - what will be subtracted from the image to adjust for
	 * noise level.
	 */
	...
	protected void computeCepstrum() {
		try {
			...
			/*
			 * Run through all the spectra one at a time and convert them to an
			 * log intensity value.
			 */
	...
	/**
	 * Updates the offset factor used to calculate the greyscale values from the
	 * intensities. This also calculates and populates all the greyscale values
	 * in the image.
	 *
	 * @param offsetFactor
	 *            the offset factor used to calculate the greyscale values from
	 *            the intensities; this is used to adjust the level of
	 *            background noise that shows up in the image
	 */
	 ...
	 *
	 * @param g
	 *            The <code>Graphics</code> to draw on.
	 */
	@Override
