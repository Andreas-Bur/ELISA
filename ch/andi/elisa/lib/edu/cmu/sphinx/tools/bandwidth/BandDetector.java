 ...
 * 
 * A paper on the subject is "DETECTING BANDLIMITED AUDIO IN BROADCAST
 * TELEVISION SHOWS" by by Mark C. Fuhs, Qin Jin and Tanja Schultz where spline
 * approximation is proposed for detection. However, the paper seems to contain
 * a fundamental flaw. The decision is made on average spectrum, not per-frame.
 * This probably leads to omission of the events in high frequency which might
 * signal about wide band.
 */
public class BandDetector {
	...
	public BandDetector() {
		...
		MelFrequencyFilterBank filterbank = new MelFrequencyFilterBank(130.0, 6800.0, bands);
