...
public class FilenameDialog extends JDialog {
	 ...
	 * @param modal
	 *            if true, this dialog box is modal
	 * @param title
	 *            the title for the login box
	 */
	public FilenameDialog(Frame parent, boolean modal, String title) {
		super(parent, modal);
		setTitle(title);
	...
	void createFilenamePanel() {
		...
		constraints = new GridBagConstraints(0, 0, 1, 1, // x, y, width, height
		...
		constraints = new GridBagConstraints(1, 0, 1, 1, // x, y, width, height
		...
		constraints = new GridBagConstraints(0, 2, 2, 1, // x, y, width, height
				1.0, 1.0, // weightx, weighty
