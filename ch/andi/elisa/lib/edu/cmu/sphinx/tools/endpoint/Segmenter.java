...
public class Segmenter {
	...
	public static void main(String[] argv) throws MalformedURLException, IOException {
		...
		if ((inputFile == null && inputCtl == null) || outputFile == null) {
			System.out.println("Usage: java  -cp lib/batch.jar:lib/sphinx4.jar edu.cmu.sphinx.tools.endpoint.Segmenter "
	...
	static private void processFile(String inputFile, String outputFile, ConfigurationManager cm)
	...
	static private void processCtl(String inputCtl, String inputFolder, String outputFolder, ConfigurationManager cm)
			throws MalformedURLException, IOException {
