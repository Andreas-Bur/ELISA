...
/**
 * Represents a single transition out of a grammar node. The grammar represented
 * is a stochastic grammar, each transition has a probability associated with
 * it. The probabilities are relative and are not necessarily constrained to
 * total 1.0.
 * <p>
