...
/**
 * Mixture component with partial score computation result. Allows to skip score
 * computing if temporary score reaches provided threshold
 */
...
public class PrunableMixtureComponent extends MixtureComponent {
	...
	public PrunableMixtureComponent(float[] mean, float[][] meanTransformationMatrix, float[] meanTransformationVector,
			float[] variance, float[][] varianceTransformationMatrix, float[] varianceTransformationVector, float distFloor,
			float varianceFloor, int id) {
		super(mean, meanTransformationMatrix, meanTransformationVector, variance, varianceTransformationMatrix,
