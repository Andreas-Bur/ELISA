...
/**
 * The only purpose of this class is to present all classes as words in the
 * getWord() method. This dictionary must be injected to a class LM as a
 * dictionary, otherwise classes will be treated as OOVs.
 *
 * @author Tanel Alumae
 */
