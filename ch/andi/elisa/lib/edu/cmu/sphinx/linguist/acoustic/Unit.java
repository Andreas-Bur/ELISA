...
/**
 * Represents a unit of speech. Units may represent phones, words or any other
 * suitable unit
 */
...
public class Unit {
	...
	/**
	 * Constructs a context independent unit. Constructors are package private,
	 * use the UnitManager to create and access units.
	 *
	 * @param name
	...
	/**
	 * Constructs a context dependent unit. Constructors are package private,
	 * use the UnitManager to create and access units.
	 *
	 * @param baseUnit
	 *            the base id for the unit
	...
	/**
	 * calculates a hashCode for this unit. Since we defined an equals for Unit,
	 * we must define a hashCode as well
	 *
	...
	/**
	 * Checks to see if the given unit with associated contexts is a partial
	 * match for this unit. Zero, One or both contexts can be null. A null
	 * context matches any context
	 *
	 * @param name
	 *            the name of the unit
	 * @param context
	...
	/**
	 * Creates and returns an empty context with the given size. The context is
	 * padded with SIL filler
	 *
	 * @param size
