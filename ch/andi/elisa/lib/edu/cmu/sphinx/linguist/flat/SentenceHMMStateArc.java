...
/**
 * Represents a transition in a sentence HMM. Each transition is described by
 * the next state and the associated acoustic and language probability for the
 * transition.
 * <p>
...
public class SentenceHMMStateArc implements SearchStateArc {
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			return nextState == other.nextState && logLanguageProbability == other.logLanguageProbability
