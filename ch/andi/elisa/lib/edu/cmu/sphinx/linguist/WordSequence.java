...
public final class WordSequence implements Comparable<WordSequence> {
	 ...
	 */
	public final static Comparator<WordSequence> OLDEST_COMPARATOR = new Comparator<WordSequence>() {
	...
	public static WordSequence asWordSequence(final Dictionary dictionary, String... words) {
