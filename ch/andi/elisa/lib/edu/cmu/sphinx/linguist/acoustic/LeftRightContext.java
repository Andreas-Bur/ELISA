...
public class LeftRightContext extends Context {
	 ...
	 *
	 * @param leftContext
	 *            the left context or null if no left context
	 * @param rightContext
	...
	/**
	 * Checks to see if there is a partial match with the given context. If both
	 * contexts are LeftRightContexts then a left or right context that is null
	 * is considered a wild card and matches anything, othewise the contexts
	 * must match exactly. Anything matches the Context.EMPTY_CONTEXT
	 *
	 * @param context
