...
public class Sphinx3Saver implements Saver {
	...
	/**
	 * The property specifying whether the transition matrices of the acoustic
	 * model is in sparse form, i.e., omitting the zeros of the
	...
	/**
	 * Saves the sphinx3 density file, a set of density arrays are created and
