...
/**
 * Class for ngram weights quantation. Stores quantation tables for each ngram
 * order for probabilities and backoffs, while ngrams store pointers to this
 * tables. Size of table is specified by quantation parameter, for default
 * QUANT_16 each weight has 65k entries table.
 */
...
public class NgramTrieQuant {
	 ...
	 * @param order
	 *            - ngrams order which quantation table corresponds to
	 * @param isProb
	 *            - specifies if provided table is for probability (backoffs
	 *            otherwise)
	 */
	 ...
	 * 
	 * @return amount of bits required to store quantized probability and
	 *         backoff
	 */
	...
	/**
	 * Returns actual weight value for specified table and encoded weight from
	 * trie
	 * 
	 * @param tableIdx
	 *            - index of table to look in. Is calculated
	 * @param encodedVal
	...
	/**
	 * Reads encoded probability from provided trie bit array and decodes it
	 * into actual value for specific ngram
	 * 
	 * @param bitArr
	 *            - trie bit array
	 * @param memPtr
	 ...
	 * @param bitOffset
	 *            - offset from memPtr that is calculated according to ngram
	 *            index
	 * @param orderMinusTwo
	...
	/**
	 * Reads encoded backoff from provided trie bit array and decodes it into
	 * actual value for specific ngram
	 * 
	 * @param bitArr
	 *            - trie bit array
	 * @param memPtr
