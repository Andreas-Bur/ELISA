...
public class AudioPanel extends JPanel implements MouseMotionListener, MouseListener {
	...
	/**
	 * Creates a new AudioPanel. The scale factors represent how much to scale
	 * the audio. A scaleX factor of 1.0f means one pixel per sample, and a
	 * scaleY factor of 1.0f means one pixel per resolution of the sample (e.g.,
	 * a scale of 1.0f would take 2**16 pixels).
	 *
	 * @param audioData
	 *            the AudioData to draw
	 * @param scaleX
	 *            how much to scale the width of the audio
	 * @param scaleY
	 *            how much to scale the height
	 */
	...
	/**
	 * Returns the index of the sample representing the end of the selection. -1
	 * means the very end.
	 *
	...
	/**
	 * Sets the index of the sample of representing the end of the selection. -1
	 * means the very end.
	 *
	 * @param newEnd
	...
	/**
	 * Crops the audio data between the start and end selections. All audio data
	 * outside the region will be permanently lost. The selection will be reset
	 * to the very beginning and very end of the cropped clip.
	 *
	 * @see #getSelectionStart
	 * @see #getSelectionEnd
	 */
