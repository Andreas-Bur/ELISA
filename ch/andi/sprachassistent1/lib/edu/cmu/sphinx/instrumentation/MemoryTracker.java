...
public class MemoryTracker extends ConfigurableAdapter implements ResultListener, StateListener, Monitor {
	...
	private void calculateMemoryUsage(boolean show) {
		...
		if (show) {
			...
			logger.info("   Used: This: " + memFormat.format(usedMem) + "  " + "Avg: " + memFormat.format(avgMemoryUsed) + "  "
