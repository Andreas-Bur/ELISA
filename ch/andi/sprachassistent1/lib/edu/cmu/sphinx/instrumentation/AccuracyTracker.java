...
abstract public class AccuracyTracker extends ConfigurableAdapter implements ResultListener, Resetable, StateListener, Monitor {
	...
	/**
	 * The property that defines whether recognition results should be
	 * displayed.
	 */
	@S4Boolean(defaultValue = true)
	...
	public AccuracyTracker(Recognizer recognizer, boolean showSummary, boolean showDetails, boolean showResults,
			boolean showAlignedResults, boolean showRawResults) {
