...
/**
 * Class that provides utils to load NgramTrieModel from binary file created
 * with sphinx_lm_convert. Routines should be called in certain order according
 * to format:
 * <ul>
 * <li>verifyHeader</li>
 * <li>readCounts</li>
...
public class BinaryLoader {
	 ...
	 * 
	 * @param order
	 *            - max order of ngrams for this model
	 ...
	 * 
	 * @param count
	 *            - amount of unigrams according to counts previously read
	 * @return array of language model unigrams, see
	 *         {@link NgramTrieModel.TrieUnigram}
	 * @throws IOException
	 *             if reading from stream failed
	 */
	...
	/**
	 * Reads trie in form of byte array into provided array. Size of byte array
	 * is computed from previously read language model specifications, see
	 * {@link NgramTrie}
	 * 
	 * @param arr
	 *            - byte array to read trie to
	 * @throws IOException
	 *             if reading from stream failed
	 */
	...
	/**
	 * Reads vocabulary of language model. Ordinal number of word stays for
	 * wordId.
	 * 
	 * @param unigramNum
	 *            - amount of unigrams
	...
	/**
	 * Reads language model max depth. Order is stored in uint8 or in byte
	 * 
	...
	/**
	 * Reads float array of specified length. Quantation tables are stored in
	 * form of float arrays, see {@link readQuant}
	 * 
	 * @param len
