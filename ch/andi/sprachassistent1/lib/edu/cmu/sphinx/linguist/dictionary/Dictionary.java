...
/**
 * Provides a generic interface to a dictionary. The dictionary is responsible
...
public interface Dictionary extends Configurable {
	...
	/**
	 * The property that specifies the word to substitute when a lookup fails to
	 * find the word in the dictionary. If this is not set, no substitute is
	 * performed.
	 */
	...
	/**
	 * The property that defines the name of the unit manager that is used to
	 * convert strings to Unit objects
	 */
