...
/**
 * Implements a buffer that contains NGrams. It assumes that the first two bytes
 * of each n-gram entry is the ID of the n-gram.
 */
...
class NGramBuffer {
	 ...
	 *
	 * @param buffer
	 *            the byte[] with NGrams
	 * @param numberNGrams
	 *            the number of N-gram
	 * @param bigEndian
	 *            the buffer's endianness
	 * @param is32bits
	 *            whether the buffer is 16 or 32 bits
	 * @param n
	 *            the buffer's order
	 * @param firstNGramEntry
	 *            the first NGram Entry
	 */
	...
	/**
	 * Returns the word ID of the nth follower, assuming that the ID is the
	 * first two bytes of the NGram entry.
	 *
	 * @param nthFollower
	 *            starts from 0 to (numberFollowers - 1).
	 * @return the word ID
	 */
	 ...
	 *
	 * @param used
	 *            true if this buffer was used in the last utterance, false
	 *            otherwise
	 */
