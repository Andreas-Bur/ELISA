...
/**
 * Language model that reads whole model into memory. Useful for loading
 * language models from resources or external locations.
 * 
...
public class BinaryStreamLoader extends BinaryLoader {
	...
	public BinaryStreamLoader(URL location, String format, boolean applyLanguageWeightAndWip, float languageWeight, double wip,
			float unigramWeight) throws IOException {
		super(format, applyLanguageWeightAndWip, languageWeight, wip, unigramWeight);
