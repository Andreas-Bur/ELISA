 ...
 * which is called by the {@link #getScore} method to calculate the score for
 * each cache miss.
 * <p>
 * Note: this implementation is thread-safe and can be safely used across
...
public abstract class ScoreCachingSenone implements Senone {
	...
	/**
	 * Gets the cached score for this senone based upon the given feature. If
	 * the score was not cached, it is calculated using {@link #calculateScore},
