...
/**
 * Represents a composite senone. A composite senone consists of a set of all
 * possible {@link Senone senones} for a given state. CompositeSenones are used
 * when the exact context of a senone is not known. The CompositeSenone
...
public class CompositeSenone extends ScoreCachingSenone {
	 ...
	 *
	 * @param senones
	 *            the set of constituent senones
	 * @param weight
	 *            weigth for composition
	 */
	...
	/**
	 * Calculates the composite senone score. Typically this is the best score
	 * for all of the constituent senones
	 */
	@Override
	...
	/**
	 * Calculate scores for each component in the senone's distribution. Not yet
	 * implemented.
	 *
	 * @param feature
	 *            the current feature
	...
	/**
	 * Returns the set of senones that compose this composite senone. This
	 * method is only needed for unit testing.
	 *
