...
/**
 * Defines possible positions of HMMs. Note that even though the positions are
 * defined to be within words, some recognizers may classify positions in terms
 * of other elements besides words.
 */
