...
final class HmmState {
	...
	public String toString() {
		return String.format("HmmSate {%d, %d, %s}", id, pdfClass, transitions);
	}
}
...
final class Triple {
	...
	public boolean equals(Object object) {
		...
		return phone == other.phone && hmmState == other.hmmState && pdf == other.pdf;
	}
...
public class TransitionModel {
	 ...
	 *
	 * @param phone
	 *            central phone in the context
	 * @param pdfs
	 *            array of pdf identifiers of the context units
	 *
	 * @return 4 by 4 matrix where cell i,j contains probability in
	 *         {@link LogMath} domain of transition from state i to state j
	 */
