...
public class NgramTrieBitarr {
	...
	/**
	 * Reads integer from byte array for specified memory pointer, offset from
	 * this pointer and mask of value that is read.
	 * 
	 * @param memPtr
	 *            - memory pointer for specific ngram order
	 * @param bitOffset
	 *            - offset from memPtr that is calculated according to ngram
	 *            index and type of value that is read.
	 * @param mask
	 *            - bit mask of value that is read
	...
	/**
	 * Reads negative float from byte array for specified memory pointer and
	 * offset from this pointer. Used to read uncompressed float, i.e. in case
	 * quantation was not applied
	 * 
	 * @param memPtr
	 *            - memory pointer for specific ngram order
	 * @param bitOffset
	...
	/**
	 * Reads float from byte array for specified memory pointer and offset from
	 * this pointer. Used to read uncompressed float, i.e. in case quantation
	 * was not applied
	 * 
	 * @param memPtr
	 *            - memory pointer for specific ngram order
