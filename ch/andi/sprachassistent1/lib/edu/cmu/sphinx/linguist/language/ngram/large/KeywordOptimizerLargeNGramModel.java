...
/**
 * Use a largeNGramModel that also can be adjusted depending on context. A model
 * that optimizes the search by giving a preference to the list of keywords.
 * <p>
 * Example of use in calling program using config file: <br>
 * <code>
 ...
 *          </code>
 * <p>
 * Create hashProbs by loading keywords and changes to probabilities, string,
 * float pairs. Keywords may be all lower case.<br>
 * <code>
