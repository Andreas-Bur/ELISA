...
/**
 * Manages HMMs. This HMMManager groups
 * {@link edu.cmu.sphinx.linguist.acoustic.HMM HMMs} together by their
...
public class HMMManager implements Iterable<HMM> {
	 ...
	 * @return the HMM for the unit at the given position or null if no HMM at
	 *         the position could be found
	 */
