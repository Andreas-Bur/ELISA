...
public interface JSGFParserConstants {
	...
	String[] tokenImage = { "<EOF>", "\" \"", "\"\\t\"", "\"\\n\"", "\"\\r\"", "\"\\f\"", "\"//\"", "<token of kind 7>", "\"/*\"",
			"<SINGLE_LINE_COMMENT>", "\"*/\"", "\"*/\"", "<token of kind 12>", "\"grammar\"", "\"import\"", "\"public\"",
			"<INTEGER_LITERAL>", "<DECIMAL_LITERAL>", "<FLOATING_POINT_LITERAL>", "<EXPONENT>", "<CHARACTER_LITERAL>",
			"<STRING_LITERAL>", "<TAG>", "<IDENTIFIER>", "<LETTER>", "<DIGIT>", "\";\"", "\"V1.0\"", "\"<\"", "\".\"", "\"*\"",
			"\">\"", "\"=\"", "\"|\"", "\"/\"", "\"+\"", "\"(\"", "\")\"", "\"[\"", "\"]\"", };
