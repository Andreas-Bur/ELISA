 ...
 * result has been obtained, <code> terminate </code> should be called.
 * <p>
 * All scores and probabilities are maintained in the log math log domain.
 * <p>
 * For information about breadth first search please refer to "Spoken Language
 * Processing", X. Huang, PTR
 */
...
public class SimpleBreadthFirstSearchManager extends TokenSearchManager {
	 ...
	 * @param pruner
	 *            pruner to prune extra paths
	 * @param scorer
	 *            scorer to estimate token probability
	 * @param activeListFactory
	 *            factory for list of tokens
	 * @param showTokenCount
	 *            show count of the tokens during decoding
	 * @param relativeWordBeamWidth
	 *            relative pruning beam for lookahead
	 * @param growSkipInterval
	 *            interval to skip growth step
	 * @param wantEntryPruning
	 *            entry pruning
	 */
	public SimpleBreadthFirstSearchManager(Linguist linguist, Pruner pruner, AcousticScorer scorer,
			ActiveListFactory activeListFactory, boolean showTokenCount, double relativeWordBeamWidth, int growSkipInterval,
