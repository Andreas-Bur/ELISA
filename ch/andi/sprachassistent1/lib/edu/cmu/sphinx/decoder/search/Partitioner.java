...
/**
 * Partitions a list of tokens according to the token score, used in
 * {@link PartitionActiveListFactory}. This method is supposed to provide O(n)
 * performance so it's more preferable than
 */
public class Partitioner {
	...
	/**
	 * Partitions sub-array of tokens around the end token. Put all elements
	 * less or equal then pivot to the start of the array, shifting new pivot
	 * position
	 *
	 * @param tokens
	 *            the token array to partition
	 * @param start
	 *            the starting index of the subarray
	 * @param end
	 *            the pivot and the ending index of the subarray, inclusive
	 * @return the index (after partitioning) of the element around which the
	...
	/**
	 * Partitions sub-array of tokens around the x-th token by selecting the
	 * midpoint of the token array as the pivot. Partially solves issues with
	 * slow performance on already sorted arrays.
	 *
	 * @param tokens
	 *            the token array to partition
	 * @param start
	 *            the starting index of the subarray
	 * @param end
	 *            the ending index of the subarray, inclusive
	 ...
	 *
	 * @param tokens
	 *            the array of tokens to partition
	 * @param size
	 ...
	 *            the ending index of the subarray, inclusive
	 * @param targetSize
	 *            target size of the partition
	 * @param depth
	 *            recursion depth to avoid stack overflow and fall back to
	 *            simple partition.
