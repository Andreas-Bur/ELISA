...
public class AlternateHypothesisManager {
	...
	/**
	 * Collects adds alternate predecessors for a token that would have lost
	 * because of viterbi.
	 *
	 * @param token
	 *            - a token that has an alternate lower scoring predecessor that
	 *            still might be of interest
	 * @param predecessor
	 *            - a predecessor that scores lower than token.getPredecessor().
	 */
	 ...
	 *
	 * @param token
	 *            - a token that may have alternate lower scoring predecessor
	 *            that still might be of interest
	 * @return A list of predecessors that scores lower than
