 ...
 *
 * This is designed specifically for obtaining confidence scores. All scores are
...
public class WordResult {
	 ...
	 *
	 * @param w
	 *            the word object to store
	 * @param timeFrame
	 *            time frame
	 * @param score
	 *            acoustic score of the word
	 * @param posterior
	 *            of the word
	 */
	...
	public String toString() {
		return String.format(Locale.US, "{%s, %.3f, [%s]}", word, LogMath.getLogMath().logToLinear((float) getConfidence()),
				timeFrame);
	}
}
