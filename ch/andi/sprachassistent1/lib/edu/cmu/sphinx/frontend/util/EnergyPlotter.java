...
/**
 * Plots positive energy values of a cepstrum to stdout. The energy value is
 * assumed to be the first element of the double array returned by
 * <code>Data.getValues()</code>. For negative energy value, a "-" will be
 * printed out. The plots look like the following, one line per cepstrum. The
 * energy value for that particular cepstrum is printed at the end of the line.
 * <p>
...
public class EnergyPlotter implements Configurable {
	...
	/**
	 * Plots the energy values of the given Data to System.out. If the Data
	 * contains a signal, it prints the signal.
	 *
	 * @param cepstrum
	 *            the Data to plot
	 */
	...
	/**
	 * Returns the corresponding plot String for the given energy value. The
	 * energy value should be positive or zero. If its negative, It will output
	 * the string "-".
	 *
	 * @param energy
