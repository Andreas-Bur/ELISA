 ...
 * float array of size three times the original cepstrum.
 * <p>
 * The format of the outputted feature is:
 * <p>
 * 12 cepstra (c[1] through c[12]) <br>
 * followed by delta cepstra (delta c[1] through delta c[12]) <br>
 * followed by c[0], delta c[0] <br>
