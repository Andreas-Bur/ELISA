 ...
 * <p>
 * <br>
 * <img alt="Audio signal" src="doc-files/139o.jpg"> <br>
 * <b>Figure 1: The audio signal of the utterance "one three nine oh".</b>
 * <p>
 * <br>
 * <img alt="Spectrogram" src="doc-files/139ospectrum.jpg"> <br>
			...
			if (!isNumberFftPointsSet) {
				...
				if (numberDataPoints != data.getValues().length) {
					...
					if (idealFftPoints != numberFftPoints) {
						logger.warning(
								"User set numberFftPoints (" + numberFftPoints + ") is not ideal (" + idealFftPoints + ')');
					}
				}
			}
			input = process(data);
