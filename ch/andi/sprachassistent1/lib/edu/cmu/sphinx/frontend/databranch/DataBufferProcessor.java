 ...
 * <p>
 * <code>Data</code>s are inserted to the buffer using the
 * <code>processDataFrame</code>-method.
 */
public class DataBufferProcessor extends BaseDataProcessor implements DataListener {
	...
	/**
	 * If this property is set <code>true</code> the buffer will wait for new
	 * data until it returns from a <code>getData</code>-call. Enable this flag
	 * if the buffer should serve as starting point for a new
	 * feature-pull-chain..
	 */
	...
	/**
	 * The time in milliseconds which will be waited between two attempts to
	 * read a data element from the buffer when being in
	 * <code>waitIfEmpty</code>-mode
	 */
	...
	/**
	 * The maximal size of the buffer in frames. The oldest frames will be
	 * removed if the buffer grows out of bounds.
	 */
	...
	/**
	 * @param maxBufferSize
	 *            The maximal size of the buffer in frames. The oldest frames
	 *            will be removed if the buffer grows out of bounds.
	 * @param waitIfEmpty
	 *            If this property is set <code>true</code> the buffer will wait
	 *            for new data until it returns from a
	 *            <code>getData</code>-call. Enable this flag if the buffer
	 *            should serve as starting point for a new feature-pull-chain.
	 * @param waitTime
	 *            The time in milliseconds which will be waited between two
	 *            attempts to read a data element from the buffer when being in
	 *            <code>waitIfEmpty</code>-mode
	 * @param listeners
	 *            listeners to get notified
	 */
