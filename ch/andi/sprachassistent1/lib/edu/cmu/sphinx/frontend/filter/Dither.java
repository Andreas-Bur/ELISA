...
/**
 * Implements a dither for the incoming packet. A small amount of random noise
 * is added to the signal to avoid floating point errors and prevent the energy
 * from being zero.
 * <p>
 * Other {@link Data} objects are passed along unchanged through this Dither
 * processor.
 * <p>
 * See also {@link EnergyFilter}, an alternative to Dither.
 */
public class Dither extends BaseDataProcessor {
	...
	/**
	 * Returns the next DoubleData object, which is a dithered version of the
	 * input
	 *
	 * @return the next available DoubleData object, or null if no Data is
	 *         available
	...
	private DoubleData process(Data input) throws IllegalArgumentException {
		...
		output = new DoubleData(outFeatures, doubleData.getSampleRate(), doubleData.getFirstSampleNumber());
