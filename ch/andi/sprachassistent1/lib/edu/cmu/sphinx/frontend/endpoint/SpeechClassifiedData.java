...
/**
 * A container for DoubleData class that indicates whether the contained
 * DoubleData is speech or not.
 */
public class SpeechClassifiedData implements Data {
	 ...
	 *            the DoubleData
	 * @param isSpeech
	 *            indicates whether the DoubleData is speech
	 */
	...
	/**
	 * Returns the position of the first sample in the original data. The very
