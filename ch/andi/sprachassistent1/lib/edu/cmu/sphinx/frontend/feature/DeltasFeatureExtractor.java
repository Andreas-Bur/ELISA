 ...
 * delta is the first order derivative and the double delta (a.k.a. delta delta)
 * is the second order derivative of the original cepstrum. They help model the
 * speech signal dynamics. The output data is a {@link FloatData} object with a
 * float array of size three times the original cepstrum, formed by the
 * concatenation of cepstra, delta cepstra, and double delta cepstra. The output
 * is the feature vector used by the decoder. Figure 1 shows the arrangement of
 * the output feature data array:
 * <p>
 * <img alt="Layout of features" src="doc-files/feature.jpg"> <br>
 * <b>Figure 1: Layout of the returned features. </b>
 * <p>
 * Suppose that the original cepstrum has a length of N, the first N elements of
 * the feature are just the original cepstrum, the second N elements are the
 ...
 * <img alt="Delta computation" src="doc-files/deltas.jpg"> <br>
 * <b>Figure 2: Delta and double delta vector computation. </b>
 * <p>
 * Referring to Figure 2, the delta is computed by subtracting the cepstrum that
