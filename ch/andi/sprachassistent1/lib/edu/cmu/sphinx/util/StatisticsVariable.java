...
/**
 * Represents a named value. A StatisticsVariable may be used to track data in a
 * fashion that will allow the data to be viewed or dumped at any time.
 * Statistics are kept in a pool and are grouped in contexts. Statistics can be
 * dumped as a whole or by context.
 */
public class StatisticsVariable {
	...
	/**
	 * the value of this StatisticsVariable. It can be manipulated directly by
	 * the application.
	 */
	public double value;
	 ...
	 * If the statistic does not currently exist, it is created. If the context
	...
	/**
	 * Gets the StatisticsVariable with the given name for the given instance
	 * and context. This is a convenience function.
	 *
	 * @param instanceName
	 *            the instance name of creator
	 * @param statName
	 *            the name of the StatisticsVariable
	 * @return new variable
	 */
