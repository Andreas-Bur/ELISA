...
public class SimpleBatchManager implements BatchManager {
	 ...
	 * @param skip
	 *            number of records to skip between items
	 * @param whichBatch
	 *            which chunk of the batch should we process
	 * @param totalBatches
	 *            the total number of chuncks that the batch is divided into.
	 */
	 ...
	 * @throws IOException
	 *             if an I/O error occurs while getting the next item from the
	 *             batch file.
	 */
