...
/**
 * A simple implementation of the batch manager suitable for single threaded
 * batch processing
 */
public class PooledBatchManager implements BatchManager {
	 ...
	 * @throws IOException
	 *             if an I/O error occurs while reading the next item from the
	 *             batch file.
	 */
	 ...
	 *
	 * @param dir
	 *            the directory to place the input file in
	 * @param name
	...
	/**
	 * Redirects standard out to a file in the results directory with a name
	 * 'Results_xxx.out'
	 */
	...
	/**
	 * Close the redirected stdout and restore it to what it was before we
	 * redirected it.
	 */
