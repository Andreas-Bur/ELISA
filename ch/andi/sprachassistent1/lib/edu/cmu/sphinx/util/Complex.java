...
public class Complex {
	 ...
	 * @param b
	 *            the second element to be added
	 */
	 ...
	 *
	 * @param a
	 *            the element we subtract from
	 * @param b
	 *            the element to be subtracted
	 */
	...
	/**
	 * Method to divide two complex numbers. To divide two complexes, we
	 * multiply by the complex conjugate of the denominator, thus resulting in a
	...
	/**
	 * Method to scale a complex number by a real one. The input complex number
