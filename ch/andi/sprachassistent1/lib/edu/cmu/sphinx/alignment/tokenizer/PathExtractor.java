...
public class PathExtractor {
	...
	/**
	 * If this system property is set to true, CART feature/item paths will only
	 * be compiled as needed.
	 */
	public final static String LAZY_COMPILE_PROPERTY = "com.sun.speech.freetts.lazyCartCompile";

	private final static boolean INTERPRET_PATHS = System.getProperty(INTERPRET_PATHS_PROPERTY, "false").equals("true");
	private final static boolean LAZY_COMPILE = System.getProperty(LAZY_COMPILE_PROPERTY, "true").equals("true");
	 ...
	 * @param path
	 *            the path to compile
	 * @return the compiled form which is in the form of an array path traversal
...
class OpEnum {
	 ...
	 *
	 * @param name
	 *            the name of the OpEnum of interest
	 */
