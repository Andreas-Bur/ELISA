...
public class NumberExpander {
	...
	private static final String[] digit2teen = { "ten", /*
														 * shouldn't get called
														 */
			"eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen" };

	private static final String[] digit2enty = { "zero", /*
															 * shouldn't get
															 * called
															 */
	...
	private static final String[] ord2teen = { "tenth", /*
														 * shouldn't get called
														 */
			"eleventh", "twelfth", "thirteenth", "fourteenth", "fifteenth", "sixteenth", "seventeenth", "eighteenth",
			"nineteenth" };

	private static final String[] ord2enty = { "zeroth", /*
															 * shouldn't get
															 * called
															 */
			"tenth", "twentieth", "thirtieth", "fortieth", "fiftieth", "sixtieth", "seventieth", "eightieth", "ninetieth" };

	private static String[] digit2Numness = { "", "tens", "twenties", "thirties", "fourties", "fifties", "sixties", "seventies",
			"eighties", "nineties" };
	 ...
	 * @param numberZeroes
	 *            the number of zeroes, depending on the order, so its either 3,
	 *            6, or 9
	 * @param wordRelation
	 *            words are added to this Relation
	 */
