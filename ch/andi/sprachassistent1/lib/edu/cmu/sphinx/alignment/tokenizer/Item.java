...
/**
 * Represents a node in a Relation. Items can have shared contents but each item
 * has its own set of Daughters. The shared contents of an item (represented by
 * ItemContents) includes the feature set for the item and the set of all
 * relations that this item is contained in. An item can be contained in a
 * number of relations and as daughters to other items. This class is used to
 * keep track of all of these relationships. There may be many instances of item
 * that reference the same shared ItemContents.
 */
public class Item {
	 ...
	 * @param sharedContents
	 *            the contents that is shared with others. If null, a new
	 *            sharedContents is created.
	 */
	...
	/**
	 * Finds the feature by following the given path. Path is a string of ":" or
	 ...
	 *
	 * @param originalItem
	 *            new item has shared contents with this item (or * null)
	 *
