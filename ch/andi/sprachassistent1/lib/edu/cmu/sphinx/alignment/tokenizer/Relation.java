 ...
 * relation has a name and a list of items, and is added to an {@link Utterance}
 * via an {@link USEnglishTokenizer}.
 */
public class Relation {
	...
	/**
	 * Name of the relation that contains the normalized version of the original
	 * input text.
	 */
