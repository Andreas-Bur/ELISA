...
public class Compose {
			...
			for (int i = 0; i < numArcs1; i++) {
				...
				for (int j = 0; j < numArcs2; j++) {
					...
					if (a1.getOlabel() == a2.getIlabel()) {
						...
						Arc a = new Arc(a1.getIlabel(), a2.getOlabel(), semiring.times(a1.getWeight(), a2.getWeight()),
								nextState);
						s.addArc(a);
					}
				}
	 ...
	 * 
	 * @param syms
	 *            the gilter's input/output symbols
	 * @param semiring
	 *            the semiring to use in the operation
	 * @return the filter
	 */
	 ...
	 * 
	 * @param label
	 *            constant denoting if the augment should take place on input or
	 *            output labels For value equal to 0 augment will take place for
	 *            input labels For value equal to 1 augment will take place for
	 *            output labels
	 * @param fst
	 *            the fst to augment
	 * @param semiring
