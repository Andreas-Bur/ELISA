...
public class Arc {
	 ...
	 * 
	 * @param iLabel
	 *            the input label's id
	 * @param oLabel
	 *            the output label's id
	 * @param weight
	 *            the arc's weight
	 * @param nextState
	...
	public int hashCode() {
		return 31
				* (iLabel + (31 * (oLabel + (31 * (nextState == null ? 0 : nextState.getId()) + Float.floatToIntBits(weight)))));
	}
