...
public class Export {
	...
	/**
	 * Exports a java binary model to openfst text format Several files are
	 * exported as follows: - basename.input.syms - basename.output.syms -
	 * basename.fst.txt First argument is the java binary model filename, second
	 ...
	 *             loading failed due to failed serialization
	 */
