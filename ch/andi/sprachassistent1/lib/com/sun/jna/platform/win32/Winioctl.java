...
public interface Winioctl {
	...
	public static class STORAGE_DEVICE_NUMBER extends Structure {
		...
		/**
		 * The type of device. Values from 0 through 32,767 are reserved for use
		 * by Microsoft. Values from 32,768 through 65,535 are reserved for use
		 * by other vendors.
		 */
