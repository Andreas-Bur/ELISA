...
public interface Sspi {
	...
	/**
	 * Validate an incoming server credential. Inbound credentials might be
	 * validated by using an authenticating authority when
	 * InitializeSecurityContext or AcceptSecurityContext is called. If such an
	...
	// Flags for the TargetDataRep parameter of AcceptSecurityContext and
	...
	// Flags for the fContextReq parameter of InitializeSecurityContext or
	// AcceptSecurityContext.

	/**
	 * The security package allocates output buffers for you. When you have
	 * finished using the output buffers, free them by calling the
	...
	/**
	 * The security context will not handle formatting messages. This value is
	 * the default.
	 */
	 ...
	 * client. The ISC_REQ_MUTUAL_AUTH flag must be set for this flag to work.
	 * Valid for Kerberos. Ignore this flag for constrained delegation.
	 */
	...
	/**
	 * Sign messages and verify signatures by using the EncryptMessage and
	 * MakeSignature functions.
	 */
	...
	/**
	 * This buffer type is used to indicate the security token portion of the
	 * message. This is read-only for input parameters or read/write for output
	 * parameters.
	 */
	 ...
	 * {@link SecPkgCredentials_Names} structure.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Queries the sizes of the various parts of a stream used in the
	 ...
	 *
	 * <p>
	 * Returns information about the security package to be used with the
	 ...
	 *
	 * <p>
	 * <strong>Windows Server 2008, Windows Vista, Windows Server 2003 and
	 * Windows XP:</strong> This value is not supported.
	 * </p>
	 */
	 ...
	 *
	 * <p>
	 * This value is supported only by the Negotiate, Kerberos, and NTLM
	 * security packages.
	 * </p>
	 * 
	 * <p>
	 ...
	 *
	 * <p>
	 * This value returns information about the security attributes for the
	 * connection.
	 * </p>
	 *
	 * <p>
	...
	/**
	 * This package receives calls from app container apps if one of the
	 * following checks succeeds.
	 * <ul>
	...
	/**
	 * The SecBuffer structure describes a buffer allocated by a transport
	 * application to pass to a security package.
	 */
	public static class SecBuffer extends Structure {
		...
		public int cbBuffer;
		/**
		 * Bit flags that indicate the type of buffer. Must be one of the values
		 * of the SecBufferType enumeration.
		 */
	 ...
	 * 
	 * <p>
	 * SecBufferDesc was introduced because {@link SecBufferDesc} does not
	 * correctly cover the case there not exactly one {@link SecBuffer} is
	 * passed to the security package.
	 * </p>
	 * 
	 * <p>
	 * If the SecBufferDesc is managed from the java side, <b>prefer to use
	 * {@link com.sun.jna.platform.win32.SspiUtil.ManagedSecBufferDesc
	 * ManagedSecBufferDesc}.</b>
	 * </p>
	 */
	...
	/**
	 * The SecPkgInfo structure provides general information about a security
	 * package, such as its name and capabilities.
	 */
	public static class SecPkgInfo extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("fCapabilities", "wVersion", "wRPCID", "cbMaxToken", "Name",
				"Comment");

		/**
		 * Set of bit flags that describes the capabilities of the security
		 * package.
		 */
		...
		/**
		 * Specifies a DCE RPC identifier, if appropriate. If the package does
		 * not implement one of the DCE registered security systems, the
		 * reserved value SECPKG_ID_NONE is used.
		 */
		public short wRPCID;
		/**
		...
		public String Name;
		/**
		 * Pointer to a null-terminated string. This can be any additional
		 * string passed back by the package.
		 */
	 ...
	 * <p>
	 * The
	 * {@link Secur32#QueryContextAttributes(com.sun.jna.platform.win32.Sspi.CtxtHandle, int, com.sun.jna.Structure) }
	 * function uses this structure.
	 * </p>
	 */
	public static class SecPkgContext_Sizes extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("cbMaxToken", "cbMaxSignature", "cbBlockSize",
				"cbSecurityTrailer");

		/**
		 * Specifies the maximum size of the security token used in the
		 ...
		 * MakeSignature function. This member must be zero if integrity
		 * services are not requested or available.
		 */
		public int cbMaxSignature;

		/**
		 * Specifies the preferred integral size of the messages. For example,
		 * eight indicates that messages should be of size zero mod eight for
		 * optimal performance. Messages other than this block size can be
		 * padded.
		 */
		public int cbBlockSize;

		/**
		 * Size of the security trailer to be appended to messages. This member
		 * should be zero if the relevant services are not requested or
		 * available.
		 */
		...
		public String toString() {
			return "SecPkgContext_Sizes{" + "cbMaxToken=" + cbMaxToken + ", cbMaxSignature=" + cbMaxSignature + ", cbBlockSize="
	...
	public static class SecPkgContext_KeyInfo extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("sSignatureAlgorithmName", "sEncryptAlgorithmName", "KeySize",
				"SignatureAlgorithm", "EncryptAlgorithm");

		/**
		 * Name, if available, of the algorithm used for generating signatures,
		 ...
		 * This is typically 40, 56, or 128 bits.
		 */
		public int KeySize;

		/**
		 * Specifies the algorithm identifier (ALG_ID) used for generating
		 * signatures, if available.
		 */
		public int SignatureAlgorithm;

		/**
		 * Specifies the algorithm identifier (ALG_ID) used for encrypting
		...
		public synchronized String getSignatureAlgorithmName() {
			...
			return Boolean.getBoolean("w32.ascii") ? sSignatureAlgorithmName.getString(0)
	...
	public static class SEC_WINNT_AUTH_IDENTITY extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("User", "UserLength", "Domain", "DomainLength", "Password",
		 ...
		 * <td>The strings in this structure are in ANSI format.</td>
		 * </tr>
		 * <tr>
		 * <td>SEC_WINNT_AUTH_IDENTITY_UNICODE</td>
		 * <td>The strings in this structure are in Unicode format.</td>
		 * </tr>
		 * </table>
		 *
