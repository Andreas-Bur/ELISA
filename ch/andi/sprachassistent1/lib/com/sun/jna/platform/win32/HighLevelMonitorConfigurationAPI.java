...
public interface HighLevelMonitorConfigurationAPI {
	...
	enum MC_CAPS implements FlagEnum {
		...
		/**
		 * The monitor supports the GetMonitorBrightness and
		 * SetMonitorBrightness functions.
		 */
		MC_CAPS_BRIGHTNESS(0x00000002),

		/**
		 * The monitor supports the GetMonitorContrast and SetMonitorContrast
		 * functions.
		 */
		MC_CAPS_CONTRAST(0x00000004),

		/**
		 * The monitor supports the GetMonitorColorTemperature and
		 * SetMonitorColorTemperature functions.
		 */
		MC_CAPS_COLOR_TEMPERATURE(0x00000008),

		/**
		 * The monitor supports the GetMonitorRedGreenOrBlueGain and
		 * SetMonitorRedGreenOrBlueGain functions.
		 */
		MC_CAPS_RED_GREEN_BLUE_GAIN(0x00000010),

		/**
		 * The monitor supports the GetMonitorRedGreenOrBlueDrive and
		 * SetMonitorRedGreenOrBlueDrive functions.
		 */
		...
		/**
		 * The monitor supports the GetMonitorDisplayAreaPosition and
		 * SetMonitorDisplayAreaPosition functions.
		 */
		MC_CAPS_DISPLAY_AREA_POSITION(0x00000080),

		/**
		 * The monitor supports the GetMonitorDisplayAreaSize and
		...
		/**
		 * If this flag is present, calling the RestoreMonitorFactoryDefaults
		 * function enables all of the monitor settings used by the high-level
		 * monitor configuration functions. For more information, see the
		 * Remarks section in RestoreMonitorFactoryDefaults.
		 */
