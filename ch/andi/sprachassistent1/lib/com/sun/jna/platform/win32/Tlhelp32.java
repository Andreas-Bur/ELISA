...
public interface Tlhelp32 {
	 ...
	 *
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/ms682489(v=vs.85).aspx">MSDN</a>
	 */
	 ...
	 */
	WinDef.DWORD TH32CS_SNAPALL = new WinDef.DWORD((TH32CS_SNAPHEAPLIST.intValue() | TH32CS_SNAPPROCESS.intValue()
	...
	public static class PROCESSENTRY32 extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("dwSize", "cntUsage", "th32ProcessID", "th32DefaultHeapID",
		 ...
		 * path to the executable file, call the Module32First function and
		 * check the szExePath member of the MODULEENTRY32 structure that is
		 * returned. However, if the calling process is a 32-bit process, you
		 * must call the QueryFullProcessImageName function to retrieve the full
	...
	public class MODULEENTRY32W extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("dwSize", "th32ModuleID", "th32ProcessID", "GlblcntUsage",
