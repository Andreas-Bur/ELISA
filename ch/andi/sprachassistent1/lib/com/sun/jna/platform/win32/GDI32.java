...
public interface GDI32 extends StdCallLibrary {
	 ...
	 * 
	 * @param lpXform
	 *            Pointer to an XFORM structure that defines the transformation
	 *            to be performed on the region. If this pointer is NULL, the
	 ...
	 *         region. If the function fails, the return value is NULL. To get
	 ...
	 * 
	 * @param hrgnDest
	 *            Handle to a new region with dimensions defined by combining
	 *            two other regions.
	 * @param hrgnSrc1
	 ...
	 * @param fnCombineMode
	 *            Specifies a mode indicating how the two regions will be
	 *            combined.
	 ...
	 *            region in logical units.
	 * @param nWidthEllipse
	 *            Specifies the width of the ellipse used to create the rounded
	 *            corners in logical units.
	 * @param nHeightEllipse
	 *            Specifies the height of the ellipse used to create the rounded
	 *            corners in logical units.
	 * @return If the function succeeds, the return value is the handle to the
	 *         region. If the function fails, the return value is NULL. To get
	 *         extended error information, call GetLastError.
	 ...
	 * 
	 * @param lppt
	 *            Pointer to an array of POINT structures that define the
	 *            vertices of the polygons in logical units. The polygons are
	 *            specified consecutively. Each polygon is presumed closed and
	 *            each vertex is specified only once.
	 * @param lpPolyCounts
	 *            Pointer to an array of integers, each of which specifies the
	 *            number of points in one of the polygons in the array pointed
	 *            to by lppt.
	 * @param nCount
	 *            Specifies the total number of integers in the array pointed to
	 *            by lpPolyCounts.
	 * @param fnPolyFillMode
	 *            Specifies the fill mode used to determine which pixels are in
	 *            the region.
	 * @return If the function succeeds, the return value is the handle to the
	 *         region. If the function fails, the return value is zero. To get
	 *         extended error information, call GetLastError.
	 */
	 ...
	 * @param nLeftRect
	 *            Specifies the x-coordinate of the upper-left corner of the
	 *            rectangular region in logical units.
	 * @param nTopRect
	 *            Specifies the y-coordinate of the upper-left corner of the
	 *            rectangular region in logical units.
	 * @param nRightRect
	 ...
	 * @param x
	 *            Specifies the x-coordinate, in logical units, of the point to
	 *            be set.
	 * @param y
	 *            Specifies the y-coordinate, in logical units, of the point to
	 *            be set.
	 * @param crColor
	 *            Specifies the color to be used to paint the point. To create a
	 *            COLORREF color value, use the RGB macro.
	 * @return If the function succeeds, the return value is the RGB value that
	 *         the function sets the pixel to. This value may differ from the
	 *         color specified by crColor; that occurs when an exact match for
	 *         the specified color cannot be found. If the function fails, the
	 ...
	 * 
	 * @param hDC
	 *            Handle to an existing DC. If this handle is NULL, the function
	 ...
	 *         memory DC. If the function fails, the return value is NULL. To
	 ...
	 * @param lpbmih
	 *            Pointer to a bitmap information header structure, which may be
	 *            one of those shown in the following table.
	 * @param fdwInit
	 *            Specifies how the system initializes the bitmap bits.
	 * @param lpbInit
	 *            Pointer to an array of bytes containing the initial bitmap
	 *            data.
	 * @param lpbmi
	 *            Pointer to a BITMAPINFO structure that describes the
	 *            dimensions and color format of the array pointed to by the
	 *            lpbInit parameter.
	 * @param fuUsage
	 *            Specifies whether the bmiColors member of the BITMAPINFO
	 *            structure was initialized and, if so, whether bmiColors
	 *            contains explicit red, green, blue (RGB) values or palette
	 *            indexes. The fuUsage parameter must be one of the following
	 *            values.
	 ...
	 * 
	 * @param hDC
	 *            Handle to a device context. If the value of iUsage is
	 *            DIB_PAL_COLORS, the function uses this device context's
	 *            logical palette to initialize the DIB colors.
	 * @param pbmi
	 *            Pointer to a BITMAPINFO structure that specifies various
	 *            attributes of the DIB, including the bitmap dimensions and
	 *            colors.
	 * @param iUsage
	 *            Specifies the type of data contained in the bmiColors array
	 *            member of the BITMAPINFO structure pointed to by pbmi (either
	 *            logical palette indexes or literal RGB values).
	 * @param ppvBits
	 *            Pointer to a variable that receives a pointer to the location
	 *            of the DIB bit values.
	 * @param hSection
	 *            Handle to a file-mapping object that the function will use to
	 *            create the DIB. This parameter can be NULL.
	 * @param dwOffset
	 *            Specifies the offset from the beginning of the file-mapping
	 ...
	 * @return If the function succeeds, the return value is a handle to the
	 *         compatible bitmap (DDB). If the function fails, the return value
	 ...
	 *         value is one of the REGION values.
	 */
	 ...
	 *         <i>nIndex</i> is <code>BITSPIXEL</code> and the device has 15bpp
	 *         or 16bpp, the return value is 16.
	 */
	 ...
	 * @param lpvBits
	 *            A pointer to a buffer to receive the bitmap data. If this
	 *            parameter is <code>null</code>, the function passes the
	 *            dimensions and format of the bitmap to the {@link BITMAPINFO}
	 *            structure pointed to by the <i>lpbi</i> parameter.
	 * @param lpbi
	 *            A pointer to a {@link BITMAPINFO} structure that specifies the
	 *            desired format for the DIB data.
	 * @param uUsage
	 *            The format of the bmiColors member of the {@link BITMAPINFO}
	 *            structure.
	 * @return status
	 */
	 ...
	 *
	 * @param hdc
	 *            Specifies the device context that the function examines to
	 *            determine the best match for the pixel format descriptor
	 *            pointed to by ppfd.
	 * @param ppfd
	 *            Pointer to a PIXELFORMATDESCRIPTOR structure that specifies
	 *            the requested pixel format.
	 * @return If the function succeeds, the return value is a pixel format
	 *         index (one-based) that is the closest match to the given pixel
	 *         format descriptor.
	 */
	 ...
	 *
	 * @param hdc
	 *            Specifies the device context whose pixel format the function
	 *            attempts to set.
	 * @param iPixelFormat
	 *            Index that identifies the pixel format to set. The various
	 *            pixel formats supported by a device context are identified by
	 *            one-based indexes.
	 * @param ppfd
	 ...
	 *            </p>
	 *            <table border="1px">
	 *            <caption>Information Received</caption> <thead>
	 *            <tr>
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td>{@link HBITMAP} returned from a call to
	 *            {@link #CreateDIBSection}</td>
	 *            <td>DIBSECTION, if cbBuffer is set to sizeof(DIBSECTION), or
	 *            BITMAP, if cbBuffer is set to sizeof (BITMAP).</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link HPALETTE}</td>
