...
public interface Wdm {
	...
	/**
	 * The KEY_BASIC_INFORMATION structure defines a subset of the full
	 * information that is available for a registry key.
	 */
	public static class KEY_BASIC_INFORMATION extends Structure {
		...
		/**
		 * A string of Unicode characters naming the key. The string is not
		 * null-terminated.
		 */
		public char[] Name;
	...
	/**
	 * The KEY_INFORMATION_CLASS enumeration type represents the type of
	 * information to supply about a registry key.
	 */
