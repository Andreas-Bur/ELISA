...
public class RunningObjectTable extends Unknown implements IRunningObjectTable {
	...
	public HRESULT Register(DWORD grfFlags, Pointer punkObject, Pointer pmkObjectName, DWORDByReference pdwRegister) {
		...
		WinNT.HRESULT hr = (WinNT.HRESULT) this._invokeNativeObject(vTableId,
				new Object[] { this.getPointer(), grfFlags, punkObject, pmkObjectName, pdwRegister }, WinNT.HRESULT.class);
	...
	public HRESULT Revoke(DWORD dwRegister) {
		...
		WinNT.HRESULT hr = (WinNT.HRESULT) this._invokeNativeObject(vTableId, new Object[] { this.getPointer(), dwRegister },
				WinNT.HRESULT.class);
	...
	public HRESULT IsRunning(Pointer pmkObjectName) {
		...
		WinNT.HRESULT hr = (WinNT.HRESULT) this._invokeNativeObject(vTableId, new Object[] { this.getPointer(), pmkObjectName },
				WinNT.HRESULT.class);
	...
	public HRESULT GetObject(Pointer pmkObjectName, PointerByReference ppunkObject) {
		...
		WinNT.HRESULT hr = (WinNT.HRESULT) this._invokeNativeObject(vTableId,
				new Object[] { this.getPointer(), pmkObjectName, ppunkObject }, WinNT.HRESULT.class);
	...
	public HRESULT NoteChangeTime(DWORD dwRegister, FILETIME pfiletime) {
		...
		WinNT.HRESULT hr = (WinNT.HRESULT) this._invokeNativeObject(vTableId,
				new Object[] { this.getPointer(), dwRegister, pfiletime }, WinNT.HRESULT.class);
	...
	public HRESULT GetTimeOfLastChange(Pointer pmkObjectName, FILETIME.ByReference pfiletime) {
		...
		WinNT.HRESULT hr = (WinNT.HRESULT) this._invokeNativeObject(vTableId,
				new Object[] { this.getPointer(), pmkObjectName, pfiletime }, WinNT.HRESULT.class);
	...
	public HRESULT EnumRunning(PointerByReference ppenumMoniker) {
		...
		WinNT.HRESULT hr = (WinNT.HRESULT) this._invokeNativeObject(vTableId, new Object[] { this.getPointer(), ppenumMoniker },
				WinNT.HRESULT.class);
