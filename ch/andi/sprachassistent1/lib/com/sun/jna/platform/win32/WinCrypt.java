...
public interface WinCrypt {
	...
	public static class CERT_TRUST_STATUS extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwErrorStatus", "dwInfoStatus");
	...
	public static class CTL_ENTRY extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("SubjectIdentifier", "cAttribute", "rgAttribute");
		...
		public CRYPT_ATTRIBUTE[] getRgAttribute() {
			if (cAttribute == 0) {
				...
				return (CRYPT_ATTRIBUTE[]) Structure.newInstance(CERT_EXTENSION.class, rgAttribute).toArray(cAttribute);
			}
		}
	...
	public static class CERT_REVOCATION_CRL_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "pBaseCRLContext", "pDeltaCRLContext",
				"pCrlEntry", "fDeltaCrlEntry");
	...
	public static class CERT_REVOCATION_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "dwRevocationResult", "pszRevocationOid",
	...
	public static class CERT_CHAIN_ELEMENT extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "pCertContext", "TrustStatus",
				"pRevocationInfo", "pIssuanceUsage", "pApplicationUsage", "pwszExtendedErrorInfo");
	...
	public static class CTL_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwVersion", "SubjectUsage", "ListIdentifier",
				"SequenceNumber", "ThisUpdate", "NextUpdate", "SubjectAlgorithm", "cCTLEntry", "rgCTLEntry", "cExtension",
				"rgExtension");
		...
		public CTL_ENTRY[] getRgExtension() {
			if (cCTLEntry == 0) {
				...
				return (CTL_ENTRY[]) Structure.newInstance(CTL_ENTRY.class, rgCTLEntry).toArray(cCTLEntry);
			}
		}
		...
		public CERT_EXTENSION[] getRgCTLEntry() {
			if (cExtension == 0) {
				...
				return (CERT_EXTENSION[]) Structure.newInstance(CERT_EXTENSION.class, rgExtension).toArray(cExtension);
			}
		}
	...
	public static class CTL_CONTEXT extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwMsgAndCertEncodingType", "pbCtlEncoded",
				"cbCtlEncoded", "pCtlInfo", "hCertStore", "hCryptMsg", "pbCtlContent", "cbCtlContent");
	...
	public static class CERT_TRUST_LIST_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "pCtlEntry", "pCtlContext");
	...
	public static class CTL_USAGE extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cUsageIdentifier", "rgpszUsageIdentifier");
	...
	public static class CERT_USAGE_MATCH extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwType", "Usage");
	...
	public static class CERT_CHAIN_PARA extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "RequestedUsage", "RequestedIssuancePolicy",
				"dwUrlRetrievalTimeout", "fCheckRevocationFreshnessTime", "dwRevocationFreshnessTime", "pftCacheResync",
				"pStrongSignPara", "dwStrongSignFlags");
	...
	public static class CERT_STRONG_SIGN_PARA extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "dwInfoChoice", "DUMMYUNIONNAME");
	...
	public static class CERT_STRONG_SIGN_SERIALIZED_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwFlags", "pwszCNGSignHashAlgids",
	...
	public static class CERT_CHAIN_POLICY_STATUS extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "dwError", "lChainIndex", "lElementIndex",
				"pvExtraPolicyStatus");
	...
	public static class CERT_SIMPLE_CHAIN extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "TrustStatus", "cElement", "rgpElement",
				"pTrustListInfo", "fHasRevocationFreshnessTime", "dwRevocationFreshnessTime");
		...
		public CERT_CHAIN_ELEMENT[] getRgpElement() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CERT_CHAIN_ELEMENT) Structure.newInstance(CERT_CHAIN_ELEMENT.class,
	...
	public static class CERT_CHAIN_POLICY_PARA extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "dwFlags", "pvExtraPolicyPara");
	...
	public static class CERT_CHAIN_CONTEXT extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "TrustStatus", "cChain", "rgpChain",
				"cLowerQualityChainContext", "rgpLowerQualityChainContext", "fHasRevocationFreshnessTime",
				"dwRevocationFreshnessTime", "dwCreateFlags", "ChainId");
		...
		public CERT_SIMPLE_CHAIN[] getRgpChain() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CERT_SIMPLE_CHAIN) Structure.newInstance(CERT_SIMPLE_CHAIN.class,
		...
		public CERT_CHAIN_CONTEXT[] getRgpLowerQualityChainContext() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CERT_CHAIN_CONTEXT) Structure.newInstance(CERT_CHAIN_CONTEXT.class,
	...
	public static class CERT_CONTEXT extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwCertEncodingType", "pbCertEncoded", "cbCertEncoded",
	...
	public static class CERT_EXTENSION extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("pszObjId", "fCritical", "Value");
	...
	public static class CERT_EXTENSIONS extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cExtension", "rgExtension");
		...
		public CERT_EXTENSION[] getRgExtension() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CERT_EXTENSION) Structure.newInstance(CERT_EXTENSION.class,
	...
	public static class CERT_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwVersion", "SerialNumber", "SignatureAlgorithm",
				"Issuer", "NotBefore", "NotAfter", "Subject", "SubjectPublicKeyInfo", "IssuerUniqueId", "SubjectUniqueId",
	...
	public static class CERT_PUBLIC_KEY_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("Algorithm", "PublicKey");
	...
	public static class CRL_CONTEXT extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwCertEncodingType", "pbCrlEncoded", "cbCrlEncoded",
				"pCrlInfo", "hCertStore");
	...
	public static class CRL_ENTRY extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("SerialNumber", "RevocationDate", "cExtension",
				"rgExtension");
	...
	public static class CRL_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwVersion", "SignatureAlgorithm", "Issuer",
				"ThisUpdate", "NextUpdate", "cCRLEntry", "rgCRLEntry", "cExtension", "rgExtension");
		...
		public CRL_ENTRY[] getRgCRLEntry() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CRL_ENTRY) Structure.newInstance(CRL_ENTRY.class, rgCRLEntry.getPointer(i * Native.POINTER_SIZE));
				elements[i].read();
			}
			return elements;
		}
	...
	public static class CRYPT_ALGORITHM_IDENTIFIER extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("pszObjId", "Parameters");
	...
	public static class CRYPT_ATTRIBUTE extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("pszObjId", "cValue", "rgValue");
	...
	public static class CRYPT_BIT_BLOB extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbData", "pbData", "cUnusedBits");
	...
	public static class CRYPT_KEY_PROV_INFO extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("pwszContainerName", "pwszProvName", "dwProvType",
				"dwFlags", "cProvParam", "rgProvParam", "dwKeySpec");
		...
		public CRYPT_KEY_PROV_PARAM[] getRgProvParam() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CRYPT_KEY_PROV_PARAM) Structure.newInstance(CRYPT_KEY_PROV_PARAM.class,
	...
	public static class CRYPT_KEY_PROV_PARAM extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("dwParam", "pbData", "cbData", "dwFlags");
	...
	public static class CRYPT_SIGN_MESSAGE_PARA extends Structure {
		...
		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "dwMsgEncodingType", "pSigningCert",
				"HashAlgorithm", "pvHashAuxInfo", "cMsgCert", "rgpMsgCert", "cMsgCrl", "rgpMsgCrl", "cAuthAttr", "rgAuthAttr",
				"cUnauthAttr", "rgUnauthAttr", "dwFlags", "dwInnerContentType", "HashEncryptionAlgorithm",
		...
		public CERT_CONTEXT[] getRgpMsgCert() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CERT_CONTEXT) Structure.newInstance(CERT_CONTEXT.class,
		...
		public CRL_CONTEXT[] getRgpMsgCrl() {
			...
			for (int i = 0; i < elements.length; i++) {
				elements[i] = (CRL_CONTEXT) Structure.newInstance(CRL_CONTEXT.class,
		...
		public CRYPT_ATTRIBUTE[] getRgUnauthAttr() {
			if (cUnauthAttr == 0) {
				...
				return (CRYPT_ATTRIBUTE[]) Structure.newInstance(CRYPT_ATTRIBUTE.class, rgUnauthAttr).toArray(cUnauthAttr);
			}
		}
	...
	public interface CryptGetSignerCertificateCallback extends StdCallLibrary.StdCallCallback {
		 ...
		 *            verification function as specified in the
		 *            CRYPT_VERIFY_MESSAGE_PARA structure.
		 * @param dwCertEncodingType
		 *            Specifies the type of encoding used. It is always
		 *            acceptable to specify both the certificate and message
		 *            encoding types by combining them with a bitwise-OR
		 ...
		 *            </ul>
		 * @param pSignerId
		 *            A pointer to a CERT_INFO structure containing the issuer
		 *            and serial number. Can be NULL if there is no content or
		 *            signer.
		 * @param hMsgCertStore
		 *            A handle to the certificate store containing all the
		 *            certificates and CRLs in the signed message.
		 * @return
		 */
	 ...
	 *
	 * @see <a href=
	 *      "https://msdn.microsoft.com/en-us/library/windows/desktop/aa381477(v=vs.85).aspx">MSDN</a>
	 */
	public static class CRYPT_VERIFY_MESSAGE_PARA extends Structure {

		private static final List<String> fieldOrder = createFieldsOrder("cbSize", "dwMsgAndCertEncodingType", "hCryptProv",
	 ...
	 * information about when and where that prompt is to be displayed when
	...
	public static class CRYPTPROTECT_PROMPTSTRUCT extends Structure {
		...
		public int cbSize;
		/**
		 * DWORD flags that indicate when prompts to the user are to be
		 * displayed.
		 */
	...
	/**
	 * Default to strong variant UI protection (user supplied password
	 * currently).
	 */
