        ...
        */
        ...
        public Object getValue() {
            ...
            switch (type) {
                ...
                case EvtVarTypeFileTime:
                    if (isArray()) {
                        WinBase.FILETIME resultFirst = (FILETIME) Structure.newInstance(WinBase.FILETIME.class, field1.getPointer().getPointer(0));
                        resultFirst.read();
                ...
                case EvtVarTypeSysTime:
                    if (isArray()) {
                        WinBase.SYSTEMTIME resultFirst = (SYSTEMTIME) Structure.newInstance(WinBase.SYSTEMTIME.class, field1.getPointer().getPointer(0));
                        resultFirst.read();
                        return resultFirst.toArray(Count);
                    } else {
                        WinBase.SYSTEMTIME result = (SYSTEMTIME) Structure.newInstance(WinBase.SYSTEMTIME.class, field1.getPointer().getPointer(0));
                        result.read();
                        return result;
                    }
                case EvtVarTypeSByte:
