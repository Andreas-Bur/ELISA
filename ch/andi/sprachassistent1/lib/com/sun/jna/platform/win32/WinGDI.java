...
public interface WinGDI {
	...
	class BITMAPINFOHEADER extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("biSize", "biWidth", "biHeight", "biPlanes", "biBitCount",
	...
	class BITMAP extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("bmType", "bmWidth", "bmHeight", "bmWidthBytes", "bmPlanes",
				"bmBitsPixel", "bmBits");
	...
	/**
	 * The PIXELFORMATDESCRIPTOR structure describes the pixel format of a
	 * drawing surface.
	 */
	class PIXELFORMATDESCRIPTOR extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("nSize", "nVersion", "dwFlags", "iPixelType", "cColorBits",
		...
		/**
		 * Specifies the size of this data structure. This value should be set
		 * to sizeof(PIXELFORMATDESCRIPTOR).
		 */
		public short nSize;
		/**
		 * Specifies the version of this data structure. This value should be
		 * set to 1.
		 */
		...
		/**
		 * Specifies the shift count for red bitplanes in each RGBA color
		 * buffer.
		 */
		...
		/**
		 * Specifies the shift count for green bitplanes in each RGBA color
		 * buffer.
		 */
		...
		/**
		 * Specifies the shift count for blue bitplanes in each RGBA color
		 * buffer.
		 */
		...
		/**
		 * Specifies the shift count for alpha bitplanes in each RGBA color
		 * buffer. Alpha bitplanes are not supported.
		 */
		...
		/**
		 * Specifies the number of auxiliary buffers. Auxiliary buffers are not
		 * supported.
		 */
		public byte cAuxBuffers;
		/**
		 * Ignored. Earlier implementations of OpenGL used this member, but it
		 * is no longer used.
		 */
