...
public interface DsGetDC {
	...
	public static class DOMAIN_CONTROLLER_INFO extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("DomainControllerName", "DomainControllerAddress",
				"DomainControllerAddressType", "DomainGuid", "DomainName", "DnsForestName", "Flags", "DcSiteName",
				"ClientSiteName");
		...
		/**
		 * Pointer to a null-terminated string that specifies the address of the
		 * discovered domain controller. The address is prefixed with "\\". This
		 * string is one of the types defined by the DomainControllerAddressType
		 * member.
		 */
	 ...
	 * Valid domain flags.
	 */
	int DS_DOMAIN_VALID_FLAGS = DS_DOMAIN_IN_FOREST | DS_DOMAIN_DIRECT_OUTBOUND | DS_DOMAIN_TREE_ROOT | DS_DOMAIN_PRIMARY
	...
	public static class DS_DOMAIN_TRUSTS extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("NetbiosDomainName", "DnsDomainName", "Flags", "ParentIndex",
				"TrustType", "TrustAttributes", "DomainSid", "DomainGuid");
