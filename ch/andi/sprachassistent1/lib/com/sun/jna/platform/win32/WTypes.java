...
public interface WTypes {
	 ...
	 * 
	 * <p>
	 * The "value" of the BSTR is the pointer to the start of the Data String,
	 * the length prefix is the four bytes before that.
	 * </p>
	 * 
	 * <p>
	 * The MSDN states, that a BSTR derived from a Nullpointer is treated as a
