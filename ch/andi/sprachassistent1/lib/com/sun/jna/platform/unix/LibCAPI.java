...
public interface LibCAPI extends Reboot, Resource {
	 ...
	 * @return Returns the value in the environment, or {@code null} if there is
	 *         no match for the name
	 * @see <A HREF=
	 ...
	 *            {@code overwrite} is non-zero, the function shall return
	 *            success and the environment shall be updated. If the
	 *            environment variable already exists and the value of
	 *            {@code overwrite} is zero, the function shall return success
	 *            and the environment shall remain unchanged.
	 * @return Upon successful completion, zero shall be returned. Otherwise, -1
	 *         shall be returned, {@code errno} set to indicate the error, and
	 ...
	 *            exist in the current environment, the environment shall be
