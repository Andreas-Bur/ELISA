 ...
 * @see <A HREF=
 *      "https:/**msdn.microsoft.com/en-us/library/windows/desktop/aa373046(v=vs.85).aspx">Performance
 *      Data Helper Error Codes</A>
 */
public interface PdhMsg {
	...
	/**
	 * A time-out occurred while waiting for the asynchronous counter collection
	 * thread to end.
	 */
	...
	/**
	 * The maximum log file size specified is too small to log the selected
	 * counters.
	 */
	...
	/**
	 * Call to SQLMoreResults failed with %1. public static final int
	 * PDH_SQL_MORE_RESULTS_FAILED = 0xC0000BE5; /** Call to SQLConnect failed
	 * with %1.
	 */
	...
	/**
	 * Collection &quot;%1!s!&quot; did not start; check the application event
	 * log for any errors.
	 */
	...
	/**
	 * SQL log format is incorrect. Correct format is
	 * &quot;SQL:&lt;DSN-name&gt;!&lt;LogSet-Name&gt;&quot;.
	 */
	public static final int PDH_INVALID_SQL_LOG_FORMAT = 0xC0000BF5;
	/**
	 * Performance counter in PdhAddCounter call has already been added in the
	 * performance query.
	 */
	...
	/**
	 * At least one of the input binary log files contain fewer than two data
	 * samples.
	 */
	public static final int PDH_LOG_SAMPLE_TOO_SMALL = 0xC0000BF8;
	/**
	 * The version of the operating system on the computer named %1 is later
	 * than that on the local computer.
	 */
	public static final int PDH_OS_LATER_VERSION = 0xC0000BF9;
	/**
	 * %1 supports %2 or later. Check the operating system version on the
	 * computer named %3.
	 */
