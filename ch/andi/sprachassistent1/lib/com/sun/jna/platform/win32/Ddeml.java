 ...
 * 
 * @see <a href=
 *      "https://msdn.microsoft.com/de-de/library/windows/desktop/ms648713(v=vs.85).aspx">MSDN:
 *      About the DDEML</a>
 */
public interface Ddeml extends StdCallLibrary {
	...
	/**
	 * The following structure is for use with {@link #XTYP_WILDCONNECT}
	 * processing.
	 */
	...
	/**
	 * The following structure is used by {@link #DdeConnect} and
	 * {@link #DdeConnectList} and by {@link #XTYP_CONNECT} and
	 * {@link #XTYP_WILDCONNECT} callbacks.
	 */
	public class CONVCONTEXT extends Structure {

		public static final List<String> FIELDS = createFieldsOrder("cb", "wFlags", "wCountryID", "iCodePage", "dwLangID",
				"dwSecurity", "qos");
		/**
	 ...
	 *
	 * @see #DdeQueryConvInfo(HCONV hConv, int idTransaction, CONVINFO
	 *      pConvInfo)
	 */
	public class CONVINFO extends Structure {

		public static final List<String> FIELDS = createFieldsOrder("cb", "hUser", "hConvPartner", "hszSvcPartner",
				"hszServiceReq", "hszTopic", "hszItem", "wFmt", "wType", "wStatus", "wConvst", "wLastError", "hConvList",
				"ConvCtxt", "hwnd", "hwndPartner");
	...
	public class MONCBSTRUCT extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("cb", "dwTime", "hTask", "dwRet", "wType", "wFmt", "hConv",
				"hsz1", "hsz2", "hData", "dwData1", "dwData2", "cc", "cbData", "Data");
	 ...
	 * about a conversation that has been established or has terminated.
	 * </p>
	 *
	 * <p>
	 ...
	 * that identify the conversation.
	 * </p>
	 */
	public class MONCONVSTRUCT extends Structure {

		public static final List<String> FIELDS = createFieldsOrder("cb", "fConnect", "dwTime", "hTask", "hszSvc", "hszTopic",
	...
	public class MONERRSTRUCT extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("cb", "wLastError", "dwTime", "hTask");
	...
	public class MONHSZSTRUCT extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("cb", "fsAction", "dwTime", "hsz", "hTask", "str");
		 ...
		 * (The application called the {@link #DdeKeepStringHandle}
		 * function.)</td>
		 * </tr>
		 * </table>
		 */
	 ...
	 * and hszItem members are global atoms.
	 * </p>
	 *
	 * <p>
	...
	public class MONLINKSTRUCT extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("cb", "dwTime", "hTask", "fEstablished", "fNoData", "hszSvc",
				"hszTopic", "hszItem", "wFmt", "fServer", "hConvServer", "hConvClient");
		...
		/**
		 * Indicates whether the {@link #XTYPF_NODATA} flag is set for the
		 * advise loop. A value of TRUE indicates the flag is set; FALSE
		 * indicates it is not.
		 */
		public BOOL fNoData;
		/**
	...
	public class MONMSGSTRUCT extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("cb", "hwndTo", "dwTime", "hTask", "wMsg", "wParam", "lParam",
				"dmhd");
	...
	public class DDEML_MSG_HOOK_DATA extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("uiLo", "uiHi", "cbData", "Data");
	 ...
	 * <dl>
	 * <dt>uType</dt>
	 * <dd>The transaction type.</dd>
	 * <dt>hconv</dt>
	 * <dd>A handle to the conversation associated with the error. This
	 * parameter is NULL if the error is not associated with a conversation.
	 * </dd>
	 * <dt>dwData1</dt>
	 * <dd>The error code in the low-order word. Currently, only the following
	 ...
	 * </tr>
	 * <tr>
	 * <td>DMLERR_LOW_MEMORY</td>
	 * <td>Memory is low; advise, poke, or execute data may be lost, or the
	 * system may fail.</td>
	 * </tr>
	 * </table>
	 * </dd>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>uFmt</dt>
	 * <dd>The format atom of the data sent from the server.</dd>
	 * <dt>hconv</dt>
	 * <dd>A handle to the conversation.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the item name.</dd>
	 * <dt>hdata</dt>
	 * <dd>A handle to the data associated with the topic name and item name
	 * pair. This parameter is NULL if the client specified the
	 ...
	 *
	 * <p>
	 * A DDE callback function should return {@link #DDE_FACK} if it processes
	 * this transaction, {@link #DDE_FBUSY} if it is too busy to process this
	 * transaction, or {@link #DDE_FNOTPROCESSED} if it rejects this
	 * transaction.
	 * </p>
	 * <p>
	 * <strong>Remarks</strong>
	 ...
	 * callback function returns. An application can use the {@link #DdeGetData}
	 ...
	 * function, DdeCallback, after the server calls the {@link #DdePostAdvise}
	 * function.
	 * 
	 * <p>
	 * <strong>Used Parameters</strong>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>uFmt</dt>
	 * <dd>The format in which the data should be submitted to the client.</dd>
	 * <dt>hconv</dt>
	 * <dd>A handle to the conversation.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the item name that has changed.</dd>
	 * <dt>dwData1</dt>
	 * <dd>The count, in the low-order word, of XTYP_ADVREQ transactions that
	 * remain to be processed on the same topic, item, and format name set
	 * within the context of the current call to the {@link #DdePostAdvise}
	 * function. The count is zero if the current XTYP_ADVREQ transaction is the
	 * last one. A server can use this count to determine whether to create an
	 * HDATA_APPOWNED data handle to the advise data. <br>
	 * <br>
	 * The low-order word is set to {@link #CADV_LATEACK} if the DDEML issued
	 * the XTYP_ADVREQ transaction because of a late-arriving DDE_ACK message
	 * from a client being outrun by the server. <br>
	 * <br>
	 ...
	 * </p>
	 * <p>
	 * The server should first call the {@link #DdeCreateDataHandle} function to
	 * create a data handle that identifies the changed data and then return the
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>uFmt</dt>
	 * <dd>The data format requested by the client.</dd>
	 * <dt>hconv</dt>
	 * <dd>A handle to the conversation.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name.</dd>
	 ...
	 * {@link #DdePostAdvise} function by the server on the same topic name and
	 * item name pair causes the system to send {@link #XTYP_ADVREQ}
	 ...
	 * {@link #XTYPF_NODATA}) to match the latest request.
	 * </p>
	 * <p>
	 * This transaction is filtered if the server application specified the
	 * {@link #CBF_FAIL_ADVISES} flag in the {@link #DdeInitialize} function.
	 * </p>
	 */
	 ...
	 * <dd>A handle to the topic name.</dd>
	 * <dt>hdata</dt>
	 * <dd>A handle to the command string.</dd>
	 * </dl>
	 * 
	 * <p>
	 * <strong>Return value</strong>
	 ...
	 *
	 * <p>
	 * A server callback function should return {@link #DDE_FACK} if it
	 * processes this transaction, {@link #DDE_FBUSY} if it is too busy to
	 * process this transaction, or {@link #DDE_FNOTPROCESSED} if it rejects
	 * this transaction.
	 * </p>
	 * 
	 * <p>
	 ...
	 * <p>
	 * This transaction is filtered if the server application specified the
	 * {@link #CBF_FAIL_EXECUTES} flag in the {@link #DdeInitialize} function.
	 * </p>
	 * 
	 * <p>
	 ...
	 * {@link #DdeGetData} function to copy the data.
	 * </p>
	 * 
	 * <p>
	 ...
	 * the server should do so after processing the XTYP_EXECUTE transaction.
	 * </p>
	 */
	 ...
	 * <dd>A handle to the topic name.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the service name.</dd>
	 * <dt>dwData1</dt>
	 * <dd>A pointer to a CONVCONTEXT structure that contains context
	 * information for the conversation. If the client is not a DDEML
	 * application, this parameter is 0.</dd>
	 * <dt>dwData2</dt>
	 * <dd>Specifies whether the client is the same application instance as the
	 * server. If the parameter is 1, the client is the same instance. If the
	 * parameter is 0, the client is a different instance.</dd>
	 * </dl>
	 * 
	 * <p>
	 * <strong>Return value</strong>
	 ...
	 * issuing an {@link #XTYP_CONNECT_CONFIRM} transaction to the server's
	 * callback function (unless the server specified the
	 * {@link #CBF_SKIP_CONNECT_CONFIRMS} flag in the {@link #DdeInitialize
	 * function}).
	 * </p>
	 * 
	 * <p>
	 ...
	 * <p>
	 * This transaction is filtered if the server application specified the
	 * {@link #CBF_FAIL_CONNECTIONS} flag in the {@link #DdeInitialize}
	 * function.
	 * </p>
	 * <p>
	 * A server cannot block this transaction type; the CBR_BLOCK return code is
	 ...
	 * result of a previous {@link #XTYP_CONNECT} or {@link #XTYP_WILDCONNECT}
	 * transaction.
	 *
	 * <p>
	 * <strong>Used Parameters</strong>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>hconv</dt>
	 * <dd>A handle to the new conversation.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name on which the conversation has been
	 * established.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the service name on which the conversation has been
	 * established.</dd>
	 * <dt>dwData2</dt>
	 * <dd>Specifies whether the client is the same application instance as the
	 * server. If the parameter is 1, the client is the same instance. If the
	 ...
	 * transaction, initiated by a call to the {@link #DdeClientTransaction}
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>uFmt</dt>
	 * <dd>The format of the data associated with the completed transaction (if
	 * applicable) or NULL if no data was exchanged during the transaction.</dd>
	 * <dt>hConv</dt>
	 * <dd>A handle to the conversation.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name involved in the completed
	 * transaction.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the item name involved in the completed transaction.</dd>
	 * <dt>hdata</dt>
	 * <dd>A handle to the data involved in the completed transaction, if
	 * applicable. If the transaction was successful but involved no data, this
	 * parameter is TRUE. This parameter is NULL if the transaction was
	 * unsuccessful.</dd>
	 * <dt>dwData1</dt>
	 * <dd>The transaction identifier of the completed transaction.</dd>
	 * <dt>dwData2</dt>
	 * <dd>Any applicable DDE_ status flags in the low word. This parameter
	 * provides support for applications dependent on DDE_APPSTATUS bits. It is
	 * recommended that applications no longer use these bits — they may not
	 * be supported in future versions of the DDEML.</dd>
	 * </dl>
	 * 
	 * <p>
	 * <strong>Remarks</strong>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>uFmt</dt>
	 * <dd>The format of the data sent from the server.</dd>
	 * <dt>hConv</dt>
	 * <dd>A handle to the conversation.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name.</dd>
	 ...
	 * <dd>A handle to the service name.</dd>
	 * <dt>hdata</dt>
	 * <dd>A handle to the data that the client is sending to the server.</dd>
	 * </dl>
	 * 
	 * <p>
	 * <strong>Return value</strong>
	 ...
	 * processes this transaction, the {@link #DDE_FBUSY} flag if it is too busy
	 * to process this transaction, or the {@link #DDE_FNOTPROCESSED} flag if it
	 ...
	 * <p>
	 * This transaction is filtered if the server application specified the
	 * {@link #CBF_FAIL_POKES} flag in the {@link #DdeInitialize} function.
	 * </p>
	 */
	 ...
	 * Management Library (DDEML) server application uses the
	 * {@link #DdeNameService} function to register a service name, or whenever
	 * a non-DDEML application that supports the System topic is started.
	 * 
	 * <p>
	 * Used Parameters
	 * </p>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the base service name being registered.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the instance-specific service name being registered.</dd>
	 * </dl>
	 *
	 * <strong>Remarks</strong>
	 * <p>
	 * This transaction is filtered if the application specified the
	 * {@link #CBF_SKIP_REGISTRATIONS} flag in the {@link #DdeInitialize}
	 * function.
	 * </p>
	 *
	 * <p>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>uFmt</dt>
	 * <dd>The format in which the server should submit data to the client.</dd>
	 * <dt>hConv</dt>
	 * <dd>A handle to the conversation.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name.</dd>
	 ...
	 *
	 * <p>
	 * The server should call the {@link #DdeCreateDataHandle} function to
	 * create a data handle that identifies the data and then return the handle.
	 * The server should return NULL if it is unable to complete the
	 * transaction. If the server returns NULL, the client will receive a
	 * {@link #DDE_FNOTPROCESSED} flag.
	 * </p>
	 * 
	 * <p>
	 * <strong>Remarks</strong>
	 ...
	 * <p>
	 * This transaction is filtered if the server application specified the
	 * {@link #CBF_FAIL_REQUESTS} flag in the {@link #DdeInitialize} function.
	 * </p>
	 * <p>
	 ...
	 * application's partner in a conversation uses the {@link #DdeDisconnect}
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>hconv</dt>
	 * <dd>A handle to that the conversation was terminated.</dd>
	 * <dt>dwData2</dt>
	 * <dd>Specifies whether the client is the same application instance as the
	 * server. If the parameter is 1, the client is the same instance. If the
	 * parameter is 0, the client is a different instance.</dd>
	 ...
	 * <p>
	 * This transaction is filtered if the application specified the
	 * {@link #CBF_SKIP_DISCONNECTS} flag in the {@link #DdeInitialize}
	 * function.
	 * </p>
	 * <p>
	 * The application can obtain the status of the terminated conversation by
	 * calling the {@link #DdeQueryConvInfo} function while processing this
	 * transaction. The conversation handle becomes invalid after the callback
	 * function returns.
	 * </p>
	 * <p>
	 * An application cannot block this transaction type; the CBR_BLOCK return
	 ...
	 * Management Library (DDEML) server application uses the
	 * {@link #DdeNameService} function to unregister a service name, or
	 * whenever a non-DDEML application that supports the System topic is
	 * terminated.
	 *
	 * <p>
	 * <strong>Used Parameters</strong>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the base service name being unregistered.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the instance-specific service name being
	 * unregistered.</dd>
	 * </dl>
	 *
	 * <p>
	 ...
	 * the hsz2 parameter to identify which application instance has terminated.
	 * </p>
	 */
	 ...
	 * service name, a NULL topic name, or both in a call to the
	 * {@link #DdeConnect} or {@link #DdeConnectList} function.
	 *
	 * <p>
	 * <strong>Used Parameters</strong>
	 * </p>
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>hsz1</dt>
	 * <dd>A handle to the topic name. If this parameter is NULL, the client is
	 * requesting a conversation on all topic names that the server
	 * supports.</dd>
	 * <dt>hsz2</dt>
	 * <dd>A handle to the service name. If this parameter is NULL, the client
	 * is requesting a conversation on all service names that the server
	 * supports.</dd>
	 * <dt>dwData1</dt>
	 * <dd>A pointer to a CONVCONTEXT structure that contains context
	 * information for the conversation. If the client is not a DDEML
	 ...
	 * <dt>dwData2</dt>
	 * <dd>Specifies whether the client is the same application instance as the
	 * server. If the parameter is 1, the client is same instance. If the
	 * parameter is 0, the client is a different instance.</dd>
	 * </dl>
	 *
	 * <p>
	 ...
	 * confirmations if it specified the {@link #CBF_SKIP_CONNECT_CONFIRMS} flag
	 * in the {@link #DdeInitialize} function.
	 * </p>
	 * <p>
	 ...
	 * specify the {@link #APPCLASS_MONITOR} value when it calls the
	 ...
	 * <dd>The transaction type.</dd>
	 * <dt>hdata</dt>
	 * <dd>A handle to a DDE object that contains information about the DDE
	 * event. The application should use the {@link #DdeAccessData} function to
	 * obtain a pointer to the object.</dd>
	 * <dt>dwData2</dt>
	 * <dd>The DDE event. This parameter can be one of the following values.
	 * <table>
	 * <tr>
	 * <th>Value</th>
	 * <th>Meaning</th>
	 * </tr>
	 * <tr>
	 * <td>{@link #MF_CALLBACKS}</td>
	 * <td>The system sent a transaction to a DDE callback function. The DDE
	 * object contains a MONCBSTRUCT structure that provides information about
	 * the transaction.</td>
	 * </tr>
	 * <tr>
	 * <td>{@link #MF_CONV}</td>
	 * <td>A DDE conversation was established or terminated. The DDE object
	 * contains a MONCONVSTRUCT structure that provides information about the
	 * conversation.</td>
	 * </tr>
	 * <tr>
	 * <td>{@link #MF_ERRORS}</td>
	 * <td>A DDE error occurred. The DDE object contains a MONERRSTRUCT
	 * structure that provides information about the error.</td>
	 * </tr>
	 * <tr>
	 * <td>{@link #MF_HSZ_INFO}</td>
	 * <td>A DDE application created, freed, or incremented the usage count of a
	 * string handle, or a string handle was freed as a result of a call to the
	 * {@link #DdeUninitialize} function. The DDE object contains a MONHSZSTRUCT
	 * structure that provides information about the string handle.</td>
	 * </tr>
	 * <tr>
	 * <td>{@link #MF_LINKS}</td>
	 * <td>A DDE application started or stopped an advise loop. The DDE object
	 * contains a MONLINKSTRUCT structure that provides information about the
	 * advise loop.</td>
	 * </tr>
	 * <tr>
	 * <td>{@link #MF_POSTMSGS}</td>
	 * <td>The system or an application posted a DDE message. The DDE object
	 * contains a MONMSGSTRUCT structure that provides information about the
	 * message.</td>
	 * </tr>
	 * <tr>
	 * <td>{@link #MF_SENDMSGS}</td>
	 * <td>The system or an application sent a DDE message. The DDE object
	 * contains a MONMSGSTRUCT structure that provides information about the
	 * message.</td>
	 * </tr>
	 * </table>
	...
	/**
	 * The response to the transaction caused the {@link #DDE_FBUSY} flag to be
	 * set.
	 */
	 ...
	 * {@link #DdeInitialize} function, or an invalid instance identifier was
	 * passed to a DDEML function.
	 */
	public int DMLERR_DLL_NOT_INITIALIZED = 0x4003;
	/**
	 * An application initialized as {@link #APPCLASS_MONITOR} has attempted to
	 * perform a DDE transaction, or an application initialized as
	 * {@link #APPCMD_CLIENTONLY} has attempted to perform server transactions.
	 */
	 ...
	 * {@link #DdeEnableCallback} function was called from within a DDEML
	 * callback function.
	 */
	 ...
	 * the application has returned from an {@link #XTYP_XACT_COMPLETE}
	 * callback, the transaction identifier for that callback function is no
	 * longer valid.
	 */
	...
	/**
	 * Prevents the callback function from receiving {@link #XTYP_CONNECT}
	 ...
	 * {@link #XTYP_ADVSTOP} transactions. The system returns
	 * {@link #DDE_FNOTPROCESSED} to each client that sends an
	 * {@link #XTYP_ADVSTART} or {@link #XTYP_ADVSTOP} transaction to the
	 * server.
	 */
	public int CBF_FAIL_ADVISES = 0x00004000;
	/**
	 * Prevents the callback function from receiving {@link #XTYP_EXECUTE}
	 * transactions. The system returns {@link #DDE_FNOTPROCESSED} to a client
	 * that sends an {@link #XTYP_EXECUTE} transaction to the server.
	 */
	public int CBF_FAIL_EXECUTES = 0x00008000;
	/**
	 * Prevents the callback function from receiving {@link #XTYP_POKE}
	 * transactions. The system returns {@link #DDE_FNOTPROCESSED} to a client
	 * that sends an {@link #XTYP_POKE} transaction to the server.
	 */
	public int CBF_FAIL_POKES = 0x00010000;
	/**
	 * Prevents the callback function from receiving {@link #XTYP_REQUEST}
	 * transactions. The system returns {@link #DDE_FNOTPROCESSED} to a client
	 * that sends an {@link #XTYP_REQUEST} transaction to the server.
	 */
	public int CBF_FAIL_REQUESTS = 0x00020000;
	/**
	 * Prevents the callback function from receiving server transactions. The
	 * system returns {@link #DDE_FNOTPROCESSED} to each client that sends a
	 ...
	 * {@link #XTYP_CONNECT_CONFIRM} notifications.
	 */
	...
	/**
	 * Prevents the DDEML from sending {@link #XTYP_CONNECT} and
	 * {@link #XTYP_WILDCONNECT} transactions to the application until the
	 ...
	 * {@link #DdeNameService} or {@link #DdeInitialize} function. This flag is
	 * always in effect when an application calls {@link #DdeInitialize} for the
	 * first time, regardless of whether the application specifies the flag. On
	 * subsequent calls to {@link #DdeInitialize}, not specifying this flag
	 * turns off the application's service-name filters, but specifying it turns
	 * on the application's service name filters.
	 */
	 ...
	 * 
	 * @param pidInst
	 *            The application instance identifier. At initialization, this
	 *            parameter should point to 0. If the function succeeds, this
	 *            parameter points to the instance identifier for the
	 *            application. This value should be passed as the idInst
	 *            parameter in all other DDEML functions that require it. If an
	 *            application uses multiple instances of the DDEML dynamic-link
	 *            library (DLL), the application should provide a different
	 *            callback function for each instance.
	 *
	 *            <p>
	 * 			If pidInst points to a nonzero value, reinitialization of the
	 *            DDEML is implied. In this case, pidInst must point to a valid
	 ...
	 *            provide special instructions to DdeInitialize. The CBF_ flags
	 *            specify filters that prevent specific types of transactions
	 *            from reaching the callback function. The MF_ flags specify the
	 *            types of DDE activity that a DDE monitoring application
	 *            monitors. Using these flags enhances the performance of a DDE
	 *            application by eliminating unnecessary calls to the callback
	 *            function.
	 *
	 *            <p>
	 ...
	 *            <td>
	 *            <p>
	 *            Makes it possible for the application to monitor DDE activity
	 *            in the system. This flag is for use by DDE monitoring
	 *            applications. The application specifies the types of DDE
	 *            activity to monitor by combining one or more monitor flags
	 *            with the {@link #APPCLASS_MONITOR} flag. For details, see the
	 ...
	 *            conversation. The application can only be a client. This flag
	 *            reduces consumption of resources by the DDEML. It includes the
	 *            functionality of the {@link #CBF_FAIL_ALLSVRXACTIONS} flag.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <p>
	 *            Prevents the DDEML from sending {@link #XTYP_CONNECT} and
	 *            {@link #XTYP_WILDCONNECT} transactions to the application
	 *            until the application has created its string handles and
	 *            registered its service names or has turned off filtering by a
	 *            subsequent call to the {@link #DdeNameService} or
	 *            DdeInitialize function. This flag is always in effect when an
	 *            application calls DdeInitialize for the first time, regardless
	 *            of whether the application specifies the flag. On subsequent
	 *            calls to DdeInitialize, not specifying this flag turns off the
	 *            application's service-name filters, but specifying it turns on
	 ...
	 *            <td>
	 *            <p>
	 *            Prevents the callback function from receiving server
	 *            transactions. The system returns {@link #DDE_FNOTPROCESSED} to
	 *            each client that sends a transaction to this application. This
	 *            flag is equivalent to combining all CBF_FAIL_ flags.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_ADVSTART} and {@link #XTYP_ADVSTOP} transactions.
	 *            The system returns {@link #DDE_FNOTPROCESSED} to each client
	 *            that sends an {@link #XTYP_ADVSTART} or {@link #XTYP_ADVSTOP}
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_CONNECT} and {@link #XTYP_WILDCONNECT}
	 *            transactions.
	 *            </p>
	 *            </td>
	 *            </tr>
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_EXECUTE} transactions. The system returns
	 *            {@link #DDE_FNOTPROCESSED} to a client that sends an
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_POKE} transactions. The system returns
	 *            {@link #DDE_FNOTPROCESSED} to a client that sends an
	 *            {@link #XTYP_POKE} transaction to the server.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_REQUEST} transactions. The system returns
	 *            {@link #DDE_FNOTPROCESSED} to a client that sends an
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_CONNECT} transactions from the application's own
	 *            instance. This flag prevents an application from establishing
	 *            a DDE conversation with its own instance. An application
	 *            should use this flag if it needs to communicate with other
	 *            instances of itself but not with itself.
	 *            </p>
	 *            </td>
	 *            </tr>
	 ...
	 *            <td>
	 *            <p>
	 *            Prevents the callback function from receiving any
	 *            notifications. This flag is equivalent to combining all
	 *            CBF_SKIP_ flags.
	 *            </p>
	 *            </td>
	 *            </tr>
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_DISCONNECT} notifications.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_REGISTER} notifications.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <p>
	 *            Prevents the callback function from receiving
	 *            {@link #XTYP_UNREGISTER} notifications.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <td>
	 *            <p>
	 *            Notifies the callback function whenever a transaction is sent
	 *            to any DDE callback function in the system.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <td>
	 *            <p>
	 *            Notifies the callback function whenever a DDE application
	 *            creates, frees, or increments the usage count of a string
	 *            handle or whenever a string handle is freed as a result of a
	 *            call to the {@link #DdeUninitialize} function.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 ...
	 * 
	 * @param hszService
	 *            A handle to the string that specifies the service name of the
	 *            server application with which a conversation is to be
	 *            established. If this parameter is 0L, the system attempts to
	 *            establish conversations with all available servers that
	 *            support the specified topic name.
	 * 
	 * @param hszTopic
	 *            A handle to the string that specifies the name of the topic on
	 *            which a conversation is to be established. This handle must
	 *            have been created by a previous call to the
	 *            {@link #DdeCreateStringHandle} function. If this parameter is
	 *            0L, the system will attempt to establish conversations on all
	 *            topics supported by the selected server (or servers).
	 * 
	 * @param hConvList
	 *            A handle to the conversation list to be enumerated. This
	 *            parameter should be 0L if a new conversation list is to be
	 *            established.
	 * 
	 * @param pCC
	 *            A pointer to the CONVCONTEXT structure that contains
	 *            conversation-context information. If this parameter is NULL,
	 *            the server receives the default CONVCONTEXT structure during
	 *            the {@link #XTYP_CONNECT} or {@link #XTYP_WILDCONNECT}
	 *            transaction.
	 * 
	 * @return If the function succeeds, the return value is the handle to a new
	 *         conversation list.
	 * 
	 *         <p>
	 * 		If the function fails, the return value is 0L. The handle to the
	 *         old conversation list is no longer valid.
	 *         </p>
	 * 
	 *         <p>
	 * 		The {@link #DdeGetLastError} function can be used to get the
	 ...
	 * 
	 * @param hConvList
	 *            A handle to the conversation list. This handle must have been
	 *            created by a previous call to the {@link #DdeConnectList}
	 *            function.
	 * 
	 * @param hConvPrev
	 *            A handle to the conversation handle previously returned by
	 *            this function. If this parameter is 0L, the function returns
	 *            the first conversation handle in the list.
	 * 
	 * @return If the list contains any more conversation handles, the return
	 *         value is the next conversation handle in the list; otherwise, it
	 *         is 0L.
	 */
	public HCONV DdeQueryNextServer(HCONVLIST hConvList, HCONV hConvPrev);

	/**
	 * Destroys the specified conversation list and terminates all conversations
	 ...
	 *            A handle to the string that specifies the service name of the
	 *            server application with which a conversation is to be
	 *            established. This handle must have been created by a previous
	 *            call to the {@link #DdeCreateStringHandle} function. If this
	 *            parameter is 0L, a conversation is established with any
	 *            available server.
	 *
	 * @param hszTopic
	 *            A handle to the string that specifies the name of the topic on
	 ...
	 *            {@link #DdeCreateStringHandle}. If this parameter is 0L, a
	 *            conversation on any topic supported by the selected server is
	 *            established.
	 *
	 * @param pCC
	 *            A pointer to the CONVCONTEXT structure that contains
	 ...
	 * {@link #DdeConnectList} function and invalidates the specified
	 * conversation handle.
	 *
	 * @param hConv
	 ...
	 *            must have obtained the conversation handle by a previous call
	 *            to the {@link #DdeConnect} function or from an
	 *            {@link #XTYP_DISCONNECT} transaction.
	 * @return If the function succeeds, the return value is the handle to the
	...
	/**
	 * Retrieves information about a Dynamic Data Exchange (DDE) transaction and
	 * about the conversation in which the transaction takes place.
	 * 
	 * @param hConv
	 *            A handle to the conversation.
	 * @param idTransaction
	 *            The transaction. For asynchronous transactions, this parameter
	 *            should be a transaction identifier returned by the
	 *            {@link #DdeClientTransaction} function. For synchronous
	 *            transactions, this parameter should be {@link #QID_SYNC}.
	 * @param pConvInfo
	 *            A pointer to the CONVINFO structure that receives information
	 *            about the transaction and conversation. The cb member of the
	 *            CONVINFO structure must specify the length of the buffer
	 ...
	 * asynchronous transactions. An application can use the
	 * {@link #DdeQueryConvInfo} function to retrieve this value.
	 *
	 * @param hConv
	 *            A handle to the conversation.
	 * @param id
	 *            The transaction identifier to associate with the value
	 *            specified by the hUser parameter. An application should set
	 *            this parameter to {@link #QID_SYNC} to associate hUser with
	 *            the conversation identified by the hConv parameter.
	 * @param hUser
	 ...
	 *            initiated. If this parameter is 0L, all transactions are
	 *            abandoned (that is, the idTransaction parameter is ignored).
	 * @param idTransaction
	 *            The identifier of the transaction to be abandoned. If this
	 *            parameter is 0L, all active transactions in the specified
	...
	/**
	 * Causes the system to send an {@link #XTYP_ADVREQ} transaction to the
	 * calling (server) application's Dynamic Data Exchange (DDE) callback
	 * function for each client with an active advise loop on the specified
	 * topic and item. A server application should call this function whenever
	 * the data associated with the topic name or item name pair changes.
	 *
	 *
	 * @param idInst
	 *            The application instance identifier obtained by a previous
	 ...
	 *
	 * @param hszTopic
	 *            A handle to a string that specifies the topic name. To send
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #EC_ENABLEALL}</td>
	 *            <td>Enables all transactions for the specified
	 *            conversation.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #EC_ENABLEONE}</td>
	 *            <td>Enables one transaction for the specified
	 *            conversation.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #EC_DISABLE}</td>
	 *            <td>Disables all blockable transactions for the specified
	 *            conversation.
	 *
	 *            <p>
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #EC_QUERYWAITING}</td>
	 *            <td>Determines whether any transactions are in the queue for
	 *            the specified conversation.</td>
	 *            </tr>
	 *            </table>
	 *
	 ...
	 *
	 *         <p>
	 *         If the wCmd parameter is {@link #EC_QUERYWAITING}, and the
	 *         application transaction queue contains one or more unprocessed
	 *         transactions that are not being processed, the return value is
	 ...
	 * server supports. This function causes the system to send
	 * {@link #XTYP_REGISTER} or {@link #XTYP_UNREGISTER} transactions to other
	 * running Dynamic Data Exchange Management Library (DDEML) client
	 * applications.
	 *
	 * @param idInst
	 *            The application instance identifier obtained by a previous
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #DNS_REGISTER}</td>
	 *            <td>Registers the error code service name.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #DNS_UNREGISTER}</td>
	 *            <td>Unregisters the error code service name. If the hsz1
	 *            parameter is 0L, all service names registered by the server
	 *            will be unregistered.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #DNS_FILTERON}</td>
	 *            <td>Turns on service name initiation filtering. The filter
	 *            prevents a server from receiving {@link #XTYP_CONNECT}
	 *            transactions for service names it has not registered. This is
	 *            the default setting for this filter. <br>
	 * 			<br>
	 *            If a server application does not register any service names,
	 *            the application cannot receive {@link #XTYP_WILDCONNECT}
	 *            transactions.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #DNS_FILTEROFF}</td>
	 *            <td>Turns off service name initiation filtering. If this flag
	 *            is specified, the server receives an {@link #XTYP_CONNECT}
	 *            transaction whenever another DDE application calls the
	 *            {@link #DdeConnect} function, regardless of the service
	 *            name.</td>
	 *            </tr>
	 *            </table>
	 * @return If the function succeeds, it returns a nonzero value. That value
	 *         is not a true HDDEDATA value, merely a Boolean indicator of
	 *         success. The function is typed HDDEDATA to allow for possible
	 ...
	 *            (HDDEDATA) to pass to the server and in that case the cbData
	 *            parameter should be set to -1. This parameter is required only
	 *            if the wType parameter is {@link #XTYP_EXECUTE} or
	 *            {@link #XTYP_POKE}. Otherwise, this parameter should be NULL.
	 *            </p>
	 * 
	 *            <p>
	 * 			For the optional usage of this parameter, {@link #XTYP_POKE}
	 *            transactions where pData is a data handle, the handle must
	 *            have been created by a previous call to the
	 *            {@link #DdeCreateDataHandle} function, employing the same data
	 *            format specified in the wFmt parameter.
	 *            </p>
	 * 
	 * @param cbData
	 *            The length, in bytes, of the data pointed to by the pData
	 *            parameter, including the terminating NULL, if the data is a
	 *            string. A value of -1 indicates that pData is a data handle
	 *            that identifies the data being sent.
	 * 
	 * @param hConv
	 ...
	 * 
	 * @param hszItem
	 *            A handle to the data item for which data is being exchanged
	 *            during the transaction. This handle must have been created by
	 *            a previous call to the {@link #DdeCreateStringHandle}
	 *            function. This parameter is ignored (and should be set to 0L)
	 *            if the wType parameter is {@link #XTYP_EXECUTE}.
	 * 
	 * @param wFmt
	 *            The standard clipboard format in which the data item is being
	 *            submitted or requested.
	 * 
	 *            <p>
	 * 			If the transaction specified by the wType parameter does not
	 *            pass data or is {@link #XTYP_EXECUTE}, this parameter should
	 *            be zero.
	 *            </p>
	 * 
	 *            <p>
	 * 			If the transaction specified by the wType parameter references
	 *            non-execute DDE data ( {@link #XTYP_POKE},
	 *            {@link #XTYP_ADVSTART}, {@link #XTYP_ADVSTOP},
	 *            {@link #XTYP_REQUEST}), the wFmt value must be either a valid
	 *            predefined (CF_) DDE format or a valid registered clipboard
	 *            format.
	 *            </p>
	 * 
	 * @param wType
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #XTYP_ADVSTART}</td>
	 *            <td>Begins an advise loop. Any number of distinct advise loops
	 *            can exist within a conversation. An application can alter the
	 *            advise loop type by combining the {@link #XTYP_ADVSTART}
	 *            transaction type with one or more of the following flags:
	 *            <dl>
	 *            <dt>{@link #XTYPF_NODATA}.</dt>
	 *            <dd>Instructs the server to notify the client of any data
	 *            changes without actually sending the data. This flag gives the
	 *            client the option of ignoring the notification or requesting
	 *            the changed data from the server.</dd>
	 *            <dt>{@link #XTYPF_ACKREQ}.</dt>
	 *            <dd>Instructs the server to wait until the client acknowledges
	 *            that it received the previous data item before sending the
	 *            next data item. This flag prevents a fast server from sending
	 *            data faster than the client can process it.</dd>
	 *            </dl>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #XTYP_ADVSTOP}</td>
	 *            <td>Ends an advise loop.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #XTYP_EXECUTE}</td>
	 *            <td>Begins an execute transaction.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #XTYP_POKE}</td>
	 *            <td>Begins a poke transaction.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>{@link #XTYP_REQUEST}</td>
	 *            <td>Begins a request transaction.</td>
	 *            </tr>
	 *            </table>
	 *
	 * @param dwTimeout
	 *            The maximum amount of time, in milliseconds, that the client
	 *            will wait for a response from the server application in a
	 *            synchronous transaction. This parameter should be
	 *            {@link #TIMEOUT_ASYNC} for asynchronous transactions.
	 * 
	 * @param pdwResult
	 *            A pointer to a variable that receives the result of the
	 *            transaction. An application that does not check the result can
	 *            use NULL for this value. For synchronous transactions, the
	 *            low-order word of this variable contains any applicable DDE_
	 *            flags resulting from the transaction. This provides support
	 *            for applications dependent on DDE_APPSTATUS bits. It is,
	 *            however, recommended that applications no longer use these
	 *            bits because they may not be supported in future versions of
	 *            the Dynamic Data Exchange Management Library (DDEML). For
	 *            asynchronous transactions, this variable is filled with a
	 *            unique transaction identifier for use with the
	 *            {@link #DdeAbandonTransaction} function and the
	 *            {@link #XTYP_XACT_COMPLETE} transaction.
	 * 
	 * @return If the function succeeds, the return value is a data handle that
	 *         identifies the data for successful synchronous transactions in
	 *         which the client expects data from the server. The return value
	 *         is nonzero for successful asynchronous transactions and for
	 *         synchronous transactions in which the client does not expect
	 *         data. The return value is zero for all unsuccessful transactions.
	 * 
	 *         <p>
	 * 		The {@link #DdeGetLastError} function can be used to get the
	 *         error code, which can be one of the following values:
	 ...
	 *         </ul>
	 */
	public HDDEDATA DdeClientTransaction(Pointer pData, int cbData, HCONV hConv, HSZ hszItem, int wFmt, int wType, int dwTimeout,
	 ...
	 * 
	 * @param pSrc
	 *            The data to be copied to the DDE object. If this parameter is
	 *            NULL, no data is copied to the object.
	 * 
	 * @param cb
	 *            The amount of memory, in bytes, to copy from the buffer
	 *            pointed to by pSrc. (include the terminating NULL, if the data
	 *            is a string). If this parameter is zero, the pSrc parameter is
	 *            ignored.
	 * 
	 * @param cbOff
	 *            An offset, in bytes, from the beginning of the buffer pointed
	 *            to by the pSrc parameter. The data beginning at this offset is
	 *            copied from the buffer to the DDE object.
	 * 
	 * @param hszItem
	 *            A handle to the string that specifies the data item
	 *            corresponding to the DDE object. This handle must have been
	 *            created by a previous call to the
	 *            {@link #DdeCreateStringHandle} function. If the data handle is
	 *            to be used in an {@link #XTYP_EXECUTE} transaction, this
	 *            parameter must be 0L.
	 * 
	 * @param wFmt
	 ...
	 *            DdeCreateDataHandle function owns the data handle this
	 *            function creates. This flag enables the application to share
	 *            the data handle with other DDEML applications rather than
	 *            creating a separate handle to pass to each application. If
	 *            this flag is specified, the application must eventually free
	 *            the shared memory object associated with the handle by using
	 *            the {@link #DdeFreeDataHandle} function. If this flag is not
	 *            specified, the handle becomes invalid in the application that
	 *            created the handle after the data handle is returned by the
	 *            application's DDE callback function or is used as a parameter
	 *            in another DDEML function.
	 * 
	 ...
	 *            object, including the terminating NULL, if the data is a
	 *            string.
	 * 
	 * @param cbOff
	 *            An offset, in bytes, from the beginning of the DDE object. The
	 *            additional data is copied to the object beginning at this
	 *            offset.
	 * 
	 * @return If the function succeeds, the return value is a new handle to the
	 *         DDE object. The new handle is used in all references to the
	 *         object.
	 * 
	 *         <p>
	 * 		If the function fails, the return value is zero.
	...
	/**
	 * Copies data from the specified Dynamic Data Exchange (DDE) object to the
	 ...
	 *            parameter is NULL, the DdeGetData function returns the amount
	 *            of data, in bytes, that would be copied to the buffer.
	 * 
	 * @param cbMax
	 *            The maximum amount of data, in bytes, to copy to the buffer
	 *            pointed to by the pDst parameter. Typically, this parameter
	 ...
	 * 
	 * @return If the pDst parameter points to a buffer, the return value is the
	 ...
	 * 
	 *         <p>
	 * 		If the pDst parameter is NULL, the return value is the size, in
	 *         bytes, of the memory object associated with the data handle.
	 *         </p>
	 * 
	 *         <p>
	 * 		The {@link #DdeGetLastError} function can be used to get the
	...
	/**
	 * Provides access to the data in the specified Dynamic Data Exchange (DDE)
	 * object. An application must call the {@link #DdeUnaccessData} function
	 ...
	 *
	 * @param pcbDataSize
	 *            A pointer to a variable that receives the size, in bytes, of
	 *            the DDE object identified by the hData parameter. If this
	 ...
	 * 
	 * @param hData
	 *            A handle to the DDE object to be freed. This handle must have
	 *            been created by a previous call to the
	 *            {@link #DdeCreateDataHandle} function or returned by the
	 *            {@link #DdeClientTransaction} function.
	 * 
	 ...
	 * Exchange (DDE) client or server application can pass the string handle as
	 * a parameter to other Dynamic Data Exchange Management Library (DDEML)
	 * functions.
	 * 
	 * @param idInst
	 *            The application instance identifier obtained by a previous
	 ...
	 * 
	 * @param psz
	 *            The null-terminated string for which a handle is to be
	 *            created. This string can be up to 255 characters. The reason
	 *            for this limit is that DDEML string management functions are
	 *            implemented using atoms.
	 * 
	 * @param iCodePage
	 *            The code page to be used to render the string. This value
	 *            should be either {@link #CP_WINANSI} (the default code page)
	 *            or {@link #CP_WINUNICODE}, depending on whether the ANSI or
	 *            Unicode version of {@link #DdeInitialize} was called by the
	 *            client application.
	 * 
	 ...
	 *            created by a previous call to the
	 *            {@link #DdeCreateStringHandle} function.
	 * 
	 * @param psz
	 ...
	 * 
	 * @param cchMax
	 *            The length, in characters, of the buffer pointed to by the psz
	 *            parameter. For the ANSI version of the function, this is the
	 *            number of bytes; for the Unicode version, this is the number
	 *            of characters. If the string is longer than ( cchMax� 1), it
	 *            will be truncated. If the psz parameter is set to NULL, this
	 *            parameter is ignored.
	 * 
	 * @param iCodePage
	 *            The code page used to render the string. This value should be
	 *            either {@link #CP_WINANSI} or {@link #CP_WINUNICODE}.
	 * 
	 * @return If the psz parameter specified a valid pointer, the return value
	 *         is the length, in characters, of the returned text (not including
	 *         the terminating null character). If the psz parameter specified a
	 *         NULL pointer, the return value is the length of the text
	 *         associated with the hsz parameter (not including the terminating
	 *         null character).
	 * 
	 *         <p>
