...
public class COMInvokeException extends COMException {
	 ...
	 *            exception message
	 * @param hresult
	 *            hresult of the invoke call
	 * @param errorArg
	 *            the position of the argument that caused the error
	 * @param description
	 *            The exception description to display. If no description is
	 *            available, use null.
	 * @param helpContext
	 *            The help context ID.
	 * @param helpFile
	 *            The fully qualified help file path. If no Help is available,
	 *            use null.
	 * @param scode
	 *            A return value that describes the error. Either this field or
	 *            wCode (but not both) must be filled in; the other must be set
	 *            to 0. (16-bit Windows versions only.)
	 * @param source
	 *            The name of the exception source. Typically, this is an
	 *            application name. This field should be filled in by the
	 *            implementor of IDispatch.
	 * @param wCode
	 *            The error code. Error codes should be greater than 1000.
	 *            Either this field or the scode field must be filled in; the
	 *            other must be set to 0.
	 */
	public COMInvokeException(String message, HRESULT hresult, Integer errorArg, String description, Integer helpContext,
			String helpFile, Integer scode, String source, Integer wCode) {
	 ...
	 *         this field or the scode field must be filled in; the other must
	 *         be set to 0. It is NULL if no exception info was created
	 */
	 ...
	 *         application name. This field should be filled in by the
	 *         implementor of IDispatch. NULL if no exception info was created
	 */
	 ...
	 *         wCode (but not both) must be filled in; the other must be set to
	 *         0. (16-bit Windows versions only.) NULL if no exception info was
	 *         created.
	 */
