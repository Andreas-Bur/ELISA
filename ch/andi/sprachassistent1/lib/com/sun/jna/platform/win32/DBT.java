...
public interface DBT {
	...
	public class DEV_BROADCAST_OEM extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dbco_size", "dbco_devicetype", "dbco_reserved",
				"dbco_identifier", "dbco_suppfunc");
	...
	public class DEV_BROADCAST_DEVNODE extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dbcd_size", "dbcd_devicetype", "dbcd_reserved",
				"dbcd_devnode");
		/** The dbcd_size. */
	...
	public class DEV_BROADCAST_VOLUME extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dbcv_size", "dbcv_devicetype", "dbcv_reserved",
	...
	public class DEV_BROADCAST_NET extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dbcn_size", "dbcn_devicetype", "dbcn_reserved",
				"dbcn_resource", "dbcn_flags");
	...
	public class DEV_BROADCAST_DEVICEINTERFACE extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dbcc_size", "dbcc_devicetype", "dbcc_reserved",
	...
	public class DEV_BROADCAST_HANDLE extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("dbch_size", "dbch_devicetype", "dbch_reserved",
				"dbch_handle", "dbch_hdevnotify", "dbch_eventguid", "dbch_nameoffset", "dbch_data");
