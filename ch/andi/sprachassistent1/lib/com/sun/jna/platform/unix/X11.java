...
public interface X11 extends Library {
	...
	interface Xrender extends Library {
		...
		class XRenderDirectFormat extends Structure {
			public static final List<String> FIELDS = createFieldsOrder("red", "redMask", "green", "greenMask", "blue",
	...
	class XWMHints extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("flags", "input", "initial_state", "icon_pixmap",
	...
	class XSizeHints extends Structure {
		...
		public static final List<String> FIELDS = createFieldsOrder("flags", "x", "y", "width", "height", "min_width",
				"min_height", "max_width", "max_height", "width_inc", "height_inc", "min_aspect", "max_aspect", "base_width",
	...
	class XWindowAttributes extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("x", "y", "width", "height", "border_width", "depth",
				"visual", "root", "c_class", "bit_gravity", "win_gravity", "backing_store", "backing_planes", "backing_pixel",
	...
	class XSetWindowAttributes extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("background_pixmap", "background_pixel", "border_pixmap",
				"border_pixel", "bit_gravity", "win_gravity", "backing_store", "backing_planes", "backing_pixel", "save_under",
				"event_mask", "do_not_propagate_mask", "override_redirect", "colormap", "cursor");
	...
	class XVisualInfo extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("visual", "visualid", "screen", "depth", "c_class",
				"red_mask", "green_mask", "blue_mask", "colormap_size", "bits_per_rgb");
	...
	class XGCValues extends Structure {
		public static final List<String> FIELDS = createFieldsOrder("function", "plane_mask", "foreground", "background",
				"line_width", "line_style", "cap_style", "join_style", "fill_style", "fill_rule", "arc_mode", "tile", "stipple",
				"ts_x_origin", "ts_y_origin", "font", "subwindow_mode", "graphics_exposures", "clip_x_origin", "clip_y_origin",
	...
	public static class XClientMessageEvent extends Structure {
		...
		protected List getFieldOrder() {
			return Arrays.asList(
					new String[] { "type", "serial", "send_event", "display", "window", "message_type", "format", "data" });
		}
	...
	class XGraphicsExposeEvent extends Structure {
		...
		@Override
		protected List getFieldOrder() {
			return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "drawable", "x", "y", "width",
					"height", "count", "major_code", "minor_code" });
		}
	}
	...
	class XErrorEvent extends Structure {
		...
		protected List getFieldOrder() {
			return Arrays.asList(
					new String[] { "type", "display", "serial", "error_code", "request_code", "minor_code", "resourceid" });
		}
	}
	 ...
	 * for the window, and it returns zero. If the WM_NAME property has not been
	 * set for this window, XFetchName() sets window_name_return to NULL. If the
	...
	class XKeyboardControlRef extends Structure implements Structure.ByReference {
		...
		public String toString() {
			return "XKeyboardControlByReference{" + "key_click_percent=" + key_click_percent + ", bell_percent=" + bell_percent
					+ ", bell_pitch=" + bell_pitch + ", bell_duration=" + bell_duration + ", led=" + led + ", led_mode="
					+ led_mode + ", key=" + key + ", auto_repeat_mode=" + auto_repeat_mode + '}';
		}
	}
