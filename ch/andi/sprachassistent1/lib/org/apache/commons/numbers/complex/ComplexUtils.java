...
public class ComplexUtils {
	 ...
	 *
	 * @param r
	 *            {@code double[]} of moduli
	 * @param theta
	 *            {@code double[]} of arguments
	 * @return {@code Complex[]}
	 * @since 1.0
	 */
	public static Complex[] polar2Complex(double[] r, double[] theta) {
	 ...
	 *
	 * @param d
	 *            array of interleaved complex numbers alternating real and
	 *            imaginary values
	 * @param index
	 *            location in the array This is the location by complex number,
	 *            e.g. index number 5 in the array will return
	 *            {@code Complex.ofCartesian(d[10], d[11])}
	 * @return {@code Complex}.
	 *
	 * @since 1.0
	 */
	 ...
	 *
	 * @param f
	 *            float array of interleaved complex numbers alternating real
	...
	/**
	 * Converts a 4D real {@code double[][][][]} array to a
	 * {@code Complex [][][][]} array.
	 *
	 * @param d
	 *            4D complex interleaved array
	...
	/**
	 * Converts a 4D imaginary array {@code double[][][][]} to a 4D
	 * {@code Complex[][][][]} array.
	 *
	 * @param i
	 *            4D complex imaginary array
	 * @return 4D {@code Complex} array
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Converts imaginary component of a 4D {@code Complex[][][][]} array to a
	 * 4D {@code double[][][][]} array.
	 *
	 * @param c
	 *            4D complex interleaved array
	 * @return 4D {@code Complex} array
	 ...
	 *
	 * @param interleaved
	 *            float[] array of numbers to be converted to their
	 ...
	 * @param c
	 *            Complex array
	 * @return complex interleaved array alternating real and imaginary values
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Converts a 2D {@code Complex[][]} array to an interleaved complex
	 * {@code double[][]} array. The second d level of the array is assumed to
	 * be interleaved.
	 *
	 * @param c
	 *            2D Complex array
	...
	/**
	 * Converts a 3D {@code Complex[][][]} array to an interleaved complex
	 * {@code double[][][]} array. The third level of the array is interleaved.
	 *
	 * @param c
	 *            3D Complex array
	 * @return complex interleaved array alternating real and imaginary values
	...
	/**
	 * Converts a 2D {@code Complex[][]} array to an interleaved complex
	 * {@code float[][]} array. The second d level of the array is assumed to be
	 * interleaved.
	 *
	 * @param c
	 *            2D Complex array
	...
	/**
	 * Converts a 3D {@code Complex[][][]} array to an interleaved complex
	 * {@code float[][][]} array. The third d level of the array is interleaved.
	 *
	 * @param c
	 *            2D Complex array
	 *
	...
	/**
	 * Converts a 2D interleaved complex {@code double[][]} array to a
	 * {@code Complex[][]} array. The second d level of the array is assumed to
	 * be interleaved.
	 *
	 * @param d
	 *            2D complex interleaved array
	 ...
	 *
	 * @param i
	 *            2D complex interleaved float array
	 * @param interleavedDim
	 *            Depth level of the array to interleave
	 * @return 2D {@code Complex} array
	 *
	 ...
	 *
	 * @param i
	 *            3D complex interleaved float array
	 * @param interleavedDim
	 *            Depth level of the array to interleave
	 * @return 3D {@code Complex} array
	 *
	...
	/**
	 * Converts a 3D interleaved complex {@code float[][][]} array to a
	 * {@code Complex[]} array. The third level of the array is assumed to be
	 * interleaved.
	 *
	 * @param d
	 *            3D complex interleaved float array
	 ...
	 * {@code double[][][][] r, double[][][][] i} to a 4D
	 * {@code Complex[][][][]} array.
	 *
	 * @param real
	 *            real component
