 ...
 * coefficient</a>, as a {@code double}. It is "{@code n choose k}", the number
 * of {@code k}-element subsets that can be selected from an {@code n}-element
 * set.
 */
public class BinomialCoefficientDouble {
	/**
	 * Computes de binomial coefficient. The largest value of {@code n} for
	 * which all coefficients can fit into a {@code long} is 66.
	 *
	 * @param n
	 *            Size of the set.
	 * @param k
