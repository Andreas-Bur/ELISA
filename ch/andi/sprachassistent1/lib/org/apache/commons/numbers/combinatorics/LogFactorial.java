 ...
 * allows to allocate a cache of precomputed values. In case of cache miss,
 * computation is performed by a call to {@link LogGamma#value(double)}.
 */
public class LogFactorial {
	 ...
	 * {@code logFactorials[i] = Math.log(i!)}.
	 */
