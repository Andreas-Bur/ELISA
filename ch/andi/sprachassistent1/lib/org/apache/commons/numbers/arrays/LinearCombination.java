...
/**
 * Computes linear combinations accurately. This method computes the sum of the
 * products <code>a<sub>i</sub> b<sub>i</sub></code> to high accuracy. It does
 * so by using specific multiplication and addition algorithms to preserve
 * accuracy and reduce cancellation effects.
 *
...
public class LinearCombination {
	 ...
	 * Caveat:
	 *
	 * The code below is split in many additions/subtractions that may appear
	 * redundant. However, they should NOT be simplified, as they do use IEEE754
	 * floating point arithmetic rounding properties. The variables naming
	 * conventions are that xyzHigh contains the most significant bits of xyz
	 * and xyzLow contains its least significant bits. So theoretically xyz is
	 * the sum xyzHigh + xyzLow, but in many cases below, this sum cannot be
	 * represented in only one double precision number so we preserve two
	 * numbers to hold it as long as we can, combining the high and low order
	 * bits together only at the end, after cancellation may have occurred on
	 * high order bits
	 */
	 ...
	 * @see #value(double, double, double, double, double, double, double,
	 *      double)
	 ...
	 * @param b4
	 *            Second factor of the fourth term.
	...
	/**
	 * @param aLow
	 *            Low part of first factor.
	 * @param bLow
	 *            Low part of second factor.
	 * @param prodHigh
	 *            Product of the factors.
	 * @param aHigh
	 *            High part of first factor.
	 * @param bHigh
	 *            High part of second factor.
