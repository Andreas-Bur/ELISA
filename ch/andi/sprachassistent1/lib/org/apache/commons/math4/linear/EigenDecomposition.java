 ...
 * matrices.
 * <p>
 * This class is similar in spirit to the {@code EigenvalueDecomposition} class
 ...
 * {@code A*V = V*D}, i.e. A.multiply(V) equals V.multiply(D). The matrix V may
 * be badly conditioned, or even singular, so the validity of the equation
 * {@code A = V*D*inverse(V)} depends upon the condition of V.
 * <p>
