...
public class ArrayFieldVector<T extends FieldElement<T>> implements FieldVector<T>, Serializable {
	 ...
	 * use either the {@link #ArrayFieldVector(FieldVector, FieldVector)}
	 * constructor or one of the {@code append} methods
	 * ({@link #add(FieldVector)} or {@link #append(ArrayFieldVector)}) to
