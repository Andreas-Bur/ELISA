...
public class Words {
	...
	private static String[][] englishLetterPhoneCombinations = new String[][] {
			...
			{ "^ee.*$", "IIH", "2" }, { "^ea.*$", "IY", "2" }, { "^ai.*$", "EH IH", "2" }, { "^a[uw].*$", "OO", "2" }, { "^th$", "TH", "2" },
			{ "^th.*$", "DH", "2" }, { "^tch.*$", "CH", "3" }, { "^tion.*$", "SH EH N", "4" }, { "^ay.*$", "EH IH", "2" },
			{ "^ire.*$", "AY EX", "3" }, { "^ch[aeiou].*$", "CH", "2" }, { "^ch[^aeiou].*$", "K", "2" }, { "^ck.*$", "K", "2" },
			{ "^sh.*$", "SH", "2" }, { "^sc.*$", "S", "2" }, { "^ph.*$", "F", "2" }, { "^wh.*$", "W", "2" },
			{ "^ng.*$", "NG", "2" }, { "^qu.*$", "K W", "2" }, { "^igh.*$", "AY", "2" }, { "^dge.*$", "JH", "2" },
			{ "^dg.*$", "JH", "2" }, { "^tio.*$", "SH AX", "3" }, { "^y$", "IY", "1" }, { "^e$", "", "1" },
			{ "^bb.*$", "B", "2" }, { "^cc.*$", "K", "2" }, { "^dd.*$", "D", "2" }, { "^ff.*$", "F", "2" },
			{ "^gg.*$", "G", "2" }, { "^ll.*$", "L", "2" }, { "^mm.*$", "M", "2" }, { "^nn.*$", "NG", "2" },
			{ "^oo.*$", "UU", "2" }, { "^pp.*$", "P", "2" }, { "^rr.*$", "R", "2" }, { "^ss.*$", "S", "2" },
			{ "^tt.*$", "TH", "2" }, { "^zz.*$", "Y", "2" }, { "^gh.*$", "", "2" }, { "^a[^aeiou]*e$", "EE IH", "1" },
			{ "^a[^aeiou][aeiou].*", "EH IH", "1" }, { "^a[l]+$", "OO", "1" }, { "^a[^aeiou]$", "AE", "1" },
			{ "^a[^aeiou]{2}.*", "AE", "1" }, { "^a.*$", "EH", "1" }, { "^b.*$", "B", "1" }, { "^c.*$", "K", "1" },
			...
			{ "^w.*$", "W", "1" }, { "^x.*$", "K S", "1" }, { "^z.*$", "Z", "1" }, { "^kn.*$", "N", "2" }, { "^k.*$", "K", "1" },
			{ "^n.*$", "N", "1" }, { "^ed$", "D", "2" }, { "^d.*$", "D", "1" }, { "^e[^aeiou]*e$", "IIH", "1" },
			{ "^e.*$", "EH", "1" }, { "^ä.*$", "EH", "1" }, { "^ö.*$", "OE", "1" }, { "^ü.*$", "UE", "1" }
	...
	public static String getPhonemes(String language, String input) {
		if (language.equalsIgnoreCase("DE")) {
			...
			// System.err.println("ERROR: (Words.getPhonemes) Die Sprache " +
			// language + " konnte nicht erkannt werden.");
			return null;
		}
	}
	...
	public static void main(String[] args) {
		System.out.println(englishWordsToPhonemes("notepad"));
	}
